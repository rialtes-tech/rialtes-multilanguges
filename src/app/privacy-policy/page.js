            ...
            >
                ...
                <div className="py-10">
                    <div className="container mx-auto">
                        <h1 className="text-[#0092E0] py-6 max-w-4xl">Privacy Policy</h1>
                    </div>

                    <div className="container mx-auto">
                        <div className="max-w-4xl">
                            <p>Effective Date:  March 19, 2025.</p>
                            <p className="mt-3">We value your privacy and are committed to protecting your data. This Privacy Notice explains how we collect, use, disclose, and protect your information when you visit our Website <a href="/www.rialtes.com" className="font-bold text-[#0092E0]">“www.rialtes.com”</a>.  It also describes your rights and choices regarding your personal information.</p>
                            <p className="mt-3">By accessing or using our Website, you acknowledge and agree to the practices described in this Privacy Policy. If you do not agree with our policies and practices, please discontinue using our Website.</p>
                            <h3 className=" text-[#0092E0] mt-5">Collection and Use of Personal Information</h3>
                            <p className=" pb-6 mt-3">We collect personal information when you submit queries on our Contact Us page/form or apply for jobs on our Careers page. When you visit our Website, we log browser-specific information like your IP address, browser type, access time, and the pages you view. Rialtes is not liable for unsolicited information you provide, and you consent to our use of your information according to our Privacy Policy. We may use your personal information to respond to requests, communicate with you, for permitted marketing, and to support our products or services.</p>
                            <h3 className=" text-[#0092E0] mt-5">Information We Collect</h3>
                            <p className="mt-3">We collect information for legitimate business purposes, provide a smooth and customized experience, send requested information, and collaborate with you as a client.</p>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 mt-3">

                                <li className="pb-4 text-black"><span className="font-bold">Personal Information :</span> When you voluntarily submit information via contact forms, webinar sign-ups, or career inquiries, we may collect your name, email address, phone number, job title, company details, and other identifying information. We may use information to improve our marketing, analyze website usage, enhance our content and services, and customize our website. We also engage outside service providers to assist with operations such as sending communications, analyzing data, processing payments, and providing customer service.</li>
                                <li className="pb-4 text-black"><span className="font-bold">Non-Personal Information :</span> To enhance user experience and analyze trends, we may collect details such as IP address, browser type, device information, referring URLs, and pages visited. We use aggregate data to understand how visitors interact with our Website and to conduct internal research on user demographics and behavior. We may share this collective information with third parties.</li>
                                <li className="pb-4 text-black"><span className="font-bold">Cookies :</span>We use cookies and other tracking technologies to gather information about your interaction with our Website, including browsing behavior and preferences. You can always choose whether to provide information on this Website through cookies. </li>
                            </ul>
                            <h3 className=" text-[#0092E0] pb-2 mt-10">How We Use Your Information</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2">
                                <li className="pb-4 text-black">Provide, operate, and enhance our Website and services.</li>
                                <li className="pb-4 text-black">Respond to your inquiries, requests, or customer service needs.</li>
                                <li className="pb-4 text-black">Personalize your experience by tailoring content and services to your preferences.</li>
                                <li className="pb-4 text-black">Improve our Website’s functionality, usability, and security.</li>
                                <li className="pb-4 text-black">Send newsletters, updates, and marketing communications (you can opt-out at any time).</li>
                                <li className="pb-4 text-black">Fulfill legal and regulatory requirements and enforce our terms of use.</li>

                            </ul>
                            <h3 className=" text-[#0092E0] pb-2 mt-10">How We Share Your Information</h3>
                            <p>We respect your privacy and do not sell, trade, or rent your personal information. We will only disclose your information to the government or third parties if required by law. We cooperate with authorities to enforce laws regarding fraud, data privacy, and security. You authorize us to share your information if we believe it's necessary for investigations related to fraud or illegal activities associated with this website. However, we may share your data in specific scenarios:</p>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 mt-3">
                            ...
                            <h3 className=" text-[#0092E0] pb-2 mt-10">Data Security</h3>
                            ...
                            <h3 className=" text-[#0092E0] pb-2 mt-10">Children’s Privacy</h3>
                            ...
                            <h3 className=" text-[#0092E0] pb-2 mt-10">EU Residents</h3>
                            <p className="pb-5">If you are a resident of the European Union, you may have specific rights regarding the collection, retention, use, and disclosure of your personal data depending on the circumstances under the General Data Protection Regulation (GDPR). We processes data based on contract, consent, legal obligations, or legitimate business interests.</p>
                            <p>Your rights include:</p>
                            <p className="mt-3"><span className="font-bold">Access & Rectification –</span> Request your data and correct inaccuracies.</p>
                            <p className="mt-3"><span className="font-bold">Objection & Restriction – </span> Object to processing or request limitations.</p>
                            <p className="mt-3"><span className="font-bold">Erasure –</span> Request data deletion in certain cases.</p>
                            <p className="mt-3"><span className="font-bold">Data Portability –</span> Receive your data in a structured format.</p>
                            <p className="mt-3"><span className="font-bold">Lodge a Complaint –</span> Contact a data protection authority if needed.</p>
                            <p className="mt-3">For details, visit the <a className="text-blue-600" href="https://www.edpb.europa.eu/about-edpb/about-edpb/members_en">European Data Protection Board</a> .</p>
                            <h3 className=" text-[#0092E0] pb-2 mt-10">Changes to This Privacy Policy</h3>
                            <p>We may update this Privacy Policy from time to time to reflect changes in our practices, services, or legal requirements. Any updates will be posted on this page with the revised effective date. We encourage you to review this policy periodically.</p>
                            <h3 className=" text-[#0092E0] pb-2 mt-10">Contact Us</h3>
                            <p>Thank you for visiting our website. If you have any questions, concerns, or requests related to this Privacy Policy, please reach out through our <a className="text-blue-600" href="https://rialtes.netlify.app/contact-us">contact form.</a> </p>
