...
const schemaData = {
  ...
  description:
    "Looking to unify and harness enterprise data using SAP Datasphere? Rialtes offers consulting, implementation, integration, and AI optimization services to turn data into actionable insights.",
  provider: {
    "@type": "Organization",
    name: "Rialtes",
  ...
  serviceType:
    "SAP Datasphere Consulting and AI-Driven Data Lake Implementation",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "SAP Datasphere Consulting & Architecture Advisory",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "SAP Datasphere Implementation & Configuration",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "SAP Datasphere Integration with SAP & Non-SAP Systems",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Industry-Specific AI Data Lake Accelerators",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Real-Time Data Governance & Compliance Setup",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "AI-Powered Data Visualization with SAP Analytics Cloud & Tableau",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Post-Go-Live AI Optimization and KPI Dashboards",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Integration with SAP S/4HANA, Ariba, and SuccessFactors",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Salesforce + SAP Datasphere Integration for Customer 360",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "AI Use Cases for Manufacturing, Automotive, Retail, Education & HR",
        },
      },
    ],
  },
...
const WhyRialtesSection = ({ onTalkClick }) => {
      ...
      <div className="w-full xl:absolute xl:top-0 xl:left-0 xl:bg-transparent bg-[#80857E] xl:pt-[150px] 2xl:pt-[154px] pt-[37px] xl:pb-[41px] z-[1]">
        <div className="custom-container mx-auto grid xl:grid-cols-12 xl:gap-[20px] gap-[39px]">
          <div className="xl:col-span-7">
            <h2 className="text-[#FFFFFF] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] font-Light leading-tight">
              Why Rialtes?
            </h2>
...
const BuildIntelligentSection = ({ onTalkClick }) => {
    ...
    <section>
      ...
      <div className="custom-container max-md:px-0">
        <div className="xl:pl-[94px] px-[35px] xl:mt-[-100px] mt-[-30px] xl:pt-[78px] pt-[38px] xl:pb-[0px] pb-[0px] bg-[#073259] relative">
          <h2 className="text-[#FFFFFF] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light xl:w-[70%]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:gap-[71px] gap-[20px] xl:mt-[53px] mt-[24px]">
            ...
            <div>
              ...
              <p className="text-[#FFFFFF] font-light 4xl:text-[20px] md:text-[18px] text-[16px] leading-tight mt-[24px] xl:mt-[37px] xl:w-[80%] w-[90%]">
                Data consolidation shouldn’t be a bottleneck — it should be a
                growth catalyst. Rialtes uses SAP Datasphere to unify all your
                critical enterprise data into a powerful data lake, eliminating
                silos and enabling AI/ML insights at scale.
              </p>
            </div>
            {/* Right Column */}
            <div className="flex flex-col">
              <p className="text-[#FFFFFF] font-semibold xl:text-[22px] text-[20px] leading-[24px] xl:leading-[27px] md:mt-0 mt-[26px]">
                Key Benefits:
              </p>
              <UnorderedList
                arrName={buildIntelligentData}
                ulClassName="list-disc pl-[22px] xl:w-[86%] w-[90%] xl:mt-[29px] mt-[26px]"
                liClassName="text-[#FFFFFF] mt-[19px] first:mt-0 xl:mt-[24px] 4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight font-light"
              />
    ...
    <section className="w-full xl:mt-[147px] mt-[41px]">
      <div className="grid grid-cols-1 md:grid-cols-[4fr_5fr]">
        ...
        <div className="text-[#000000] xl:pl-[60px] mx-[35px] xl:pt-0 pt-[40px]">
          <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light">
          ...
          <p className="4xl:text-[20px] xl:text-[18px] md:text-[18px] text-[16px] leading-tight mt-[22px] xl:mt-[45px] xl:w-[86%] font-light">
            Rialtes’ pre-delivered accelerators make AI data consolidation
            seamless and impactful. Designed specifically for Manufacturing,
            Semiconductor, Automotive, Retail, Education, and HR industries,
            these plug-and-play solutions help you gain immediate business
            value.
          </p>
          ...
          <UnorderedList
            ulClassName="list-disc pl-[22px] w-[90%] xl:mt-[28px] mt-[22px] 4xl:space-y-[24px] space-y-[19px]"
            arrName={industryAcceleratorsData}
            liClassName="4xl:text-[20px] md:text-[18px] text-[16px] leading-tight font-light"
          />
        </div>
      </div>
    </section>
...
const IntelligentAutomativeSection = ({ onTalkClick }) => {
    ...
    <section className="relative xl:mt-[66px] mt-[53px] custom-container max-md:px-0 md:!pr-0">
      ...
      <div className="absolute inset-0 flex items-start justify-start md:mt-[64px] mt-[254px]">
        <div className="md:w-[86%] custom-container">
          <h2 className="text-[#FFFFFF] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light 4xl:w-[90%] xl:w-[80%] lg:w-[80%]">
            Intelligent Automotive Data Lakes — Transform Vehicle Data into
            AI-Driven Value
          </h2>
          ...
          <UnorderedList
            ...
            ulClassName="list-disc pl-[22px] lg:w-[70%] w-[90%] mt-[24px] xl:mt-[39px] 4xl:space-y-[24px] space-y-[19px]"
            liClassName="text-[#FFFFFF] 4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight"
          />
          ...
          <div className="bg-[#163055] absolute bottom-[-70px] mr-[36px] lg:ml-[-20px]">
            <p className="text-[#FFFFFF] 4xl:text-[26px] xl:text-[24px] text-[22px] leading-tight xl:py-[37px] py-[27px] xl:px-[43px] px-[24px] font-light">
              Unlock AI for better vehicle performance, customer experience, and
              market growth.
            </p>
          </div>
        </div>
    ...
    <section className="w-full xl:mt-[158px] mt-[180px] relative">
      <div className="grid grid-cols-1 md:grid-cols-[6fr_4fr]">
        ...
        <div className="order-2 md:order-1 text-[#FFFFFF] custom-container lg:!pr-0 xl:pt-[88px] pt-[46px] pb-[120px] bg-[#64676C]">
          <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light xl:w-full w-[80%]">
          ...
          <UnorderedList
            arrName={aiReadyData}
            ulClassName="list-disc pl-[22px] w-[80%] xl:mt-[39px] mt-[29px] 4xl:space-y-[24px] space-y-[19px]"
            liClassName="4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-[24px] leading-[22px] font-light"
          />
        </div>
      </div>
        ...
        <div className="md:w-[56%] relative">
          <div className="bg-[#163055] mt-[-90px] sm:mt-[-60px] w-full">
            <p className="text-[#FFFFFF] 4xl:text-[26px] xl:text-[20px] text-[22px] leading-tight xl:py-[37px] py-[27px] xl:px-[43px] px-[24px] font-light">
              Stay competitive with AI-powered, data-driven manufacturing
              intelligence.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div>
          ...
          <div className="relative text-[#000000] bg-[#E0E0E0] xl:pt-[300px] 2xl:pt-[360px] pt-[305px] xl:pb-[145px] pb-[100px] px-[35px] xl:px-[70px] overflow-visible">
            <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light xl:w-[70%]">
            ...
            <UnorderedList
              arrName={omniSectionData}
              ulClassName="list-disc pl-[22px] w-[90%] xl:mt-[47px] mt-[25px] 4xl:space-y-[24px] space-y-[19px]"
              liClassName="4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight font-light"
            />
          </div>
          <div className="bg-[#163055] mx-[35px] xl:mx-[70px] xl:mt-[-90px] mt-[-60px] relative z-20">
            <p className="text-[#FFFFFF] 4xl:text-[26px] xl:text-[22px] text-[20px] leading-tight xl:py-[37px] py-[27px] xl:px-[43px] px-[24px] font-light">
              Empower retail with hyper-personalized experiences and optimized
              operations.
            </p>
          </div>
        </div>
        <div className="xl:mt-[40%] mt-[80px]">
          ...
          <div className="relative text-[#000000] bg-[#7AB5BF] xl:pt-[300px] 2xl:pt-[360px] pt-[305px] xl:pb-[145px] pb-[100px] px-[35px] xl:pl-[70px] xl:pr-[40px] overflow-visible">
            <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light xl:w-[90%]">
            ...
            <UnorderedList
              arrName={educationSectionData}
              ulClassName="list-disc pl-[22px] 2xl:w-[80%] xl:w-[90%] w-[90%] xl:mt-[49px] mt-[25px] 4xl:space-y-[24px] space-y-[19px]"
              liClassName="4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight font-light"
            />
          </div>
          <div className="bg-[#163055] mx-[35px] xl:mx-[70px] xl:mt-[-90px] mt-[-60px] relative z-20">
            <p className="text-[#FFFFFF] 4xl:text-[26px] xl:text-[22px]  text-[20px] leading-tight xl:py-[37px] py-[27px] xl:px-[43px] px-[24px] font-light">
              Future-proof education with AI insights to enhance student
              outcomes.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[7fr_5fr]">
        ...
        <div>
          <div className="relative text-[#FFFFFF] xl:pl-[72px] xl:ml-[-20%] xl:mt-[100px] mx-[0px] px-[35px] xl:pt-[76px] pt-[42px] bg-[#006FBE] xl:pb-[76px] pb-[142px] overflow-visible">
            <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light xl:w-[80%]">
            ...
            <UnorderedList
              arrName={aiPoweredData}
              ulClassName="list-disc pl-[22px] w-[90%] xl:mt-[49px] mt-[25px] 4xl:space-y-[24px] space-y-[19px]"
              liClassName="4xl:text-[20px] md:text-[18px] text-[16px] leading-tight font-light"
            />
            <div className="bg-[#163055] w-[80%] absolute bottom-[-50px] xl:left-[0px] xl:w-[100%] xl:right-[-72px] xl:bottom-auto xl:top-full xl:mt-[0px] xl:transform-none">
              <p className="text-[#FFFFFF] 4xl:text-[26px] xl:text-[22px] text-[20px] leading-tight xl:py-[37px] py-[27px] xl:px-[43px] px-[24px] font-light">
                Take HR to the next level with AI-powered talent management and
                compliance.
              </p>
            </div>
          </div>
...
const SapAribaSection = ({ onTalkClick }) => {
  const sapAribaData = [
  ...
  return (
    <>
      <section className="custom-container max-md:px-0 md:!pr-0 xl:mt-[240px] mt-[94px]">
        <h2 className="text-[#000000] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] font-light px-[36px] md:px-0 leading-tight">
          End-to-End Integration — <div className="sm:block hidden" /> Real-Time
          Data Unification
        </h2>
        <div>
          <Image
      ...
      <div className="custom-container max-md:px-0">
        <div className=" xl:pl-[57px] px-[35px] xl:mt-[-16%] mt-[-30px] xl:pt-[70px] pt-[42px] xl:pb-[68px] pb-[49px] bg-[#3280A3] relative">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:gap-[20px] gap-[20px] xl:mt-[0px] mt-[24px]">
            <div>
              <h2 className="text-[#FFFFFF] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light 2xl:w-[80%]">
            ...
            <div className="flex flex-col">
              <UnorderedList
                ...
                ulClassName="list-disc pl-[22px] 2xl:w-[86%] w-[90%] md:mt-[0] mt-[21px] 4xl:space-y-[24px] space-y-[19px]"
                liClassName="text-[#FFFFFF] 4xl:text-[20px] md:text-[18px] text-[16px] leading-tight font-normal"
              />
...
const SapHanaSection = ({ onTalkClick }) => {
  const sapHanaData = [
      ...
      <div className="bg-[#75603B] xl:mt-[91px] mt-[55px]">
        <div className="grid grid-cols-1 md:grid-cols-[6fr_5fr]">
          ...
          <div className="text-[#FFFFFF] xl:pl-[36px] mx-[35px] xl:pt-[57px] pt-[42px]">
            ...
            <UnorderedList
              arrName={sapHanaData}
              ulClassName="list-disc pl-[22px] w-[90%] xl:mt-[49px] mt-[45px] 4xl:space-y-[24px] space-y-[19px]"
              liClassName="4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight font-light"
            />
...
const SapSucessFactorSection = ({ onTalkClick }) => {
...
const SalesforceSap = ({ onTalkClick }) => {
...
const AdvancedDataSection = ({ onTalkClick }) => {
  const advancedData = [
        ...
        <div className="bg-[#A16B5D] xl:mt-[98px] mt-[64px] md:pb-0 pb-[47px] relative">
          <div className="grid grid-cols-1 md:grid-cols-[5fr_6fr]">
            ...
            <div className="order-2 md:order-1 text-[#FFFFFF] xl:pl-[36px] mx-[35px] xl:pt-[57px] pt-[42px]">
              ...
              <UnorderedList
                arrName={advancedData}
                ulClassName="list-disc pl-[22px] w-[80%] xl:w-[90%] xl:mt-[49px] mt-[45px] 4xl:space-y-[24px] space-y-[19px]"
                liClassName="4xl:text-[20px] md:text-[18px] text-[16px] xl:leading-tight font-light"
              />
              <div className="xl:my-[62px] mt-[34px] mb-[49px]">
                <LearnMore onClick={onTalkClick} btnName="Talk to Us" />
...
const AIPoweredUseSection = ({ onTalkClick }) => {
  const aiPoweredData = [
        ...
        <div className="relative block md:hidden">
          ...
          <div className="relative">
            <div className="mx-[10px] absolute bottom-[220px] left-0 right-0 px-[22px] pt-[0px] pb-[73px] z-10 text-white">
              ...
              <UnorderedList
                arrName={aiPoweredData}
                ulClassName="list-disc pl-[22px] mt-[22px] 4xl:space-y-[24px] space-y-[19px]"
                liClassName="4xl:text-[20px] md:text-[18px] text-[16px] leading-[19px]"
              />
        ...
        <div className="hidden md:flex absolute inset-0 items-start justify-start custom-container">
          <div className="relative">
            ...
            <div className="relative z-10 xl:pt-[70px] pt-[57px] xl:pb-[80px] pb-[0px] px-[26px] md:px-[67px] text-white">
              <h2 className=" 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight font-light w-[70%]">
                AI-Powered Use Cases
              </h2>
              ...
              <UnorderedList
                arrName={aiPoweredData}
                ulClassName="list-disc pl-[22px] xl:mt-[43px] mt-[16px] w-[80%]  4xl:space-y-[24px] space-y-[19px]"
                liClassName="xl:text-[20px] text-[15px] leading-tight font-light"
              />
  ...
  return (
    <section className="xl:mt-[121px] mt-[136px] custom-container lg:!pr-0 max-md:px-0">
      <div className="relative">
        ...
        >
          <div className="z-30">
            <h2 className="text-[#FFFFFF] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] md:text-[32px] text-[26px] font-light leading-tight">
          ...
          <div className="grid grid-cols-12 w-full">
            <div className="4xl:col-span-7 sm:col-span-8 xl:col-span-6 col-span-11">
              ...
              <h1 className="text-[26px] leading-tight xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] mt-[11.5px] md:mt-[28.5px]">
                Unleash the Power of AI-Driven Data Lakes with Rialtes & SAP
                Datasphere
              </h1>
            </div>
      ...
      <section className="custom-container mt-5">
        ...
        <div className="grid xl:grid-cols-12 2xl:gap-[60px] xl:gap-[46px] gap-y-[39px] xl:mt-[104px] mt-[53px] xl:mb-[0px] mb-[52px]">
          <div className="4xl:col-span-7 xl:col-span-6 col-span-12">
            <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] font-Light leading-tight xl:w-[100%] lg:w-[80%]">
              Future-Proof Your Business with Intelligent Data Consolidation, AI
              Insights, and Seamless Integration
            </h2>
          </div>
          <div className="4xl:col-span-5 xl:col-span-6 col-span-12">
            <p className="4xl:text-[22px] md:text-[18px] text-[16px] font-normal leading-tight xl:w-full lg:w-[90%] w-[96%]">
              In today’s competitive landscape, data is the new currency. Yet,
              most organizations struggle with fragmented data spread across
              multiple systems like SAP, Salesforce, Oracle, and more. Rialtes,
              as a certified SAP partner, offers cutting-edge SAP Datasphere
              services to consolidate and harmonize your enterprise data,
              unlocking real-time AI-powered insights that drive value and
              innovation.
            </p>
            <p className="4xl:text-[22px] md:text-[18px] text-[16px] font-normal leading-tight xl:w-full lg:w-[90%] w-[96%] xl:mt-[30px] mt-[19px]">
              With deep expertise in SAP Datasphere and AI-led data
              architecture, we turn your data sprawl into a powerful, unified
              asset — creating a future-ready, intelligent enterprise.
            </p>
          </div>
        </div>
      </section>
      {/* why rialtes section */}
      <WhyRialtesSection onTalkClick={handleScrollToContact} />
      {/* Build Intelligent Section */}
      <BuildIntelligentSection onTalkClick={handleScrollToContact} />
      {/* industry accelerators section */}
      <IndustryAcceleratorsSection onTalkClick={handleScrollToContact} />
      {/* Intelligent Automative Section */}
      <IntelligentAutomativeSection onTalkClick={handleScrollToContact} />
      {/* AI Ready Manufacturing Section */}
      <AIReadyManufacturingSection onTalkClick={handleScrollToContact} />
      {/* OmnichannelSmartEducationSection */}
      <OmnichannelSmartEducationSection onTalkClick={handleScrollToContact} />
      {/* ai powered hr analytics section */}
      <AiPoweredHRAnalyticsSection onTalkClick={handleScrollToContact} />
      {/* sap ariba section */}
      <SapAribaSection onTalkClick={handleScrollToContact} />
      {/* sap hana section */}
      <SapHanaSection onTalkClick={handleScrollToContact} />
      {/* sap success factors */}
      <SapSucessFactorSection onTalkClick={handleScrollToContact} />
      {/* SalesforceSap section */}
      <SalesforceSap onTalkClick={handleScrollToContact} />
      {/* advanced data visualization */}
      <AdvancedDataSection onTalkClick={handleScrollToContact} />
      {/* ai powered section */}
      <AIPoweredUseSection onTalkClick={handleScrollToContact} />
      {/* Global Presence Section */}
      <GlobalPresenceSection onTalkClick={handleScrollToContact} />
      {/* Contact Form */}
      <div
        className="custom-container text-[#000000] pb-10  max-[460px]:mt-[540px] mt-[400px] sm:mt-[460px] md:mt-[400px] lg:mt-[80px] xl:mt-[90px] scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Ready to Transform Your Data Landscape?"}
          subtitle={
            "Rialtes is here to guide you on every step of your AI and data consolidation journey — from strategy to execution to AI insights that create real business value. "
          }
          subtitle1={
            "Contact us today for a personalized consultation and see how SAP Datasphere can redefine your enterprise!"
          }
          className={
            "xl:w-[70%] 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight mt-[52px] xl:mt-[89px]"
          }
        />
      </div>
    </>
