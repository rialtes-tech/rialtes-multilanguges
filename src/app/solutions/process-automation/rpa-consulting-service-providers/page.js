...
export default function DemandPlusSection() {
    const schemaData = {
        ...
        "url": "https://www.rialtes.com/solutions/process-automation/rpa-consulting-service-providers",
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <Seo
                ...
                canonical="https://www.rialtes.com/solutions/process-automation/rpa-consulting-service-providers/"
            />
            <script
            ...
            <section className="4xl:mt-20 mt-0 xl:mt-0 custom-container 4xl:!pr-[142px] 4xl:pl-[280px] max-md:px-0">
                <div className="xl:grid-cols-12 grid">
                    ...
                    <div className="xl:col-span-7 bg-[#006FBE] p-10 text-white order-2 xl:order-1 pb-32 4xl:pb-0 xl:pb-0">
                        <h2 className="leading-tight text-[26px] 4xl:text-[60px] xl:text-[42px]">Why RPA with UiPath?</h2>
                        <p className="mt-5 4xl:text-[22px] text-[16px] font-normal">
            ...
            <section className="mt-24 my-10 custom-container 4xl:pr-[464px] xl:pr-[200px]">
                <h2 className="leading-tight text-[26px] 4xl:text-[60px]  xl:text-[42px]">
                    Rialtes’ End-to-End RPA Services
                </h2>
                <h3 className="4xl:text-[36px] text-[22px] xl:text-[25px] font-semibold leading-tight mt-5">Powered by UiPath</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5 xl:mt-[67px] mt-[48px]">
                    {featureBoxes.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-white border hover:bg-[#D9F2FF] 4xl:p-10 p-8 flex flex-col h-full">
            ...
            <section className="mt-20 custom-container 4xl:pl-[280px] 4xl:pr-0 max-md:px-0">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-8 bg-[#F0DCC9] max-md:px-[35px] md:px-[35px] text-black 4xl:pl-64 4xl:pr-[22rem] xl:pr-[14rem] xl:pl-[11rem] pt-16  4xl:ml-[-200px] xl:ml-[-130px] mt-[-230px] 4xl:mt-0 xl:mt-0">
                        <h2 className="leading-tight text-[26px] 4xl:text-[60px]  xl:text-[40px] pt-24 4xl:pt-0 xl:pt-0">
                        ...
                        <h3 className="4xl:mt-10 xl:mt-5 font-semibold 4xl:text-[32px] xl:text-[20px] text-[18px] leading-tight mt-10">Ariba Use Cases:</h3>
                        <ul className="list-disc leading-tight 4xl:space-y-3 xl:space-y-1  marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] font-light text-[16px] mt-3 pr-12 xl:pr-0">
                        ...
                        <h3 className="4xl:mt-10 xl:mt-5 font-semibold 4xl:text-[32px] xl:text-[20px] text-[18px] leading-tight mt-10">Benefits:</h3>
                        <ul className="list-disc leading-tight 4xl:space-y-3 xl:space-y-1  marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] font-light text-[16px] mt-3 pr-12 xl:pr-0">
            ...
            <section className="mt-20 custom-container 4xl:pl-[142px] 4xl:pr-[280px] max-md:px-0">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="4xl:col-span-5 xl:col-span-6 mt-10 xl:mt-20 4xl:mb-32 mb-16 order-1 xl:order-2">
                        <div className="xl:block hidden">
                            <Image
                    ...
                    <div className="4xl:col-span-7 max-md:px-[35px] md:px-[35px] xl:col-span-6 bg-[#BFDEE3] text-black pt-16 4xl:pl-[197px] 4xl:pr-[250px] 4xl:mr-[-200px] xl:pl-20 xl:pr-[200px] xl:mr-[-150px] order-2 xl:order-1 mt-[-285px] xl:mt-0 4xl:mt-0">
                        ...
                        <h3 className="4xl:mt-10 xl:mt-8 mt-10 font-semibold 4xl:text-[32px] xl:text-[22px] text-[18px] leading-tight">
                            S/4HANA Use Cases:
                        </h3>
                        <ul className="list-disc leading-tight 4xl:space-y-3 xl:space-y-3 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] font-light text-[16px] mt-3 pr-12 xl:pr-0">
            ...
            <section className="mt-20 custom-container 4xl:pl-[280px] 4xl:pr-0 max-md:px-0">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-4 mt-10 xl:mt-20 mb-16 xl:mb-32">
                        <div className="xl:block hidden">
                            <Image
                    ...
                    <div className="xl:col-span-8 bg-[#E6D2D2] max-md:px-[35px] md:px-[35px] mt-[-200px] xl:mt-0 4xl:mt-0 text-black 4xl:pl-64 4xl:pr-[22rem] xl:pr-[14rem] xl:pl-[11rem] pt-16 4xl:ml-[-200px] xl:ml-[-130px] order-2 xl:order-1">
                        ...
                        <h3 className="4xl:mt-10 xl:mt-5 font-semibold 4xl:text-[32px] xl:text-[20px] text-[18px] leading-tight mt-10">
            ...
            <section className="mt-20 custom-container 4xl:pl-[142px] 4xl:pr-[280px] max-md:px-0">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="4xl:col-span-7 xl:col-span-6 max-md:px-[35px] md:px-[35px] bg-[#ACD8ED] mt-[-200px] xl:mt-0 4xl:mt-0 text-black pt-16 4xl:pl-[197px] 4xl:pr-[250px] 4xl:mr-[-200px] xl:pl-20 xl:pr-[200px] xl:mr-[-150px] order-2 xl:order-1">
                        ...
                        <h3 className="4xl:mt-10 xl:mt-8 font-semibold 4xl:text-[32px] xl:text-[22px] text-[18px] leading-tight mt-10">
            ...
            <section className="relative 4xl:mt-32 xl:mt-32 mt-20 custom-container 4xl:pl-[280px] 4xl:pr-0 xl:pr-0 max-md:pr-0">
                ...
                <div
                    ...
                    <div className="xl:col-span-10 bg-[#016FBE]  text-white p-8 xl:pl-20 4xl:pl-20 4xl:pb-20 pb-20 xl:pb-10">
                        <h2 className="leading-tight 4xl:mt-10 text-[26px] 4xl:text-[60px]  xl:text-[40px]">Industry-Focused UiPath RPA Use Cases</h2>
                        <h3 className="4xl:text-[40px] text-[20px] font-semibold leading-tight 4xl:mt-8 xl:mt-5 mt-5">Ready-to-Deploy</h3>
                        ...
                        <div className="flex xl:gap-20 4xl:gap-20 gap-10 md:gap-0 xl:flex-row flex-col mt-16 md:flex-row">
                            <div>
                            ...
                            <div>
                                ...
                                <div className="absolute mt-1 xl:hidden block">
                                    <LearnMore />
                                </div>
                            </div>
            ...
            <section className="mt-24 custom-container 4xl:pr-[142px]">
                <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-20 4xl:gap-20">
                    ...
                    <div className="xl:col-span-7 mt-16">
                        <h2 className="leading-tight 4xl:mt-10 text-[26px] 4xl:text-[60px]  xl:text-[40px]">Data Visualization & Analytics with UiPath + Tableau/Qlik + Data Cloud</h2>
                        <ul className="list-disc leading-tight 4xl:space-y-5 xl:space-y-3 font-light marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] text-[16px] 4xl:mt-8 xl:mt-5 pr-12 mt-8 xl:pr-0">
            ...
            <section className="mt-24 custom-container 4xl:pr-0 xl:pr-0">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    ...
                    <div className="xl:col-span-4 order-2 xl:order-1">
                        ...
                        <h3 className="4xl:text-[40px] xl:text-[30px] text-[20px] mt-5 leading-tight font-bold">
                        ...
                        <ul className="list-disc leading-tight 4xl:space-y-5 xl:space-y-3 font-light marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] text-[16px] 4xl:mt-8 xl:mt-5  mt-8 4xl:pr-16">
                        ...
                        <div className="absolute mt-12 xl:mt-5">
                            <LearnMore />
                        </div>
                    </div>
            ...
            <section className="mt-40 custom-container 4xl:pr-0 xl:pr-0 4xl:pl-[142px]">
                <div className="grid xl:grid-cols-12 grid-cols-1 gap-20">
                    ...
                    <div className="4xl:col-span-5 xl:col-span-6">
                        <h2 className="leading-tight text-[26px] 4xl:text-[60px]  xl:text-[40px] 4xl:pr-10">Proven Delivery with Global Reach & Agile Execution</h2>
                        ...
                        <ul className="list-disc leading-tight 4xl:space-y-5 xl:space-y-3 font-light marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] text-[16px] 4xl:mt-8 xl:mt-5 pr-12 mt-8 4xl:pr-16">
            ...
            <section className="relative mt-32 custom-container 4xl:pl-[280px] 4xl:pr-[142px] xl:pr-0 max-md:px-0">
                <div className="xl:block hidden">
                    <Image
                ...
                <div
                    ...
                    <div className="xl:col-span-10 bg-[#016FBE]  text-white p-8 xl:pl-20 4xl:pl-20 4xl:pb-24 pb-20 xl:pb-[6rem]">

                        <div className="flex xl:gap-20 xl:flex-row flex-col">
                            <div>
                                <h2 className="leading-tight 4xl:mt-10 text-[26px] 4xl:text-[60px]  xl:text-[40px]">Why Rialtes for UiPath RPA?</h2>
            ...
            <div className="mt-20
             custom-container
             pb-20">
                <ContactForm title={'Ready to Transform with UiPath RPA?'} subtitle={"Partner with Rialtes to accelerate your automation journey. Our UiPath-certified experts are ready to help you unlock efficiency, reduce costs, and scale innovation."} subtitle1={"Contact us today for a free automation assessment!"} className={"4xl:max-w-[59rem] xl:max-w-[44rem] leading-tight text-[26px] !font-light 4xl:text-[60px]  xl:text-[45px] pr-10 xl:pr-0"} />
            </div >
        </div>
    );
}
