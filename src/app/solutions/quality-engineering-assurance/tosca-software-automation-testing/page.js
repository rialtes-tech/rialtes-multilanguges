        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative">
                ...
                <div
                    ...
                    <div className="xl:col-span-6 absolute 4xl:right-[333px] xl:right-[170px]  xl:top-0 top-[290px]">
                        <div className="bg-[#016FBE] xl:bg-opacity-90 text-white p-8 4xl:w-[765px] xl:w-[550px] 4xl:pb-20 pb-48 xl:pb-10">
                            ...
                            <UnorderedList arrName={whychooseData} ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-3 font-light marker:font-bold marker:text-2xl pl-5 4xl:mt-8 xl:mt-5 pr-12 mt-8 xl:pr-0" liClassName="4xl:text-[20px] xl:text-[18px] text-[16px]" />
                        </div>
            ...
            {/* end to end section */}
            <section className="custom-container xl:!pr-0 4xl:mt-32 mt-[39rem] md:mt-[30rem] xl:mt-32">
                ...
                <div className="grid xl:grid-cols-12 grid-cols-1 4xl:gap-10 xl:gap-16 4xl:mt-10 mt-16">
                    ...
                    <div className="xl:col-span-6 order-2 xl:order-1">
                        ...
                        <UnorderedList arrName={endToEndData} ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-2 marker:font-bold marker:text-2xl pl-5 font-medium 4xl:mt-8 mt-5 pr-16 xl:pr-0 md:pb-0" liClassName="4xl:text-[20px] xl:text-[18px] text-[16px]" />
                    </div>
            ...
            <section className="4xl:-mt-[12rem] xl:custom-container px-0 sm:px-0 md:px-6 xl:-mt-[9rem] absolute 4xl:!pl-[205px] xl:pl-[80px] xl:pr-[150px] 4xl:pr-[280px]">
                <div className="bg-[#006FBE] xl:p-16 4xl:p-16 p-10 grid xl:grid-cols-12 text-white 4xl:pb-32 pb-32">
                    ...
                    <div className="xl:col-span-5">
                        ...
                        <UnorderedList arrName={qTestData} ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-2  marker:font-bold marker:text-2xl pl-5 font-light 4xl:mt-8 mt-5 pr-12 xl:pr-0" liClassName=" 4xl:text-[20px] xl:text-[18px] text-[16px]" />
                    </div>
                </div>
            </section>
            ...
            <section className="xl:mt-32 mt-24 xl:custom-container lg:px-0 pl-0">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    ...
                    <div className="xl:col-span-7 bg-[#D0EBFF] text-black 4xl:ml-[-32rem] max-md:px-[65px]  xl:ml-[-28rem] pb-[15rem] xl:pb-[9rem] 4xl:pb-[11rem] px-[35px] 4xl:pl-[36rem] xl:pl-[31rem] 4xl:pr-[10rem] xl:pr-[7rem] xl:mt-0 mt-[-200px] ">
                        <h2 className="text-[26px] 4xl:text-[60px] xl:text-[38px] leading-tight 4xl:pr-16 xl:pr-10 pt-[15rem] 4xl:pt-16 xl:pt-[4rem] 2xl:text-[30px]">LiveCompare Implementation</h2>
                        ...
                        <h3 className="text-[#006FBE] mt-5 font-semibold 4xl:text-[32px] xl:text-[22px] text-[20px] leading-tight 4xl:pr-[4rem] pr-20">Accelerate Safe SAP Updates with AI-Driven Impact Analysis</h3>
                        ...
                        <UnorderedList arrName={liveCompareData} ulClassName="list-disc leading-tight 4xl:space-y-5 marker:font-bold marker:text-2xl pl-5 font-normal 4xl:pr-32 4xl:mt-5 mt-5 pr-12 xl:pr-0" liClassName="4xl:text-[20px] xl:text-[14px] text-[16px]" />
                ...
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-7 col-span-12 bg-[#427C8A] text-white px-[35px] md:pl-10 xl:pl-[5rem] 4xl:h-[1090px] 4xl:pl-[8rem] order-2 xl:order-1 mt-[-200px] xl:mt-0 4xl:mt-0 pb-[15rem] xl:pb-0 4xl:pb-0">
                        ...
                        <div className="4xl:pr-[14rem] xl:pr-[8rem]">
                            ...
                            <UnorderedList arrName={neoLoadData} ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-1 font-light marker:font-bold marker:text-2xl pl-5 4xl:mt-8 mt-5 pr-12 xl:pr-0" liClassName=" 4xl:text-[20px] xl:text-[14px] text-[16px]" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                {expertsList.map((item, index) => (
                                    <div key={index} className="flex items-start gap-5">
                                        <div className={`w-[${item.lineWidth}] h-full bg-[#006FBE]`}></div>
                ...
                <div className="absolute top-0 max-md:px-[35px] custom-container ">
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1">
                        <div className="xl:col-span-6 col-span-12">
                            ...
                            <UnorderedList arrName={seamlessData} ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-1 space-y-2 font-medium  marker:font-bold marker:text-2xl pl-5 4xl:mt-8 mt-5 pr-12 xl:pr-0" liClassName=" 4xl:text-[20px] xl:text-[18px] text-[16px]" />
                        </div>
                    </div>

                    <div className="xl:grid xl:grid-cols-12">
                        <div className="order-1 xl:order-3 4xl:mt-[28px] xl:mt-[3px] mt-10 col-span-2 2xl:mt-[100px]">
                            <LearnMore bgcolor={"#006FBE"} bordercolor={"#006FBE"} />
                        </div>

                        <div className="order-2 xl:order-2 xl:col-span-1"></div>

                        <div className="order-3 xl:order-1 xl:col-span-7 col-span-12 md:mt-[3rem] mt-10 xl:mt-0 4xl:mt-0  xl:mr-0 4xl:mr-0">
            ...
            <div className="mt-20 custom-container text-black pb-20">
                <ContactForm title={'Ready to Transform Your Testing Journey?'} subtitle={'Let Rialtes help you embrace Tosca and modern test automation to ensure every release is high-quality, fast, and secure.'} subtitle1="Schedule a Free Tosca Consultation, Book a Demo or Contact Our Experts Please fill the below form." className={"4xl:max-w-[59rem] xl:max-w-[44rem] leading-tight text-[26px] font-light 4xl:text-[60px]  xl:text-[45px] xl:pr-0"} />
            </div>
        </div>
    );
}
