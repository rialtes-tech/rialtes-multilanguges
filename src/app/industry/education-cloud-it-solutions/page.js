...
const Services2 = () => {
    return (
        <div className="mx-auto text-black">
            <h2 className="text-black mb-6 4xl:text-[60px] 2xl:text-[56px] xl:text-[45px] lg:text-[45px] md:text-[35px] text-[26px] max-[350px]:text-[22px] leading-tight">Rialtes’ Pre-Delivered Accelerators:</h2>
            <h3 className="4xl:text-[42px] 2xl:text-[40px] xl:text-[36px] lg:text-[36px] md:text-[26px] max-[390px]:text-[20px] xl:font-bold  font-medium mt-5 text-[22px] pr-10 xl:pr-0">Fast-Tracking Education Success</h3>
            <p className="mt-5 4xl:text-[22px] 2xl:text-[20px] xl:text-[16px] md:text-[18px] text-[16px] w-full pr-4 xl:pr-0 font-light leading-tight">Our proprietary accelerators for the education sector are designed to simplify and optimize student lifecycle management:</p>
...
const ServicesCard = ({ services }) => (
    <div className="w-full h-full flex flex-col border border-[#707070] py-10 px-6 2xl:p-14 xl:p-10 transition ease-out duration-300 hover:bg-[#D9F2FF] hover:border-[#D9F2FF]">
        <div className="flex-grow flex flex-col">
            <h3 className="mb-[15px] md:mb-[25px] 4xl:text-[24px] 2xl:text-[20px] xl:text-[18px]  text-[20px] max:[400px]:text-[18px] font-semibold leading-tight">{services.title}</h3>
            <p className='md:mb-[15px] mb-0 4xl:text-[20px] 2xl:text-[17px] xl:text-[15px] md:text-[17px] text-[16px] leading-tight font-light'>{services.description}</p>
        </div>
    </div>
);
...
export default function Page() {
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="h-full relative custom-container">
                    <div className="grid xl:grid-cols-12 grid-cols-1  xl:mt-20  mt-[9rem]">
                        <div className="xl:col-span-7 col-span-12">
                            <h1 className="text-white 2xl:text-[24px] xl:text-[22px] text-[18px] font-bold mb-2 mt-10">Education Industry</h1>
                            ...
                            <h3 className="4xl:text-[45px] 2xl:text-[42px] xl:text-[38px] lg:text-[38px] xl:mt-10 mt-5 text-white font-bold text-[18px] leading-tight">Rialtes’ End-to-End Solutions for Student Success</h3>
                        </div>
            ...
            <section className="xl:mt-16 mt-8 custom-container">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    <div className="xl:col-span-11 col-span-12">
                        ...
                        <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] md:text-[18px]  text-[16px] mt-10 lg:pr-32 leading-tight">Education today is evolving at a rapid pace. Institutions must engage digitally native students, streamline enrollment and academic processes, and foster lifelong relationships with learners. From K-12 to higher education, organizations face challenges in managing fragmented student journeys, disjointed academic operations, and evolving stakeholder expectations.</p>
                        <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] md:text-[18px]  text-[16px] mt-5 xl:pr-32 leading-tight"> Rialtes delivers holistic education solutions—covering strategic advisory, seamless implementations, process optimization, and long-term support.</p>
                    </div>
            ...
            <section className="relative xl:mt-20 mt-16 pb-20">
                ...
                <div className="relative xl:mt-16 mt-8 custom-container">
                    <div className="xl:pt-16">
                        <h2 className="4xl:text-[60px] 2xl:text-[56px] xl:text-[45px] lg:text-[45px] md:text-[30px] text-[26px] max-[350px]:text-[22px]">Thought Leadership:</h2>
                        <h3 className="4xl:text-[42px] 2xl:text-[40px] xl:text-[36px] lg:text-[36px]md:text-[30px]  max-[350px]:text-[18px] mt-5 xl:font-bold font-medium text-[22px] ">Solving Education’s Most Pressing Challenges</h3>
                    </div>
                    <div className="grid xl:grid-cols-12 grid-cols-1 xl:pt-10 pt-5">
                        <div className="xl:col-span-5 col-span-12">
                            <h3 className="4xl:text-[26px] 2xl:text-[24px] xl:text-[22px] text-[20px] font-bold max-[350px]:text-[18px]">Key Industry Challenges We Address:</h3>
                            <UnorderedList arrName={keyIndustryData} ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 text-[16px] md:text-[18px] 2xl:text-[20px] xl:text-[18px] xl:mt-5 mt-3 lg:pr-10" liClassName="" />
                        </div>
                        <div className="xl:col-span-5 col-span-12  bg-[#0A69B7] absolute xl:left-[44%] left-0 top-[40rem] max-[380px]:top-[44rem] md:left-[30px] md:top-[26rem] xl:top-[22rem] text-white p-10 pb-12  xl:w-[500px]">
                            <h3 className="4xl:text-[26px] 2xl:text-[24px] xl:text-[22px]  text-[20px] font-bold ">Rialtes’ Approach:</h3>
                            <UnorderedList arrName={approachData} ulClassName="list-disc xl:space-y-5 space-y-3 marker:font-bold marker:text-2xl pl-5 2xl:text-[20px] xl:text-[18px] text-[16px] md:text-[18px] lg:pr-4 mt-5" liClassName="" />
                        </div>
                    </div>
                </div>
            </section>
            {/**Pre-Delivered Accelerators */}
            <section className="xl:mt-40 max-[400px]:mt-[40rem] mt-[35rem] md:mt-[26rem] custom-container xl:!pr-[142px]">
                        ...
                        <div className="relative 4xl:w-[1014px] 2xl:w-[980px] xl:w-[850px] xl:h-[1621px] pb-16 xl:pb-0">
                            ...
                            <div className="relative bg-opacity-80 text-white z-10 rounded-lg">
                                <div className=" pt-16  xl:pr-0 xl:pl-20">
                                    <h2 className="leading-tight xl:pr-20 4xl:text-[60px]  2xl:text-[56px] xl:text-[45px] lg:text-[45px] md:text-[30px] text-[26px] max-[350px]:text-[22px]">The Complete Student Journey</h2>
                                    <h3 className="4xl:text-[42px]  2xl:text-[40px] xl:text-[34px] lg:text-[36px]md:text-[30px] text-[22px] max-[350px]:text-[18px] xl:font-bold font-medium mt-10 leading-tight xl:pr-40 ">From First Inquiry to Graduation and Beyond</h3>
                                </div>
                                <div>
                                    <div className=" flex items-center xl:gap-5 gap-3">
                                        <h3 className="xl:border-white-education"></h3>
                                        <h3 className="4xl:text-[35px] mt-10 2xl:text-[32px] xl:text-[28px]  text-[20px] font-bold  xl:pr-0 max-[350px]:text-[18px]">Recruitment and Enrollment Journey</h3>
                                    </div>
                                </div>
                                <div className="xl:pl-20   xl:pr-0 xl:pt-10 pt-5">
                                    <h3 className="4xl:text-[30px] 2xl:text-[28px] xl:text-[26px] md:text-[22px] text-[18px] xl:font-bold font-medium max-[350px]:text-[16px]">Student Lead Management and Engagement</h3>
                                    <UnorderedList arrName={studentLeadData} ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[16px] xl:mt-5 mt-3 xl:pr-64 font-light" liClassName="" />
                                </div>
                                <div className="xl:pl-20  pt-10">
                                    <h3 className="4xl:text-[30px] 2xl:text-[28px] xl:text-[26px] md:text-[22px] text-[18px] font-medium max-[350px]:text-[16px]">Selection and Admissions</h3>
                                    <UnorderedList arrName={selectionData} ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[16px] mt-5 xl:pr-64" liClassName="" />
                                </div>
                                <div className="flex items-center xl:gap-5 gap-3 mt-10">
                                    <h3 className="xl:border-white-education"></h3>
                                    <h3 className="4xl:text-[35px] 2xl:text-[32px] xl:text-[28px]  text-[20px] font-bold max-[350px]:text-[18px]">Student Family Mapping and Engagement</h3>
                                </div>
                                <div className="xl:pl-20  pt-5">
                                    <UnorderedList arrName={studentData} ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] text-[16px] md:text-[18px] xl:mt-5 xl:pr-64" liClassName="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#C4EBEA] custom-container w-full xl:pr-20 xl:pb-20 pb-10 pt-[8rem] xl:pt-[5rem]">
                            ...
                            <UnorderedList arrName={hyperData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl  md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#F7E2D4] w-full xl:pb-20 pb-10 pt-[6rem] xl:!pl-16 mt-[-3rem]  custom-container">
                            ...
                            <UnorderedList arrName={lifelongData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#D6CFCF] custom-container w-full xl:pr-12 xl:pb-20 pb-10 pt-[5rem] -mt-14">
                            ...
                            <UnorderedList arrName={selfData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#E8DFC7] w-full xl:pb-20 pb-10 pt-[6rem] xl:!pl-16 mt-[-3rem] custom-container">
                            ...
                            <UnorderedList arrName={s4HanaData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] font-medium leading-tight marker:font-bold marker:text-2xl" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#F1D8D9] custom-container w-full xl:pr-20 xl:pb-20 pb-10 pt-[6rem] xl:pt-[6rem] -mt-16">
                            ...
                            <UnorderedList arrName={dynamicData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#C7E8E9] w-full xl:pb-20 pb-10 pt-[6rem] xl:!pl-16 mt-[-3rem] custom-container">
                            ...
                            <UnorderedList arrName={unifiedData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#C4E2FF] custom-container w-full xl:pr-20 xl:pb-20 pb-10 pt-[7rem] xl:pt-[6rem] -mt-16">
                            ...
                            <h3 className="mt-5 font-bold 4xl:text-[40px] 2xl:text-[36px] xl:text-[32px] text-[22px]  max-[400px]:text-[21px] max-[350px]:text-[18px]">Agentforce for Education</h3>
                            <UnorderedList arrName={empoweringData} ulClassName="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl md:text-[18px]" liClassName="" />
                            <div className="mt-5">
                                <LearnMore />
                            </div>
                        </div>
                ...
                <div className="text-white h-full relative custom-container">
                    <div className="grid xl:grid-cols-12 grid-cols-1 text-white">
                        <div className="xl:col-span-8 col-span-12 xl:pr-20">
                            <h2 className="text-[30px] 4xl:text-[50px] 2xl:text-[46px] xl:text-[40px] md:text-[35]  text-white leading-tight xl:pr-10 font-medium max-[400px]:text-[26px] max-[350px]:text-[24px]">
                                <span className="font-bold 4xl:text-[70px] 2xl:text-[65px] xl:text-[62px] md:text-[50] text-[40px] max-[400px]:text-[36px] max-[350px]:text-[34px]">AgentChat</span> <br></br>  Transforming Communication in Education with AI-Powered WhatsApp Integration
                            </h2>
                        </div>
                        <div className="xl:col-span-4 col-span-12 mt-10 xl:mt-0">
                            <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[20px] md:text-[18px] text-[16px]  xl:pr-0 leading-tight font-light">Unlock the future of communication with AgentChat, an AI-driven, bi-directional WhatsApp conversation tool fully integrated with Salesforce Education Cloud. Streamline interactions with students, parents, and faculty, all while enhancing engagement, boosting operational efficiency, and delivering personalized experiences.</p>
                        </div>
                    </div>
                    <div className="xl:mt-20 mt-10">
                        <h3 className="2xl:text-[30px] xl:text-[28px] md:text-[26px] text-[24px]">Key Features:</h3>
                        <div className="flex flex-col md:flex-row xl:flex-row mt-10 xl:gap-20 gap-8 mb-16">
                            <div className="flex flex-col xl:flex-row  xl:items-start gap-4 xl:gap-0 xl:w-1/2">
                                ...
                                <div className="mt-4 xl:mt-0 xl:ml-12">
                                    <h3 className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] md:text-[22] text-[20px]   xl:text-left pr-16 xl:pr-0 leading-tight">Seamless Salesforce Integration</h3>
                            ...
                            <div className="flex flex-col  xl:flex-row  xl:items-start gap-4 xl:gap-0 xl:w-1/2 mt-10 md:mt-0 xl:mt-0">
                                ...
                                />
                                <div className="mt-4 xl:mt-0 xl:ml-12">
                                    <h3 className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] md:text-[22] text-[20px] pr-16 xl:pr-0 xl:text-left leading-tight ">AI-Powered Automation & Personalization</h3>
                        ...
                        <div className="flex flex-col md:flex-row xl:flex-row mt-10 xl:gap-20 gap-8 mb-16">
                            <div className="flex flex-col xl:flex-row  xl:items-start gap-4 xl:gap-0 xl:w-1/2 mt-10 xl:mt-0">
                                ...
                                />
                                <div className="mt-4 xl:mt-0 xl:ml-12">
                                    <h3 className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] md:text-[22] text-[20px] pr-16 xl:pr-0 xl:text-left leading-tight">Scalable & Efficient Communication</h3>
                                    <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] md:text-[18px] text-[16px] mt-3 xl:pr-0 xl:text-left leading-tight font-light">
                            ...
                            <div className="flex flex-col xl:flex-row  xl:items-start gap-4 xl:gap-0 xl:w-1/2 mt-10 xl:mt-0">
                                ...
                                />
                                <div className="mt-4 xl:mt-0 xl:ml-12">
                                    <h3 className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] md:text-[22] text-[20px] pr-16 xl:pr-0 xl:text-left leading-tight">Actionable Insights & Data Security</h3>
                                    <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] md:text-[18px] text-[16px] mt-3  xl:pr-0 xl:text-left leading-tight font-light">
            ...
            <div className="h-full xl:mr-[142px] custom-container">
                <p className="4xl:text-[26px] 2xl:text-[22px] xl:text-[18px] md:text-[20px]  text-[18px] bg-[#0C8AD4]  p-5 xl:p-8  pl-6  text-white max-md:left-7 max-md:right-7 max-[400px]:mt-[-5rem] xl:mt-[-5rem] absolute xl:w-[60%] leading-tight font-light max-[400px]:text-[17px] ">With AgentChat, elevate your institution’s communication to new heights—efficient, secure, and fully integrated.</p>
            </div>
            ...
            {/* related section */}
            <div className="py-32 xl:mt-20 md:mt-[-80px] mt-[-40px]">
                <div className="relative custom-container">
                    <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-16">
                        ...
                        <div className="xl:col-span-5 col-span-12 text-black">
                            <h2 className="4xl:text-[60px] 2xl:text-[54px] xl:text-[45px] lg:text-[45px]md:text-[30px] text-[26px] max-[350px]:text-[22px] font-light mb-8 mt-10 xl:mt-0">Related Solutions</h2>
