...
export default function Page() {
    return (
        ...
        custom-container"
                ...
                >
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1  xl:pt-10 pt-5">
                        ...
                        <div className="xl:col-span-5 col-span-12">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 text-[16px]  md:text-[18px] 2xl:text-[20px] xl:text-[18px] xl:mt-5 mt-3 lg:pr-10">
                        ...
                        <div className="xl:col-span-5 col-span-12  bg-[#0A69B7] absolute xl:left-[44%] left-0 top-[40rem] max-[380px]:top-[44rem] md:left-[30px] md:top-[26rem] xl:top-[22rem] text-white p-10 pb-12  xl:w-[500px]">
                            ...
                            <ul className="list-disc xl:space-y-5  space-y-3  marker:font-bold marker:text-2xl pl-5  2xl:text-[20px] xl:text-[18px] text-[16px] md:text-[18px] lg:pr-4 mt-5">
            ...
            <div
                className="xl:mt-40 max-[400px]:mt-[40rem] mt-[35rem] md:mt-[26rem]
                        ...
                        <div className="relative 4xl:w-[1014px] 2xl:w-[980px] xl:w-[850px] xl:h-[1621px] pb-16 xl:pb-0">
                            ...
                            <div className="relative bg-opacity-80 text-white z-10   rounded-lg">
                                ...
                                <div className="xl:pl-20   xl:pr-0 xl:pt-10 pt-5">
                                    ...
                                    <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[16px] xl:mt-5 mt-3 xl:pr-64   font-light">
                                ...
                                <div className="xl:pl-20  pt-10">
                                    ...
                                    <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[16px] mt-5 xl:pr-64 ">
                                ...
                                <div className="xl:pl-20  pt-5">
                                    ...
                                    <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] text-[16px] md:text-[18px] xl:mt-5 xl:pr-64 ">
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#C4EBEA] custom-container w-full xl:pr-20 xl:pb-20 pb-10 pt-[8rem] xl:pt-[5rem]">
                            ...
                            <ul className="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] font-medium leading-tight marker:font-bold marker:text-2xl  md:text-[18px] ">
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 items-start relative z-10 gap-10">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-[#E8DFC7] w-full xl:pb-20 pb-10 pt-[6rem] xl:!pl-16 mt-[-3rem] custom-container">
                            ...
                            <ul className="list-disc mt-5 pl-5 space-y-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] font-medium leading-tight marker:font-bold marker:text-2xl">
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-16">
                        ...
                        <div className="xl:col-span-5 col-span-12 text-black">
                            ...
                            <div className="space-y-10">
                                <div>
                                    <Link href='/services/business-transformation/grow-with-sap-services' className="text-[#0C8AD4] font-semibold underline 4xl:text-[22px] 2xl:2xl:text-[20px] xl:text-[18px] md:text-[20] text-[18px]">SAP S/4HANA for Education</Link>
                                    <p className="text-gray-700 mt-2 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[17px]  xl:pr-0">Robust ERP for education finance, HR, and campus operations.</p>
                                    <hr className="mt-8 border-gray-300 border-1" />
                                </div>

                                <div>
                                    <Link href='/solutions/enterprise-platforms/salesforce-revenue-cloud-consulting' className="text-[#0C8AD4] underline font-semibold 4xl:text-[22px] 2xl:2xl:text-[20px] xl:text-[18px] md:text-[20] text-[18px] pr-10 xl:pr-0">Salesforce Marketing and Revenue Cloud</Link>
                                    <p className="text-gray-700 mt-2  4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[17px]  xl:pr-0">Personalized campaigns and dynamic pricing.</p>

                                    <hr className="mt-8 border-gray-300 border-1" />
                                </div>
                                <div>
                                    <Link href='/services/spend-management/sapbuyplus-ariba-implementation-partner' className="text-[#0C8AD4] underline font-semibold 4xl:text-[22px] 2xl:2xl:text-[20px] xl:text-[18px] md:text-[20] text-[18px]">SAP ARIBA for Education</Link>
                                    <p className="text-gray-700 mt-2  4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[18px] text-[17px]">Procurement solutions for campus operations.</p>
