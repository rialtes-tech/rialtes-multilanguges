  ...
  return (
    <>
      ...
      <div className="w-full hidden md:flex flex justify-center items-center min-h-screen bg-white-100 bg-cover">
        <div
          className="relative w-full h-[650px] bg-cover bg-center flex items-center justify-center mt-[-350px] ml-[-20px]"
        ...
        >
          <div className="text-left text-white px-0 ml-[-586px] mt-[-37px] ">
            ...
            <h1 className="leading-tight font-light mt-5 ml-[-128px]">
              Powering the Future <br /> of Manufacturing
            </h1>
            <h3 className="text-[40px] font-semibold mt-8 ml-[-128px]">
      ...
      <div className="flex md:flex justify-center items-center bg-white px-4 h-[1px] mt-[-100px] mb-[80px]">
      ...
      <div className="block md:hidden ">
        <div
          className="relative w-full h-[400px] bg-cover bg-center flex items-end justify-start mt-[7rem]"
      ...
      <div className="hidden md:flex max-w-[1600px] mx-auto flex-col md:flex-row items-center justify-between px-4 py-16 mt-[30px] gap-13 ml-[163px]">
      ...
      <div className="hidden md:block relative  h-[668px] ml-[280px] mt-[30px]  bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("/images/manufacture/Group 592.webp")' }}>
      ...
      <div className="hidden md:flex mx-auto ">
        <div className="w-[852px] h-[725px] bg-[#DDF74D] p-10 flex flex-col justify-center pl-[256px]">
      ...
      <div className="max-w-7xl hidden md:block mx-auto px-4 py-16 space-y-24 mt-[-100px]">
        ...
        <div className="relative flex justify-center ">
          ...
          {/* Text Overlay */}
          <div className="absolute top-1/2 -translate-y-1/2 bg-[#33A316] text-white p-8 w-[595px] h-[699px] shadow-lg ml-[-758px]">
      ...
      <div className="flex justify-center py-12 hidden md:block relative">
        ...
        >
          ...
          <div className="text-white w-[650px] flex justify-between px-8 py-10 rounded shadow-lg ml-[200px] mb-[80px] pt-20 pb-20 relative overflow-visible">
            ...
            <button
              className="absolute bottom-[-55px] left-[115px] transform -translate-x-1/2 bg-[#006FBE] hover:bg-[#ffffff] hover:text-[#134874] border border-[#134874] font-semibold text-white transition duration-300 w-[162px] h-[60px] z-20 text-[20px]"
            >
              <Link href="/contact-us">Learn More</Link>
      ...
      <div className="ml-0 md:ml-[280px] px-4 sm:px-6 md:px-0">
        <ContactForm
          title={
            <>
