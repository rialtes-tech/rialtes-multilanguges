...
export default function Page() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[399px] xl:h-[650px]">
        ...
        >
          <div className="grid xl:grid-cols-12 grid-cols-1 gap-20 xl:mt-20">
            <div className="xl:col-span-5 col-span-12 xl:pr-0 pr-[35rem] mt-20">
              <h3 className="text-white xl:text-[24px] text-[18px] font-bold mb-2 mt-10">Manufacturing</h3>
              <h1 className="text-white  leading-tight mt-5 pr-10 xl:pr-0">
                Powering the Future of Manufacturing
              </h1>
              <h3 className="xl:text-[40px] mt-10 text-white font-bold text-[18px]">Smarter, Faster, Connected</h3>
      ...
      <section className="relative h-[625px] xl:h-[692px] overflow-hidden mt-20 xl:mr-[142px]">
        <div className="xl:block hidden">
          <Image
        ...
        >
          <div className="relative p-6 w-[512px] h-[692px] xl:block hidden">
            ...
            <div className="relative  bg-opacity-80 text-white z-10 p-4 rounded-lg">
              ...
              <h3 className="xl:text-[36px] text-[22px] mt-5 leading-tight font-semibold">Leading the Digital Reinvention of Manufacturing</h3>
      ...
      <section className="relative xl:h-[790px] h-[1150px] xl:ml-[280px]">
        <div></div>
        <div className="xl:block hidden">
          <Image
        ...
        >
          ...
          <div className="grid xl:grid-cols-12 grid-cols-1  xl:pt-10 pt-5 xl:pb-32 pb-10">
            ...
            <div className="xl:col-span-5 col-span-12 xl:pt-8 xl:pl-16 xl:mt-0 mt-[38rem] mx-[35px] xl:mx-0">

              <h2 className="leading-tight">Rialtes’ End-to-End Manufacturing Transformation Services</h2>
              <p className="mt-5 font-normal pr-8 xl:pr-0">Our services cover the entire manufacturing value chain, from advisory and architecture to implementation, testing, and continuous innovation. </p>
              <p className="xl:mt-5 font-normal">We collaborate with leading platforms like SAP, Salesforce, MuleSoft, and Kinaxis to provide scalable, integrated, and future-ready solutions. Rialtes brings together technology, process, and industry expertise under one roof to deliver seamless transformation.</p>
              <div className="mt-5">
      ...
      <section className="relative grid xl:grid-cols-12 grid-cols-1">
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="xl:col-span-4 col-span-12 bg-[#C17B57] text-white xl:pl-14 pr-14 pt-14 p-10 pb-0 w-full">
            <h2 className="leading-tight">Pre-Built Manufacturing Accelerators</h2>
            <h3 className="xl:text-[36px] text-[22px] mt-5 font-semibold">Speed, Scale, Success</h3>
            <p className="mt-5 xl:mb-10 mb-5 font-normal xl:pr-20 pr-5 leading-tight">With industry-specific accelerators, Rialtes enables manufacturers to deploy ready-to-use solutions that cut down months of setup time. From smart factory templates to AI-powered predictive workflows, our tools are designed to accelerate value realization, improve productivity, and drive intelligent operations. Our accelerators also ensure regulatory compliance and quality assurance, reducing risks during implementation.</p>
      ...
      <section className="xl:mx-[280px] mt-16">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="xl:col-span-5 col-span-12 mx-[35px] xl:mx-0 order-2 xl:order-1">
            <h2 className="leading-tight mt-10 xl:mt-0">Discrete Manufacturing</h2>
            <h3 className="xl:text-[36px] text-[22px] mt-5 font-semibold xl:pr-20 leading-tight">
              Managing Complex Products Made Simple
            </h3>
            <p className="mt-5 xl:mb-10 font-normal xl:pr-24 pr-5 leading-tight">
      ...
      <section className="relative xl:h-[668px]  xl:ml-[280px] mt-20">
        <div></div>
        <div className="xl:block hidden">
          <Image
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="col-span-5 bg-[#DDF74D] order-2 xl:order-1 pb-10 xl:pb-0">
            <div className="xl:ml-[280px] mx-[35px] xl:mx-0">
              <h2 className="leading-tight mt-10 pr-20 xl:pr-0">Repetitive Manufacturing</h2>
              <h3 className="xl:text-[36px] text-[22px] mt-5 font-semibold xl:pr-20 leading-tight">
                Streamlining Mass Production Operations
              </h3>
              <p className="mt-5 xl:mb-5 font-normal xl:pr-10 pr-5">
      ...
      {/* robotics section */}
      <section className="xl:mx-[280px] mx-[35px]">
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-16 text-white">
          <div className="col-span-6">
            ...
            <div className="bg-[#CA7D12] p-12">
              <h2 className="leading-tight ">AI & Robotic Manufacturing</h2>
              <h3 className="xl:text-[42px] text-[22px] mt-5 font-semibold xl:pr-20 leading-tight">
          ...
          <div className="col-span-6 xl:mt-32 mt-10">
            ...
            <div className="bg-[#0963C4] p-12">
              <h2 className="leading-tight">Job Shop Manufacturing</h2>
              <h3 className="xl:text-[42px] text-[22px] mt-5 font-semibold xl:pr-20 leading-tight">
      ...
      <section className="xl:mt-48 xl:ml-[280px] mx-[35px] xl:mx-0 mt-[28rem]">
        <div className="grid xl:grid-cols-12 grid-cols-1 gap-5">
          ...
          <div className="xl:col-span-6 col-span-12 order-1 xl:order-2">
            <Image
              ...
              alt=""
              priority
              className="w-full xl:h-[565px] object-cover"
              width={0}
              height={0}
            />
          </div>
          ...
          <div className="xl:col-span-5 col-span-12 order-2 xl:order-1">
            <h2 className="leading-tight pr-16 xl:pr-0">ERP Integration with SAP & Oracle via MuleSoft</h2>
            <h3 className="mt-5 xl:text-[42px] text-[22px] leading-tight font-semibold">End-to-End Visibility</h3>
      ...
      <section className="mt-16 xl:ml-[280px] mx-[35px] xl:mx-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-16">
          <div className="xl:col-span-5 col-span-12 order-2 xl:order-2">
            <h2 className="leading-tight mt-8 xl:mt-0">Demand Planning with Kinaxis RapidResponse</h2>
            <h3 className="mt-5 xl:text-[42px] text-[22px] leading-tight font-semibold">Staying Ahead of the Curve</h3>
            <p className="mt-8 pr-10 font-normal leading-tight">
      ...
      <section className="xl:ml-[280px] mt-16">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          <div className="xl:hidden block">
            <Image
          ...
          <div className="xl:col-span-4 bg-[#33A316] p-10 text-white xl:mt-10 mb-10 z-[9] mx-[35px] xl:mx-0 mt-[-115px]">
            <div className="xl:col-span-5 col-span-12">
          ...
          <div className="xl:col-span-8 col-span-12 xl:block hidden">
            <Image
              src="/images/industry/manufacture/ai.webp"
              alt=""
              priority
              className="w-[393px] xl:w-[1380px] xl:h-[830px] absolute xl:ml-[-300px]"
              width={0}
              height={0}
            />
          </div>
      ...
      <section className="xl:mt-24 mt-16 mx-[24px] xl:mx-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-16">
          ...
          <div className="xl:col-span-4 col-span-12">
            <h2 className="leading-tight mt-8 xl:mt-0">SAP & Salesforce</h2>
            <h3 className="mt-5 xl:text-[42px] text-[22px] leading-tight font-semibold">The Power Duo for Intelligent Manufacturing</h3>
            <p className="mt-8  font-normal leading-tight">
      ...
      <section className="mt-20 relative">
        ...
        <div className="xl:hidden block">
          ...
          alt=""
          priority
          className="w-full h-[1320px]"
          width={0}
          height={0}
        />
        </div>
        <div className="grid xl:grid-cols-12 grid-cols-1 absolute top-20 text-white mx-[35px] xl:mx-0 mt-64 xl:mt-0">
          <div className="col-span-7 xl:ml-[280px]">
            <h2>Fast Facts</h2>
            <h3 className="mt-5 xl:text-[42px] text-[22px]">Manufacturing Industry Insights</h3>
            <div className="grid xl:grid-cols-12 grid-cols-1 mt-10">
              <div className="col-span-6">
                <div>
                  <h2 className="text-[#068EDA] font-extrabold leading-tight text-[40px] xl:text-[60px]">70% </h2>
                  <h3 className="pr-10 leading-tight">of manufacturers are accelerating Industry 4.0 investments.</h3>
                </div>
                <div className="mt-16">
                  <h2 className="text-[#068EDA] font-extrabold leading-tight text-[40px] xl:text-[60px]">76% </h2>
                  <h3 className="pr-10 leading-tight">of companies struggle with real-time supply chain visibility.</h3>
                </div>

                <div className="mt-16">
                  <h3 className="leading-tight">Cloud-enabled manufacturing systems increase equipment effectiveness by </h3>
                  <h2 className="text-[#068EDA] font-extrabold leading-tight text-[40px] xl:text-[60px]">15%.</h2>

                </div>
                 <div className="xl:mt-[65px] mt-[325px] absolute  xl:relative">
                <LearnMore bgcolor={"#006FBE"} bordercolor={"#006FBE"} />
              </div>


              </div>
              <div className="col-span-6 xl:space-y-10 mt-10 xl-mt-0">
                <div>
                  <h3 className="pr-10 leading-tight">AI adoption in manufacturing expected to surpass   </h3>
                  <h2 className="text-[#068EDA] font-extrabold leading-tight text-[40px] xl:text-[60px]">$20 billion </h2>
  ...
  text-black xl:py-20 pb-10"
      >
        <ContactForm title={'Ready to Reimagine Your Manufacturing Future?'} subtitle={"Partner with Rialtes to transform your manufacturing operations with AI, SAP, Salesforce, and next-gen tools. "} subtitle1={"Contact Us Today and start your journey toward intelligent, resilient, and customer-centric manufacturing!"} className={"max-w-[62rem] xl:font-medium xl:text-[60px] text-[26px]"} />
      </div >
    </div >
  );
}