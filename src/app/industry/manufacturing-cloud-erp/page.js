...
export default function Page() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative   custom-container mt-20">
        <div></div>
        <div className="xl:block hidden">
          <Image
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="col-span-5 bg-[#DDF74D] order-2 xl:order-1 pb-10 xl:pb-0">
            <div className="custom-container xl:!pr-0">
              <h2 className="leading-tight mt-10">Repetitive Manufacturing</h2>
              <h3 className="xl:text-[36px] text-[22px] mt-5 font-semibold leading-tight">
                Streamlining Mass Production Operations
              </h3>
              <p className="mt-5 xl:mb-5 font-normal xl:pr-10">
      ...
      <section className="custom-container mt-16 xl:!pr-0">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          <div className="xl:hidden block">
            <Image
          ...
          <div className="xl:col-span-7 md:col-span-1 col-span-12">
            ...
            <div className="grid xl:grid-cols-12 grid-cols-12 md:grid-cols-2 mt-10">
              ...
              <div className="xl:col-span-6 md:col-span-1 col-span-12 xl:space-y-10 mt-10 xl-mt-0">
                <div>
                  <h3 className="pr-10 leading-tight font-medium">AI adoption in manufacturing expected to surpass   </h3>
  ...
  text-black xl:py-20 pb-10"
      >
        <ContactForm title={'Ready to Reimagine Your Manufacturing Future?'} subtitle={"Partner with Rialtes to transform your manufacturing operations with AI, SAP, Salesforce, and next-gen tools. "} subtitle1={"Contact Us Today and start your journey toward intelligent, resilient, and customer-centric manufacturing!"} className={"max-w-[62rem] xl:font-normal leading-tight xl:text-[60px] text-[26px]"} />
      </div >
    </div >
  );
}