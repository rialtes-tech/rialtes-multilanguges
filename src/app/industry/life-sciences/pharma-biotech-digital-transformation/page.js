...
export default function Page() {
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="custom-container absolute bottom-0 ">
                    <div className="grid md:grid-cols-12 grid-cols-1">
                        <div className="md:col-span-7 col-span-12">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] md:text-[16px] text-[16px] mt-5 leading-tight">
                    ...
                    <div className="custom-container grid grid-cols-1 gap-[21px] lg:gap-[32px] md:grid-cols-2 xl:grid-cols-3 text-black relative z-10">
                        {[
                            ...
                            <div key={index} className="bg-white xl:p-14 p-[40px]  rounded border border-black sm:mx-auto sm:w-[96%] w-full md:w-full ">
                                <h3 className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] lg:text-[18px] text-[20px] font-bold leading-tight ">{item.title}</h3>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 xl:gap-[158px] lg:gap-[108px] lg:mt-[60px] mt-[44px] ">
                        ...
                        <div className="4xl:w-[532px] 2xl:w-[510px]">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] text-[16px] mt-5">
                        ...
                        <div className="">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] text-[16px]  mt-5 pr-4 xl:pr-20 leading-tight">
            ...
            <div
                className="custom-container h-full mt-[141px] lg:mt-[165px]"
            >
                ...
                <div
                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 relative ">
                        <div className="lg:col-span-6 col-span-12 lg:mt-[93px] mt-[500px md:mt-[600px] sm:mt-[500px] mt-[480px] lg:ml-[61px] ml-[36px] lg:mb-[81px] mb-[40px]">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] text-[16px] mt-5 lg:pr-4 pr-8">
                ...
                <div
                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 relative text-black">
                        ...
                        <div className="lg:col-span-7 lg:order-2 col-span-12 lg:mt-[93px] mt-[500px md:mt-[600px] sm:mt-[500px] mt-[480px] lg:ml-[61px] lg:mr-[20px] ml-[36px] lg:mb-[81px] mb-[40px]">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] text-[16px] mt-5 xl:pr-20 pr-10">
                ...
                >
                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 3xl:gap-[120px] lg:gap-[80px] xl:gap-[96px] gap-y-[59px]">
                        <div className="lg:col-span-6 col-span-12 mt-[-4rem] md:w-[80%] lg:w-full">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] 2xl:text-[18px] text-[16px] mt-5">
                        ...
                        <div className="lg:col-span-6 col-span-12 lg:mt-64 mt-0 md:w-[80%] lg:w-full">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] 2xl:text-[18px]  mt-5 pr-10 leading-tight">
                            ...
                            <p className="bg-[#163055] absolute  4xl:text-[26px] 2xl:text-[24px] xl:text-[20px] lg:text-[18px]  md:text-[20px] text-[18px] p-10 lg:mt-[100px] xl:mt-[100px] 2xl:mt-[140px] mt-[40px]  leading-tight">Enhancing patient safety, outcomes, and evidence generation.</p>
            ...
            >
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    ...
                    <div className="col-span-6 4xl:w-[532px] 2xl:w-[480px] xl:w-[460px] lg:w-[450px] md:w-[450px]">
                        ...
                        <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] 2xl:text-[18px] mt-5 font-bold leading-tight">
                ...
                >
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1 mt-10 text-white">
                        ...
                        <div className="xl:col-span-6 col-span-12">
                            ...
                            <ul className="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] 2xl:text-[18px] text-[16px] mt-5 font-medium pr-6 xl:pr-0">
