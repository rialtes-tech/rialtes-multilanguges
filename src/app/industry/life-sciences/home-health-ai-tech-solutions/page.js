...
export default function Page() {
  ...
  const schemaData = {
    ...
    description:
      "Rialtes provides AI-powered Home Health Care Technology Solutions built on Salesforce to support remote monitoring, virtual consultations, personalized care, and digital transformation in home-based healthcare delivery.",
    publisher: {
      "@type": "Organization",
      name: "Rialtes",
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Track vitals and symptoms via wearables integrated with Salesforce Health Cloud to enable real-time alerts and chronic care management.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Automated care plans, mobile dashboards, and real-time task tracking for clinicians and caregivers.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Predictive health monitoring, smart care planning, and AI diagnostics for proactive home care delivery.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Unified health records, appointment scheduling, care plan automation, and real-time patient engagement via Salesforce.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Real-time, HIPAA-compliant messaging between care teams and patients using Salesforce-integrated WhatsApp communication.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Discreet access to mental health professionals via virtual counseling, mood-tracking tools, and wellness check-ins.",
            },
          },
        ],
      },
  ...
  const capabilitiesData = [
    {
      title:
        "Intelligent Appointment Scheduling for Home Visits & Virtual Care",
  ...
  return (
    <section className="min-h-screen bg-white">
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Home Health" />
      {/* herosection */}
            ...
            <div className="col-span-12">
              <h1 className="text-[#FFFFFF] text-[18px] md:text-[24px] font-bold lg:w-full">
                ...
                <div className="text-[#FFFFFF] text-[26px] leading-tight xl:text-[40px] 4xl:text-[60px] mt-[11.5px] md:mt-[28.5px]">
                  ...
                  <div className="min-[330px]:block hidden" /> to Connect
                  Patients <div className="min-[330px]:block hidden" /> with
                  Their Providers
                </div>
              </h1>
            </div>
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[40px] gap-y-[28px]">
          ...
          <div className="lg:col-span-6 xl:col-span-5 col-span-12">
            <p className="text-[16px] 4xl:text-[22px] xl:text-[18px] font-normal mt-[6px] w-[90%] md:w-[80%] lg:w-full">
              The need for efficient and patient-centric care is greater than
              ever. Our home health services provide healthcare organizations
              with cutting-edge mobile and home health technology solutions for
              remote patient monitoring, virtual consultations, and personalized
      ...
      <section className="custom-container xl:mt-[166px] mt-[49px]">
        ...
        <p className="text-[16px] 4xl:text-[22px] xl:text-[18px] font-normal xl:mt-[39px] mt-[28px] w-[90%] lg:w-[65%] 4xl:w-[70%]">
          While home-based care offers a transformative opportunity for
          healthcare delivery, it must overcome several long-standing
          challenges. At Rialtes, we design next-gen Remote Monitoring and Home
          Health solutions on Salesforce Health Cloud to break down these
          barriers and deliver equitable, efficient, and empathetic care.
        </p>
        {addressingData.map((data, ind) => {
          ...
          const content = [
            <React.Fragment key="image">
              ...
              <div
                className={`lg:col-span-8 col-span-12 xl:pt-[51px] xl:pb-[93px] xl:px-[68px] pt-[29px] pb-[64px] px-[30px] relative  ${!isEven && "lg:order-1 order-2"}`}
                key="text"
              >
                <h2 className="4xl:text-[30px] xl:text-[26px] text-[22px] leading-tight text-[#0A6BB8] font-semibold w-[90%] md:w-full">
                  {data.title}
                </h2>
                <p className="text-[16px] 4xl:text-[22px] xl:text-[18px] font-normal xl:mt-[39px] mt-[19px] w-[90%] lg:w-[94%]">
                  {data.desc}
                </p>
                <div className="xl:mt-[40px] mt-[20px] absolute">
                  <LearnMore
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1">
          <div className="lg:col-span-5 col-span-12 lg:my-[40px] max-md:mx-[36px] lg:mr-[-90px] max-md:mt-[-120px] relative z-20 lg:order-1 order-2">
            <div className="bg-[#006FBE] text-[#ffffff] xl:pt-[69px] xl:pb-[96px] lg:pl-[63px] xl:pr-[20px] pt-[39px] pb-[70px] px-[26px]">
              <h2 className="4xl:text-[60px] xl:text-[40px] text-[26px] leading-tight font-light w-[90%] lg:w-[60%] xl:w-full">
                Global Expertise, Locally Delivered
              </h2>
              <p className="text-[16px] 4xl:text-[22px] xl:text-[18px] font-normal xl:mt-[65px] mt-[25px] w-[94%] lg:w-[90%]">
                With certified expertise in Salesforce Life Sciences Cloud and
                SAP S/4HANA for Pharma, Rialtes brings together global
                innovation and local compliance. Operating across India, the
                United States, Canada, and Singapore, we ensure that your home
                health programs align with regional regulations while following
                global best practices in healthcare delivery and digital
                transformation.
              </p>
          ...
          <div className="lg:col-span-7 col-span-12 lg:order-2 order-1">
            <Image
              src="/images/home-health/Mobile/global-mob.webp"
              alt="mobile"
              className="block md:hidden w-full h-full object-cover"
              width={375}
              height={250}
            ...
            />
            <Image
              src="/images/home-health/global-desk.webp"
              alt="desktop"
              className="hidden md:block w-full h-full object-cover"
              width={1200}
              height={630}
      ...
      <section className="custom-container xl:mt-[119px] mt-[85px]">
        <div className="grid xl:grid-cols-12 grid-cols-1 gap-y-[29px] xl:gap-[60px]">
          ...
          <div className="xl:col-span-5 col-span-12">
            <p className="text-[16px] 4xl:text-[20px] xl:text-[18px] font-normal md:w-[80%] xl:w-full">
              Artificial Intelligence is redefining what’s possible in
              home-based care. By enabling predictive insights, personalized
              treatment, and real-time decision-making, AI empowers care teams
              to move from reactive to proactive care models, improving patient
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[20px] sm:w-[70%] md:w-full">
            {aiRovolutionizingData.map((data, ind) => {
              return (
                <div
                  key={ind}
                  className="border border-[#707070] xl:pt-[52px] xl:pb-[56px] xl:px-[40px] pt-[32px] pb-[32px] px-[26px]"
                >
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 xl:mt-[36px] mt-[17px] lg:gap-[60px] gap-y-[17px]">
            ...
            <div className="lg:col-span-7 col-span-12">
              <p className="text-[16px] 4xl:text-[20px] xl:text-[18px] font-normal w-[90%] md:w-[70%] lg:w-full 4xl:w-[90%]">
                We integrate AI into every layer of your Salesforce-powered home
                health ecosystem, transforming your operations with intelligent
                automation and insight-driven care.
              </p>
            </div>
          </div>
              ...
              return (
                <div key={ind}>
                  ...
                  <UnorderedList
                    ...
                    ulClassName="xl:space-y-[24px] space-y-[19px] list-disc xl:mt-[35px] mt-[17px] pl-[20px] w-[90%] md:w-full 4xl:w-[90%]"
      ...
      <section className="custom-container bg-[#0A6BB8] text-[#ffffff] xl:mt-[247px] mt-[174px]">
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[80px] gap-y-[40px]">
          <div className="relative mt-[-120px]">
            <Image
              src="/images/home-health/Mobile/agent-chat-mob.webp"
              alt="mobile"
              className="block md:hidden w-full h-full object-cover"
              width={375}
              height={250}
            ...
            />
            <Image
              src="/images/home-health/agent-chat-desk.webp"
              alt="desktop"
              className="hidden md:block w-full h-full object-cover md:h-[600px] lg:h-full"
              width={1200}
              height={630}
              priority
            />
          ...
          <div>
            ...
            <p className="text-[16px] 4xl:text-[20px] xl:text-[18px] font-normal w-[90%] lg:w-full xl:mt-[35px] mt-[24px]">
              ...
              AgentChat—a powerful solution that instantly connects with
              patients and caregivers through WhatsApp, all within Salesforce.
              With AgentChat, your care teams can respond to patients, families,
              and field staff using the world’s most popular messaging app,
              while keeping every conversation tracked and accessible.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] gap-y-[19px] mt-[40px] xl:mt-[80px] items-stretch">
          ...
          <div className="lg:col-span-6 xl:col-span-7 col-span-12">
            <UnorderedList
              arrName={homeHealth}
              ulClassName="xl:space-y-[24px] space-y-[19px] list-disc pl-[20px] w-[90%] md:w-full 4xl:w-[90%] lg:pb-[120px]"
              liClassName="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight font-normal"
            />
          </div>
        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 md:gap-x-[60px] xl:gap-x-0 gap-y-[40px] xl:mt-[83px] mt-[40px] sm:w-[80%] xl:w-full">
          {relatedData.map((data, ind) => {
            const paddingRight = (ind) => {
              if (ind === 0)
                return "xl:pr-[60px] xl:border-r max-lg:border-b border-[d4d7db]";
              if (ind === 1)
                return "max-lg:border-b border-[d4d7db] xl:border-r xl:px-[40px] ";
              if (ind === 2)
                return "xl:px-[40px] max-lg:border-b xl:border-r border-[d4d7db]";
              if (ind === 3) return "xl:pl-[40px]";
              return "";
            };
            return (
              <div
                className={`${paddingRight(ind)} flex flex-col pb-[30px] xl:pb-0`}
                key={ind}
              >
      ...
      <section className="custom-container xl:mt-[130px] xl:mb-[130px] mt-[65px] mb-[48px] scroll-mt-28" ref={contactRef}>
        <ContactForm
          title={
            "Ready to Deliver Proactive, Connected, and Compassionate Care Directly to Patients?"
          }
          subtitle="Transform your patient care model with Rialtes’ Salesforce-powered home health solutions"
          className={
            "font-normal text-[26px] leading-tight xl:text-[40px] 4xl:text-[60px] xl:w-[60%] 4xl:w-[80%]"
          }
        />
      </section>
    </section>
