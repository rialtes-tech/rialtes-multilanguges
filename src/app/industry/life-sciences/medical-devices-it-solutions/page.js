...
const schemaData = {
  ...
  description:
    "Rialtes delivers customized IT solutions for the medical device industry powered by Salesforce, SAP, and cloud technologies. Our services support R&D, Quality Management Systems (QMS), compliance, sales automation, and supply chain optimization for MedTech organizations.",
  publisher: {
    "@type": "Organization",
    name: "Rialtes",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Ensure FDA and ISO compliance with advanced QMS and audit trail capabilities using SAP S/4HANA and Salesforce Health Cloud.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Empower field sales and service agents with real-time insights, mobile access, and automated lead-to-quote processes.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Enhance visibility and agility across procurement, production, and distribution using SAP Digital Supply Chain solutions.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Streamline R&D, testing, and market launch cycles with integrated SAP PLM and collaboration tools.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Optimize medical equipment servicing with predictive maintenance, IoT integration, and mobile workflows via Salesforce Field Service.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Drive decision-making with real-time analytics, clinical performance dashboards, and data harmonization using Tableau and Salesforce Data Cloud.",
          },
        },
      ],
    },
          ...
          >
            ...
            <div className="lg:col-span-6 col-span-12 z-10 flex flex-col mt-[60px] lg:mt-0">
              ...
              <div className="order-3">
                ...
                <UnorderedList
                  arrName={challenge.points}
                  ulClassName="list-disc lg:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] text-[16px] lg:mt-[46px] leading-tight mt-[25px]"
                  liClassName=""
                />
              </div>
            </div>
...
export default function Page() {
  ...
  return (
    <div className="bg-white">
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Medical Devices" />
      {/* hero section */}
        ...
        <div className="h-full relative custom-container">
          <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-20 xl:mt-20">
            <div className="4xl:col-span-7 xl:col-span-6 col-span-12 sm:pr-5">
              <h3 className="text-white xl:text-[24px] text-[18px] leading-tight font-bold xl:mb-2 mb-5 xl:mt-32 mt-20">
                Medical Devices
              </h3>
              ...
              <h3 className="4xl:text-[45px] xl:text-[33px] md:text-[18px] mt-5 text-white font-bold leading-tight pr-16 xl:pr-0">
                Rialtes Life Sciences & Medical Devices Solutions
              </h3>
            </div>
      ...
      <section className="xl:mt-10 mt-4 custom-container">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          <div className="xl:col-span-10 col-span-12 leading-tight font-medium">
            <p className="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight mt-10">
              {" "}
              In today’s fast-evolving Medical Device industry, companies are
              under immense pressure to innovate faster, improve patient
              outcomes, ensure regulatory compliance, and manage complex global
              supply chains. At Rialtes, we bring deep domain expertise in
              Medical Devices, SAP S/4 HANA, Salesforce Life Sciences Cloud, and
              AI-driven solutions to deliver end-to-end consulting, advisory,
              implementation, integration, and post-go-live services that help
              medical device companies accelerate their growth while staying
              compliant and patient-centric.
            </p>
            <p className="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight mt-5">
              {" "}
              With offices in the United States, Canada, India, and Singapore,
              Rialtes operates as a global partner equipped to solve real-world
              challenges with next-generation digital solutions.
            </p>
          </div>
        ...
        <div className="custom-container absolute md:mt-[86px] lg:mt-[106px] max-md:bottom-[52px] md:bottom-auto">
          <div className="grid md:grid-cols-12 grid-cols-1">
            <div className="md:col-span-7 2xl:col-span-6 col-span-12">
              <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] xl:mt-10 mt-5">
                Thought Leadership:
              </h2>
              <h3 className="4xl:text-[42px] xl:text-[35px] text-[22px] xl:mt-5 mt-3 font-bold leading-tight xl:w-[90%]">
                Helping Medical Device Companies Move from Compliance to
                Competitive Advantage
              </h3>
              <p className="4xl:text-[22px] xl:text-[20px] text-[16px] mt-5 leading-tight">
                Rialtes focuses on bringing together strategy, technology, and
                patient-centric design, helping Medical Device companies:
              </p>
              <UnorderedList
                arrName={thoughLeadershipData}
                ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 4xl:text-[20px] xl:text-[18px] text-[16px] mt-5 leading-tight"
                liClassName=""
              />
            </div>
          </div>
        ...
        <div className="custom-container">
          <div className="relative p-6 md:p-12 4xl:w-[690px] 4xl:h-[430px] xl:w-[520px] xl:h-[367px]">
            ...
            <div className="relative bg-opacity-80 text-white z-10 xl:p-4 rounded-lg ">
              <h2 className="4xl:text-[60px] xl:text-[42px] text-[26px] leading-tight">
                Why Partner with Rialtes for Medical Device Transformation
              </h2>
            </div>
          </div>
        </div>
        <div className="absolute bottom-[-260px] sm:bottom-[-80px] md:bottom-[-80px]">
          <div className="custom-container grid grid-cols-1 gap-[21px] lg:gap-[32px] md:grid-cols-2 xl:grid-cols-3 text-black relative z-10">
            {whyPartnerData.map((item, index) => (
              <div
                key={index}
                className="bg-white xl:p-12 p-[40px] border-[1px] border-solid border-[#707070] hover:bg-[#D9F2FF] text-black sm:mx-auto sm:w-[80%] md:w-full"
              >
                <h3 className="4xl:text-[24px] xl:text-[22px] text-[20px] font-bold leading-tight">
                  {item}
                </h3>
              </div>
            ))}
        ...
        <div className="text-white custom-container h-full relative">
          <div className="grid grid-cols-12">
            <div className="4xl:col-span-10 2xl:col-span-7 xl:col-span-8 lg:col-span-11 sm:col-span-11 col-span-12 xl:mt-[106px] mt-[52px]">
              <h2 className="leading-tight  4xl:text-[60px] xl:text-[42px] text-[26px]">
                End-to-End Expertise in Salesforce Life Sciences Cloud & SAP S/4
                HANA for Medical Devices
              </h2>
            </div>
          </div>
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white xl:pt-20 pt-10">
            <div className="xl:col-span-5 col-span-12">
              <h3 className="4xl:text-[40px] xl:text-[33px] text-[28px] font-bold leading-tight">
                Salesforce Life Sciences Cloud{" "}
              </h3>
              <h2 className="4xl:text-[35px] xl:text-[25px] text-[22px] leading-tight mt-5 font-medium xl:font-normal">
                Powering Patient and Provider Journeys
              </h2>
              <UnorderedList
                arrName={salesforceLifeData}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-10 mt-5"
                liClassName=""
              />
            </div>
            ...
            <div className="xl:col-span-5 col-span-12 mt-[72px] xl:mt-0">
              <h3 className="4xl:text-[40px]  xl:text-[33px] text-[28px] font-bold leading-tight">
                SAP S/4 HANA for Medical Devices{" "}
              </h3>
              <h2 className="4xl:text-[35px] xl:text-[25px] text-[22px] leading-tight mt-5 font-medium xl:font-normal">
                {" "}
                Operational & Financial Backbone
              </h2>
              <UnorderedList
                arrName={sapData}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-5 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
                liClassName=""
              />
            </div>
          </div>
      ...
      <div className="xl:mt-[136px] mt-[56px] custom-container h-full relative">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          <div className="3xl:col-span-8 lg:col-span-10 col-span-12">
            ...
            <h3 className="4xl:text-[40px] xl:text-[30px] text-[22px] font-bold xl:mt-[35px] mt-[22px]">
        ...
        <div className="text-white group overflow-hidden relative">
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 relative text-white">
            ...
            <div className="lg:col-span-6 lg:order-2 col-span-12 lg:mt-[92px] lg:mb-[123px] mt-[57px] mb-[95px] lg:mx-[61px] mx-[36px]">
              <h3 className="4xl:text-[40px] xl:text-[32px] text-[22px] leading-tight font-bold">
                Key AI Impact Areas:
              </h3>
              <UnorderedList
                arrName={keyAiData}
                ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight mt-5"
                liClassName=""
              />
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[40px] 2xl:gap-[90px]">
          ...
          <div className="lg:col-span-7 2xl:col-span-6 col-span-12 order-2 lg:order-1">
            ...
            <div className="xl:pr-12 pr-0">
              ...
              <UnorderedList
                arrName={patientData}
                ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 mt-5 leading-tight text-[16px] xl:text-[18px] 4xl:text-[20px]"
                liClassName=""
              />
      ...
      <div className="xl:mt-[129px] mt-[51px] h-full relative custom-container">
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px]">
          ...
          <div className="lg:col-span-6 col-span-12 xl:pl-[55px]">
            <h2 className="4xl:text-[50px] xl:text-[39px] text-[26px] font-light mb-8 leading-tight mt-10 xl:mt-0">
              Integrated Order Management with SAP & Oracle ERP
            </h2>
            <UnorderedList
              arrName={integratedData}
              ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 leading-tight text-[16px] xl:text-[18px] 4xl:text-[20px] xl:mt-5"
              liClassName=""
            />
          </div>
        </div>
        <p className="4xl:text-[26px] xl:text-[22px] text-[18px]  bg-[#0E3157] xl:py-10  text-white xl:mt-[63px] mt-[35px] p-[24px] 2xl:mr-[40px]">
          From manufacturing to delivery — Rialtes keeps the supply chain
      ...
      <div className="xl:mt-[126px] mt-[54px] relative custom-container">
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-20">
          <div className="lg:col-span-6 col-span-12">
            ...
            <h2 className="mt-10 4xl:text-[50px] xl:text-[40px] text-[26px] leading-tight">
              Mobile Apps for Patient-Reported Outcomes
            </h2>
            <h3 className="4xl:text-[38px] xl:text-[30px] text-[22px] xl:mt-10 mt-5 font-bold leading-tight">
              Empowering Real-Time Patient Feedback
            </h3>
            <UnorderedList
              arrName={mobileData}
              ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] mt-5 leading-tight"
              liClassName=""
            />
            <p className="bg-[#068EDA] text-white 4xl:text-[26px] xl:text-[19px] text-[18px] p-[24px] xl:p-[30px] 4xl:p-[40px]  xl:mt-[56px] mt-[38px] leading-tight">
              Putting power in the hands of patients for better outcomes and
              safer devices.
            </p>
          </div>
          <div className="lg:col-span-6 col-span-12 lg:mt-64 mt-16">
            ...
            <h2 className="mt-10 4xl:text-[47px] xl:text-[38px] text-[26px] leading-tight">
              Remote Device Monitoring
            </h2>
            <h3 className="4xl:text-[40px] xl:text-[30px] text-[22px] xl:mt-10 mt-5 font-bold leading-tight">
              Delivering Real-Time Device Insights
            </h3>
            <UnorderedList
              arrName={remoteDeviceData}
              ulClassName="list-disc xl:space-y-4 marker:font-bold marker:text-2xl pl-5 mt-5 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
              liClassName=""
            />
            <p className="bg-[#068EDA] text-white 4xl:text-[26px] xl:text-[19px] text-[18px]  p-[24px] xl:p-[30px] 4xl:p-[40px]  xl:mt-[62px] mt-[38px] leading-tight">
              Better data, better devices, better patient lives.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#184671] text-white pb-20 xl:mt-[16rem] mt-[14rem] relative">
        <div className="mt-[30px] custom-container text-black pt-20 pb-10 lg:pb-20">
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 lg:mt-[61px] mt-[66px] text-white lg:gap-[60px]">
            <div className="lg:col-span-6 col-span-12">
              <h2 className="4xl:text-[50px] xl:text-[40px] text-[26px] leading-tight">
                Salesforce Agentforce{" "}
              </h2>
              <h3 className="4xl:text-[42px] xl:text-[32px] text-[26px] leading-tight xl:font-semibold ">
                Revolutionizing Medical Device Sales & Services
              </h3>
              <p className="4xl:text-[22px] xl:text-[18px] text-[16px] xl:mt-5 mt-8 font-normal leading-tight">
                Agentforce is a game-changing Salesforce solution that enables
                Medical Device sales and service teams to manage complex sales
                cycles, compliance, and patient interactions seamlessly on a
                single platform. Rialtes has a strong Agentforce practice,
                deeply aligned with Medical Device and Life Sciences industry
                needs.
              </p>
              <div className="xl:mt-10 mt-5">
                <button
                  className="bg-white xl:text-[20px] hover:bg-[#ffffff] hover:text-[#134874] border-[1px] border-[solid] border-[#134874] font-semibold text-black py-3 px-8 transition duration-300 order-4 mt-6"
                  aria-label="salesforce agentforce button"
                >
            ...
            <div className="lg:col-span-6 col-span-12">
              <h3 className="4xl:text-[30px] xl:text-[23px] text-[18px] xl:mt-5 mt-8 xl:font-semibold ">
                How Agentforce Empowers Medical Device Companies:
              </h3>
              <UnorderedList
                arrName={salesforceAgentData}
                ulClassName="list-disc leading-tight xl:space-y-4 marker:font-bold marker:text-2xl pl-5 font-medium  mt-5 text-[16px] xl:text-[18px] 4xl:text-[20px]"
                liClassName=""
              />
            </div>
          </div>
        ...
        <div className="absolute sm:mt-[20px] lg:mt-[38px] xl:mt-0">
          <div className="custom-container">
            <p className="4xl:text-[26px] xl:text-[23px] text-[18px]  bg-[#068EDA] xl:py-[52px] xl:pl-[48px] p-[24px] text-white leading-tight font-normal">
              Agentforce delivers a connected, compliant, and patient-first
              approach to sales and service in Medical Devices.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#626262] text-white xl:mt-[16rem] md:mt-[8rem] mt-[10rem] xl:pb-[168px] pb-[119px] relative">
        <div className="custom-container">
          ...
          <h2 className="4xl:text-[60px] xl:text-[40px] text-[26px] text-white mt-10 leading-tight">
            Real-Time Communication with AgentChat
          </h2>
          <div className="grid lg:grid-cols-12 grid-cols-1 text-white mt-8 lg:gap-[60px]">
            <div className="lg:col-span-6 col-span-12">
              <h3 className="4xl:text-[40px] xl:text-[34px] text-[26px] leading-tight font-bold">
                WhatsApp Integration for Medical Devices
              </h3>
              <p className="4xl:text-[22px] xl:text-[18px] text-[16px] mt-8 leading-tight ">
                RialChat, our WhatsApp integration solution, brings instant
                patient, provider, and field service communication:
              </p>
            </div>
            <div className="lg:col-span-6 col-span-12">
              <UnorderedList
                arrName={realTimeData}
                ulClassName="list-disc lg:space-y-4 marker:font-bold marker:text-2xl pl-5 mt-5 font-medium lg:mt-0 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
                liClassName=""
              />
              <div className="mt-5">
                <button
                  className="bg-white xl:text-[20px]  border-[1px] hover:text-[#134874]  font-semibold text-black py-3 px-8 transition duration-300 order-4 mt-6"
                  aria-label="real time know more button"
                >
        ...
        <div className="absolute md:mt-[80px] mt-[60px] 2xl:mt-[90px]">
          <div className="custom-container">
            <p className="text-[18px] xl:text-[23px] 4xl:text-[25px] bg-[#068EDA] xl:p-[48px] p-[24px] text-white inline-block">
              Stay connected with patients and providers on the channel they
              trust.
            </p>
          </div>
        </div>
      ...
      {/* Contact Form */}
      <div
        className="xl:mt-16 mt-10 custom-container text-black py-20 scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={
            "Transform Patient Lives and Medical Device Operations with Rialtes!"
          }
          subtitle="Ready to elevate your medical device operations? Contact Rialtes today to lead the way in patient-centric innovation and compliance."
          className={
            "max-w-[70rem] leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] xl:w-[70%] 4xl:w-full"
          }
        />
      </div>
    </div>
