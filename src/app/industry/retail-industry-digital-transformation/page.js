...
export default function retailPage() {
  const schemaData = {
    ...
    description:
      "Rialtes empowers retail industry digital transformation through SAP and Salesforce. We offer AI-powered personalization, inventory intelligence, omnichannel engagement, and seamless backend integration tailored for retailers.",
    publisher: {
      "@type": "Organization",
      name: "Rialtes",
    ...
    mainEntity: {
      ...
      name: "Retail Industry Digital Transformation Solutions",
      description:
        "SAP and Salesforce-powered digital solutions for the retail industry, enabling AI personalization, inventory intelligence, and omnichannel success.",
      areaServed: [
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Fashion-specific SAP and Salesforce solutions including trend forecasting, real-time inventory, loyalty, and omnichannel experiences.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Hyper-personalized marketing campaigns, automated customer journeys, segmentation, and engagement analytics.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "AI-powered real-time inventory management, demand forecasting, and smart replenishment across all retail locations.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Multi-tier loyalty programs, AI-driven customer insights, gamification, and personalized retention strategies.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Unified backend integration across SAP S/4HANA, Oracle ERP, Salesforce, and MuleSoft for smooth retail operations.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Executive-level dashboards and AI-driven insights for customer behavior, sales forecasting, and marketing performance.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Accelerated delivery, real-time updates, optimized routing, and integrated SAP/Salesforce mobile commerce.",
            },
          },
        ],
      },
  ...
  const newRealityData = [
    {
      ...
      subtitle:
        "Shoppers move between digital and physical touchpoints expecting consistent experiences.",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Multi-channel inventory management, supply chain challenges, and cost pressures.",
    },
    {
  ...
  const aiPoweredCustomerData = [
    {
      mobImgUrl:
        "/images/industry/retail-industry/mobile/aiPowered-agentforce-mob-img.webp",
      deskImgUrl:
        "/images/industry/retail-industry/aiPowered-agentforce-desk-img.webp",
      title: "Agentforce",
      desc: "AI-powered service cloud bots, virtual agents, and personalized support journeys.",
    },
    {
      mobImgUrl:
        "/images/industry/retail-industry/mobile/aiPowered-datacloud-mob-img.webp",
      deskImgUrl:
        "/images/industry/retail-industry/aiPowered-datacloud-desk-img.webp",
      title: "Data Cloud",
  ...
  return (
    <section className="min-h-screen">
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Retail" />
      {/* herosection */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 w-full">
            <div className="col-span-12">
              ...
              <h1 className="text-[#FFFFFF] text-[26px] leading-[34px] md:text-[36px] md:leading-[50px] lg:text-[40px]  2xl:text-[60px] xl:text-[50px] 2xl:leading-[73px] xl:leading-[65px] lg:leading-[50px] mt-[11.5px] md:mt-[28.5px] max-[350px]:text-[22px] max-[350px]:leading-[30px]">
                Rialtes: Your Trusted <br /> Partner for Retail <br /> Industry
                Innovation
              </h1>
            </div>
      ...
      <section className="custom-container xl:mt-[135px] mt-[42px]">
        ...
        <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px]   text-[16px] leading-[19px] xl:leading-[30px] lg:leading-[25px] xl:mt-[34px] mt-[23px] lg:w-[68%] max-md:w-[94%]">
          ...
          experiences across every channel while managing operational complexity
          behind the scenes. At Rialtes, we empower retailers to embrace the
          future of commerce by unifying business processes, customer
          engagement, and intelligent analytics through strategic partnerships
          with SAP, Salesforce, MuleSoft, and Oracle.
          <br />
          <br />
          Our proprietary pre-built accelerators for fashion and restaurant
          verticals ensure you go to market faster, smarter, and with a
      ...
      <section className="custom-container xl:mt-[96px] mt-[59px] max-md:px-0">
        ...
        <div className="bg-[#163055] md:w-[90%] 2xl:w-[80%] max-md:mx-[36px] text-[#ffffff] max-md:mt-[35px]">
          <p className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] lg:text-[18px] text-[18px] leading-tight py-[24px] px-[24px] lg:pl-[31px] font-light">
            We help you turn these challenges into growth opportunities by
            crafting modern, AI-powered, integrated solutions tailored for
            retail.
          </p>
        </div>
          ...
          <div className="md:absolute bottom-[-50px] md:ml-[80px]">
            <div className="bg-[#163055] md:w-[70%] lg:w-[60%] xl:w-[70%] 2xl:w-[60%] text-[#ffffff] max-md:mt-[60px] mx-auto">
              <p className=" 4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] lg:text-[18px] text-[18px]  leading-tight py-[24px] px-[28px] md:px-[24px] lg:pl-[31px] font-light">
                With global presence (US, Canada, India, Singapore), we bring
                  ...
                  <div className="lg:col-span-6 col-span-12 lg:order-1 order-2 relative">
                    <div className="lg:pr-[20px]">
                      ...
                      <div className="lg:pr-[70px]">
                        <p className="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px]   leading-tight font-normal xl:mt-[36px] mt-[15px] max-[400px]:text-[16px]">
                          Fashion is dynamic. So should your retail technology
                          be. Rialtes helps fashion brands:
                        </p>
                        <UnorderedList
                          arrName={fashionRetailData}
                          ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[44px] mt-[21px] pl-[20px] lg:pb-[49px]"
                          liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] max-[400px]:text-[16px] leading-tight font-normal"
                        />
                      </div>
                    </div>
                    <div className="absolute bottom-[-170px] 2xl:bottom-[-102px] 4xl:bottom-[-107px] xl:bottom-[-98px] md:bottom-[-130px]">
                      <div className="bg-[#163055] text-[#ffffff] max-lg:mt-[35px]">
                        <p className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] lg:text-[18px] text-[18px]  leading-tight  py-[24px] px-[24px] lg:pl-[31px] font-light">
                          Our fashion-specific accelerators ensure that your
                          brand remains a trendsetter, not a follower.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 gap-y-[36px] md:gap-[40px] xl:gap-[50px] 2xl:gap-[80px] relative">
          ...
          <div className="md:col-span-6 col-span-12 max-md:px-[36px] md:pr-[36px]">
            ...
            <h3 className="4xl:text-[30px] 2xl:text-[28px] xl:text-[24px]  text-[20px] font-semibold md:mt-[31px] mt-[22px] leading-tight w-[92%] max-[400px]:text-[18px] lg:w-[80%] 4xl:[97%] 2xl:w-[90%] xl:w-[90%]">
              Engage the right customers, at the right time, with the right
              message.
            </h3>
            <div className="lg:pr-[120px]">
              <p className="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal xl:mt-[31px] mt-[22px]">
                Rialtes leverages Salesforce Marketing Cloud and Retail Cloud
                to:
              </p>
              <UnorderedList
                arrName={hyperPersonalizationData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[25px] mt-[18px] pl-[30px] mb-[166px] sm:mb-[136px] md:mb-[106px]"
                liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
              />
            </div>
          </div>
          <div className="absolute bottom-[-35px] right-0">
            <div className="bg-[#163055] text-[#ffffff] max-lg:mt-[35px] max-md:mx-[36px] md:mr-[36px] lg:mr-auto xl:mr-[100px]">
              <p className="4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] lg:text-[18px] text-[18px]   leading-tight py-[24px] px-[24px] lg:pl-[31px] font-light">
                Deliver delightful experiences that turn browsers into loyal
                brand advocates.
              </p>
            </div>
          </div>
            ...
            <div className="bg-[rgba(0,111,190,0.85)] h-full w-full md:w-[52%] xl:w-[55%] 2xl:w-[54%] 3xl:w-[54%] text-white flex flex-col xl:pt-[68px] xl:px-[77px] pt-[25px] px-[33px]">
              <div>
                ...
                <UnorderedList
                  ...
                  ulClassName="list-disc mt-[18px] md:mt-[16px] pl-[20px] xl:space-y-[27px] space-y-[19px] lg:pr-[35px]"
                  liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
                />
              </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1">
          ...
          <div className="md:col-span-7 col-span-12 max-md:px-[36px] bg-[#EFEFEF]">
            <div className="md:mx-[40px] md:pt-[64px] md:pb-[56px] pb-[31px] pt-[34px] 4xl:pr-[170px] 2xl:pr-[130px] xl:pr-[120px] ">
              ...
              <UnorderedList
                arrName={loyaltyData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[34px] mt-[23px] pl-[20px] md:pb-[49px]"
                liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
              />
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] gap-y-[41px]">
          <div className="md:col-span-6 col-span-12 md:order-1 order-2 max-md:px-[36px]">
            ...
            <p className="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px]  leading-tight font-normal xl:mt-[31px] mt-[24px] max-[350px]:text-[16px]">
              Retail success needs harmony between customer-facing and backend
              systems. Rialtes connects:
            </p>
            <UnorderedList
              arrName={frictionlessData}
              ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[34px] mt-[23px] pl-[20px] md:pb-[49px]"
              liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal max-[350px]:text-[16px]"
            />
              ...
              <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[25px]">
                ...
                <div>
                  ...
                  <div className="lg:pr-[75px]">
                    <UnorderedList
                      arrName={actionableData}
                      ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[34px] mt-[27px] pl-[20px] pb-[48px] md:pb-[52px]"
                      liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
                    />
                  </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] 2xl:gap-[80px] gap-y-[41px]">
          <div className="md:col-span-5 col-span-12 md:order-1 order-2 max-md:px-[36px]">
            ...
            <p className="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px]  font-normal xl:mt-[41px] mt-[23px]">
              Choosing the right tools shapes your brand’s future. Rialtes
              guides you to:
            </p>
            <UnorderedList
              arrName={rightData}
              ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[24px] mt-[23px] pl-[20px] xl:w-[80%]"
              liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
            />
          </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] xl:gap-[50px] 2xl:gap-[80px]">
          ...
          <div className="md:col-span-6 col-span-12 max-md:px-[36px] md:pr-[36px] lg:pr-auto lg:pt-[60] pt-[41px]">
            ...
            <div className="max-md:pr-[20px]">
              ...
              <UnorderedList
                arrName={aiPoweredRetailData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[24px] mt-[23px] pl-[20px] xl:w-[95%]"
                liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
              />
            </div>
            <p className="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal xl:mt-[31px] mt-[44px] xl:w-[84%]">
              With Rialtes, AI becomes an integrated part of your customer and
      ...
      <section className="custom-container xl:mt-[74px] mt-[53px] lg:pl-0 max-lg:px-0 bg-[#EAC84C]">
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] xl:gap-[20px] 2xl:gap-[80px]">
          <div className="2xl:col-span-7 md:col-span-6 col-span-12">
             <div className="block md:hidden relative w-full h-[365px] sm:h-[630px]">
        <Image
          src="/images/industry/retail-industry/mobile/fast-mob-img.webp"
          alt="Quick Commerce Retail"
          fill
      ...
      <div className="hidden md:block relative w-full h-full min-h-[500px]">
        <Image
          src="/images/industry/retail-industry/fast-desk-img.webp"
          alt="Quick Commerce Retail"
          fill
          className="object-cover object-[8%_20%]"
          priority
        />
      </div>
          </div>
          ...
          <div className="2xl:col-span-5 md:col-span-6 col-span-12 max-md:px-[36px] md:pr-[36px] lg:pr-auto xl:pt-[72px] md:pt-[35px] pt-[30px] lg:pb-[97px] pb-[83px]">
            ...
            <p className="4xl:text-[30px] 2xl:text-[28px] xl:text-[27px] lg:text-[24px] text-[18px] leading-tight font-semibold xl:mt-[41px] mt-[24px]  max-[400px]:text-[16px]">
              Speed is the new loyalty in retail. Rialtes helps you embrace
              Quick Commerce:
            </p>
            <UnorderedList
              arrName={fastData}
              ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[34px] mt-[31px] pl-[20px] lg:pr-[70px]"
              liClassName="text-[16px] 4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] leading-tight font-normal"
            />
      ...
      <section
        className="relative
                          xl:pt-[99px] pt-[42px] pb-[71px] xl:pb-[82px] lg:mt-[94px] mt-[89px] text-[#FFFFFF]"
      >
        <div className="absolute inset-0 z-0">
          {/* Mobile Background */}
          <div className="block md:hidden relative w-full h-full">
            <Image
              src="/images/industry/retail-industry/mobile/properietary-mob-img.webp"
              alt="Proprietary Rialtes Accelerators"
              fill
          ...
          <div className="hidden md:block relative w-full h-full">
            <Image
              src="/images/industry/retail-industry/properietary-desk-img.webp"
              alt="Proprietary Rialtes Accelerators"
              fill
              className="object-cover object-center"
              priority
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:mt-[45px] mt-[23px] md:gap-[40px] gap-y-[20px] w-full ">
            {proprietaryData.map((data, ind) => {
              return (
                <div
                  key={ind}
                  className="card bg-[#ffffff] xl:py-[55px] py-[34px] 2xl:px-[60px] px-[28px] xl:px-[50px]"
                >
                  <p className="4xl:text-[26px] 2xl:text-[22px] xl:text-[20px]  text-[20px]  text-[#0A6BB8] leading-tight font-semibold">
                    {data.title}
                  </p>
                  <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] text-[16px] leading-tight xl:mt-[32px] mt-[23px] text-[#000000]">
                    {data.desc}
                  </p>
                </div>
              );
      ...
      <section className="custom-container xl:mt-[124px] mt-[58px] max-md:pr-0">
        <h2 className="4xl:text-[60px] 2xl:text-[52px] xl:text-[45px] lg:text-[40px] md:text-[29px] text-[26px] leading-tight max-[400px]:text-[22px]  2xl:w-[80%] xl:w-[78%] max-md:pr-[36px]">
          AI-Powered Customer Engagement with Agentforce and 360° Insights with
          Data Cloud
        </h2>
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[20px] gap-y-[94px] md:mt-[106px] xl:mt-[126px] mt-[94px]">
          {aiPoweredCustomerData.map((data, ind) => {
            return (
              <div
                key={ind}
                className="card bg-[#EDEDED] lg:pb-[52px] py-[34px] lg:px-[58px] px-[28px] relative"
              >
                {/* Mobile image */}
                ...
                <div className="lg:mt-[380px] md:mt-[320px] mt-[320px]">
                  <p className="4xl:text-[36px] 2xl:text-[32px] xl:text-[28px] lg:text-[24px] text-[20px] text-[#0A6BB8] leading-tight font-semibold">
                    {data.title}
                  </p>
                  <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[18px] text-[16px]  leading-tight xl:mt-[29px] mt-[20px] text-[#000000]">
                    {data.desc}
                  </p>
                </div>
              </div>
      ...
      <div className="custom-container md:mt-[129px] xl:mb-[104px] mt-[41px] mb-[45px]">
        <ContactForm
          ...
          subtitle="Ready to reimagine your retail journey? Rialtes brings the tools, expertise, and innovation you need to thrive in today’s demanding landscape."
          subtitle1=" Contact us today to unlock the future of retail."
          className={
            "xl:w-[70%] 2xl:w-[75%] lg:w-[70%] 4xl:text-[60px] 2xl:text-[52px] xl:text-[45px] lg:text-[40px] md:text-[29px] text-[26px] leading-tight max-[400px]:text-[22px] "
          }
        />
      </div>
    </section>
