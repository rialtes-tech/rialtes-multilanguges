...
export default function page() {
  ...
  const schemaData = {
    ...
    description:
      "Empowering digital transformation in life sciences with connected data, AI insights, and cloud solutions for Pharma, MedTech, providers, and public health.",
    publisher: {
      "@type": "Organization",
      name: "Rialtes",
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Deliver end-to-end patient engagement journeys with real-time communication and AI personalization.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Interactive visualization for patient medical history, clinical insights, and personalized treatment planning.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Accelerate clinical trials with AI-powered recruitment, compliance tools, and real-world evidence insights.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Implement Salesforce Health Cloud for payer-provider collaboration, patient support programs, and remote monitoring.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Manage connected devices, predictive maintenance, and field service operations for better patient outcomes.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Drive data-driven public health programs with SDOH analysis, case tracking, and behavioral outreach.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Enhance patient access, drug safety, and regulatory compliance using AI, Data Cloud, and intelligent workflows.",
            },
          },
        ],
      },
  ...
  const commonSectionData = [
    {
      ...
      blueCard:
        "Deliver efficient, personalized care and manage cost with real-time analytics.",
    ...
    },
    {
      ...
      blueCard:
        "Enhancing patient experiences with connected, coordinated care.",
    ...
    },
    {
      ...
      blueCard:
        "Deliver superior patient outcomes with connected MedTech solutions.",
    ...
    },
    {
      ...
      blueCard:
        "Ensuring life-saving therapies and devices reach patients on time.",
  ...
  const commonSectionData1 = [
    ...
    },
    {
      ...
      blueCard:
        "AI is revolutionizing patient care, therapy development, and safety.",
    ...
    },
    {
      ...
      blueCard:
        "Deliver healthcare at the speed of need — powered by SAP & Salesforce.",
  ...
  return (
    <section className="min-h-screen">
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Life Sciences" />
      {/* herosection */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 w-full text-[#ffffff]">
            <div className="col-span-12">
              ...
              <h1 className="text-[26px] leading-tight xl:text-[40px] 4xl:text-[60px] mt-[11.5px] md:mt-[28.5px] w-[67%] sm:w-full">
                Powering the Next <div className="sm:block hidden" /> Era of
                Life Sciences
              </h1>
              <h4 className="text-[20px] leading-tight xl:text-[28px] 4xl:text-[35px] font-bold xl:mt-[23px] mt-[15px]">
                Intelligent, Connected, <div /> and Patient-Centric <div />{" "}
                Solutions
              </h4>
            </div>
      ...
      <section className="custom-container">
        ...
        <div className="xl:mt-[119px] mt-[44px]">
          <h2 className="4xl:text-[60px] xl:text-[40px] text-[26px] leading-tight font-light w-[90%] md:w-[90%] lg:w-[60%] xl:w-[66%] 2xl:w-[60%] 4xl:w-[80%]">
            Driving Compliance & Innovation in Life Sciences & Healthcare
            through SAP, Salesforce & AI.
          </h2>
          <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight mt-[19px] xl:mt-[49px] w-[90%] sm:w-[80%] lg:w-[60%] xl:w-[70%]">
            In a world where patient-centricity, compliance, and innovation are
            critical, life sciences organizations must move fast, stay
            compliant, and deliver exceptional value. Rialtes partners with
            global life sciences leaders to redefine their business models,
            connect ecosystems, and unlock the potential of AI and cloud
            technologies.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 border border-[#707070]">
          <div className="md:col-span-7 col-span-12 border-r border-[#707070]">
            <div className="relative pt-[33px] pb-[26px] pl-[26px] pr-[23px] xl:pt-[58px] xl:pb-[50px] xl:pl-[49px] xl:pr-[44px]">
              <p className="xl:text-[36px] 4xl:text-[50px] text-[26px] max-[340px]:text-[22px] leading-tight text-[#038EF4] italic w-fit bg-[#ffffff] px-[14px] top-[-20px] 4xl:top-[-30px] absolute">
                Did you know?
              </p>
              <p className="xl:text-[22px] 4xl:text-[28px] text-[18px] leading-tight w-[90%] sm:w-full">
                The global life sciences market is projected to reach{" "}
                <span className="xl:text-[28px] 4xl:text-[35px] text-[22px] text-[#038EF4] font-bold">
                  {" "}
                  $3.6 trillion by 2030.
                </span>
              </p>
            </div>
            <div className="pt-[30px] pb-[23px] pl-[26px] pr-[22px] xl:pt-[31px] xl:pb-[30px] xl:pl-[49px] xl:pr-[44px] border-t border-[#707070]">
              <p className="xl:text-[22px] 4xl:text-[28px] text-[18px] leading-tight">
                ...
                of life sciences organizations cite “delivering personalized
                patient experiences” as a top priority.
              </p>
            </div>
          </div>
          <div className="md:col-span-5 col-span-12">
            <div className="pt-[29px] pb-[25px] pl-[26px] pr-[26px] xl:pt-[57px] xl:pb-[68px] xl:pl-[57px] xl:pr-[57px] max-md:border-t max-md:border-[#707070]">
              <p className="xl:text-[22px] 4xl:text-[28px] text-[18px] leading-tight w-[90%] sm:w-full">
                <span className="xl:text-[28px] 4xl:text-[35px] text-[22px] text-[#038EF4] font-bold">
                  {" "}
                  AI adoption in life sciences is growing at a CAGR of 30%{" "}
                </span>{" "}
                - revolutionizing R&D, clinical trials, and patient engagement.
              </p>
            </div>
          </div>
        </div>
        <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight mt-[31px] xl:mt-[54px]">
          With pre-built accelerators like Body Map and Patient Interaction
          tools, our deep domain expertise, and strategic partnerships with SAP,
          Salesforce, MuleSoft, and Oracle, Rialtes helps life sciences
          companies achieve intelligent, compliant, and patient-focused outcomes
          — faster and better.
        </p>
      </section>
      {/* why rialtes */}
      <section className="custom-container relative max-[450px]:h-[1180px] max-[409px]:h-[1250px] max-[375px]:h-[1350] max-[345px]:h-[1390] h-[1150px] sm:h-[1100px] md:h-[890px] lg:h-[780px] xl:h-[950px] 2xl:h-[1100px] 3xl:h-[950px] 4xl:h-[1100px] max-md:px-0 lg:pr-0 xl:mt-[100px] mt-[54px] text-white">
        <div className="relative max-md:px-[36px] md:pl-[61px] lg:pt-[76px] pt-[38px] h-full">
          ...
          <h2 className="2xl:text-[50px] xl:text-[38px] text-[26px] leading-tight font-light w-[85%] md:w-[50%] lg:w-[40%] xl:w-[48%] 2xl:w-[56%] 4xl:w-[47%]">
            Why Rialtes is Your Strategic Partner in Life Sciences Digital
            Transformation
          </h2>
          ...
          <div className="absolute bottom-[-80px] md:bottom-[-80px] max-sm:mr-[36px]">
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-[20px] gap-y-[23px] xl:mt-[85px] mt-[68px] w-[100%] sm:w-[70%] md:w-[80%] lg:w-[80%] xl:w-[90%] 2xl:w-[80%] 3xl:w-[80%] 4xl:w-[80%]">
              {whyRialtesData.map((data, ind) => (
                <div
                  key={ind}
                  className="bg-white pt-[40px] pb-[31px] pl-[32px] pr-[22px] xl:pt-[51px] xl:pb-[47px] xl:px-[36px] border border-[#707070]"
                >
            ...
            <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] gap-y-[31px]">
              <div className="lg:col-span-5 col-span-12">
                ...
                <UnorderedList
                  ...
                  ulClassName="list-disc xl:mt-[35px] mt-[31px] ml-[20px] space-y-[19px] xl:space-y-[24px] 4xl:w-[80%]  lg:w-[90%] xl:w-full"
                  liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
                />
              </div>
          ...
          <div className="bg-[#006FBE] text-[#ffffff] lg:pt-[83px] 4xl:px-[86px] md:px-[66px] md:pb-[128px] pt-[31px] px-[42px] pb-[110px] max-[430px]:px-[30px] max-[430px]:pb-[160px] relative">
            <div className="grid md:grid-cols-2 grid-cols-1 xl:gap-[60px] gap-y-[19px]">
              <div>
                <h2 className="4xl:text-[60px] xl:text-[40px] text-[26px] leading-tight font-light md:w-[80%] xl:w-full">
                  Pre-built Industry Accelerators: <br /> Body Map & Patient
                  Interaction
                </h2>
              ...
              <div>
                <h3 className="xl:text-[30px] 4xl:text-[42px] text-[18px] leading-tight font-semibold">
                  Accelerate your digital transformation journey with Rialtes
                  life sciences-specific accelerators:
                </h3>
                <UnorderedList
                  arrName={prebuiltData}
                  ulClassName="list-disc xl:mt-[37px] mt-[19px] ml-[20px] space-y-[19px] xl:space-y-[24px]"
                  liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
                />
            ...
            <div className="absolute bottom-[-50px] right-0 bg-[#163055] xl:py-[38px] xl:px-[48px] pt-[27px] px-[42px] pb-[32px]">
              <p className="xl:text-[22px] 4xl:text-[26px] text-[18px] leading-tight">
                Ensure rapid deployment and regulatory compliance while focusing
                on patient care.
              </p>
            </div>
          </div>
      ...
      <section className="custom-container xl:mt-[81px] mt-[109px]">
        {commonSectionData.map((data, ind) => {
          return ind % 2 == 0 ? (
            <div
              className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] lg:gap-[0px] xl:gap-0 xl:mt-[137px] mt-[180px] border border-[#707070] relative"
              key={ind}
            >
              <div className="md:col-span-6 lg:col-span-5 xl:col-span-6 col-span-12 xl:pt-[79px] xl:px-[58px] xl:pb-[115px] md:pb-[110px] pt-[35px] px-[26px] pb-[35px] md:order-1 order-2">
                <h2
                  className={`4xl:text-[54px] xl:text-[40px] text-[26px] leading-tight font-light`}
                >
                  {data.title}
                </h2>
                <h3
                  className={`xl:text-[30px] 4xl:text-[42px] text-[18px] leading-tight font-semibold xl:mt-[11px] mt-[19px] ${ind == 4 || ind == 6 ? "xl:w-full" : " xl:w-[86%] "}`}
                >
                  {data.subtitle}
                </h3>
                <UnorderedList
                  arrName={data.dataList}
                  ulClassName={`list-disc xl:mt-[32px] mt-[19px] ml-[20px] space-y-[19px] xl:space-y-[24px] w-[90%] sm:w-full 4xl:w-[86%]`}
                  liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
                />
            ...
            <div
              className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] lg:gap-[0px] xl:mt-[137px] mt-[180px] border border-[#707070] relative"
              key={ind}
            >
              ...
              <div className="md:col-span-6 lg:col-span-5 xl:col-span-6 col-span-12 xl:pt-[79px] xl:px-[58px] md:pb-[115px] pt-[35px] px-[26px] pb-[35px]">
                ...
                <h3
                  className={`xl:text-[30px] 4xl:text-[42px] text-[18px] leading-tight font-semibold xl:mt-[11px] mt-[19px] w-[88%] sm:w-full ${ind == 5 && "4xl:text-[39px]"}`}
                >
                  {data.subtitle}
                </h3>
                <UnorderedList
      ...
      <section className="bg-[#EAEAEA] relative z-0 xl:pt-[145px] lg:pt-[115px] lg:pb-[42px] md:pb-[120px] xl:pb-[52px] pt-[56px] pb-[172px] 4xl:pr-[162px] lg:pr-[62px] max-lg:px-[36px] max-lg:mt-[100px] max-[450px]:mt-[130px] ">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-y-[35px] lg:gap-[40px] xl:gap-[60px] 4xl:gap-[80px]">
            ...
            <div className="custom-container max-lg:px-0">
              <div className="absolute bottom-0 max-lg:mr-[36px] text-[#ffffff] bg-[#163055] xl:py-[38px] xl:px-[48px] pt-[27px] px-[22px] pb-[32px]">
                <p className="xl:text-[22px] 4xl:text-[26px] text-[18px] leading-tight font-normal w-[90%] sm:w-full">
                  Efficient, connected enterprise operations for better
                  outcomes.
                </p>
              </div>
            </div>
          ...
          <div className="relative">
            <h2
              className={`4xl:text-[54px] xl:text-[40px] text-[26px] leading-tight font-light 4xl:w-[90%] w-[90%] sm:w-full`}
            >
              Seamless Integration with SAP, Oracle, MuleSoft for Unified Life
              Sciences Operations
            </h2>
            <h3
              className={`xl:text-[30px] 4xl:text-[42px] text-[18px] leading-tight font-semibold xl:mt-[46px] mt-[29px]`}
            >
              Powered by Data Cloud
            </h3>
            <UnorderedList
              arrName={seamlessData}
              ulClassName="list-disc xl:mt-[46px] mt-[28px] ml-[20px] space-y-[19px] xl:space-y-[24px] w-[90%] sm:w-full 4xl:w-[86%]"
              liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
            />
      ...
      <section className="custom-container">
        {commonSectionData1.map((data, ind) => {
          return ind % 2 == 0 ? (
            <div
              className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] lg:gap-[0px] xl:gap-0 xl:mt-[137px] first:mt-[80px] mt-[180px] border border-[#707070] relative"
              key={ind}
            >
              <div className="md:col-span-6 lg:col-span-5 xl:col-span-6 col-span-12 xl:pt-[79px] xl:px-[58px] md:pb-[115px] pt-[35px] px-[26px] pb-[35px] md:order-1 order-2">
                ...
                <h3
                  className={`xl:text-[30px] 4xl:text-[42px] text-[18px] leading-tight font-semibold xl:mt-[39px] mt-[19px]`}
                >
                  {data.subtitle}
                </h3>
                <UnorderedList
                  arrName={data.dataList}
                  ulClassName="list-disc xl:mt-[32px] mt-[28px] ml-[20px] space-y-[19px] xl:space-y-[24px] w-[90%] sm:w-full 4xl:w-[86%]"
                  liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
                />
                <div className="mt-[22px] xl:mt-[59px]">
                  <LearnMore
            ...
            >
              ...
              <div className="md:col-span-6 lg:col-span-5 xl:col-span-6 col-span-12 xl:pt-[79px] xl:px-[58px] md:pb-[115px] pt-[35px] px-[26px] pb-[35px]">
                ...
                <h3
                  className={`xl:text-[30px] 4xl:text-[40px] text-[18px] leading-tight font-semibold xl:mt-[39px] mt-[18px] w-[88%] sm:w-full 4xl:w-[98%]`}
                >
                  {data.subtitle}
                </h3>
                <UnorderedList
                  arrName={data.dataList}
                  ulClassName="list-disc xl:mt-[32px] mt-[19px] ml-[20px] space-y-[19px] xl:space-y-[24px] w-[90%] sm:w-full 4xl:w-[82%]"
                  liClassName="xl:text-[19px] 4xl:text-[20px] text-[16px] leading-tight"
                />
                <div className="mt-[22px] xl:mt-[59px]">
                  <LearnMore
      ...
      {/* Contact Form */}
      <div
        className="custom-container xl:mt-[167px] xl:mb-[104px] mt-[164px] mb-[45px] scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Ready to Transform Life Sciences with Rialtes?"}
          subtitle="Partner with Rialtes to unlock innovation, compliance, and patient-centric solutions across the life sciences ecosystem."
          subtitle1="Contact us today to discover how Rialtes can drive growth and patient impact for your organization."
          className="sm:w-[66%] 2xl:w-[60%] 4xl:w-[80%] 4xl:text-[60px] xl:text-[40px] text-[26px]"
        />
      </div>
    </section>
  );
