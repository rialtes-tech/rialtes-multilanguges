...
const schemaData = {
  ...
  description:
    "Rialtes delivers end-to-end digital transformation for the automotive industry using Salesforce Automotive Cloud, SAP S/4HANA, Revenue Cloud, and Data Cloud. Our AI-powered solutions streamline lead management, dealer operations, vehicle lifecycle, warranty management, and customer engagement across OEMs, dealers, and mobility service providers.",
  publisher: {
    "@type": "Organization",
    name: "Rialtes",
  ...
  mainEntity: {
    ...
    name: "Digital Transformation in Automotive Industry",
    description:
      "AI-powered Salesforce and SAP automotive solutions for OEMs, dealers, and mobility providers focused on lifecycle, engagement, and compliance.",
    areaServed: [
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Capture omnichannel leads with Salesforce Automotive Cloud, enable vehicle configuration, test drive scheduling, and AI-powered recommendations for upselling and personalization.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Configure quotes, manage trade-ins, financing, and dealer incentives using Salesforce Revenue Cloud and CPQ, integrated with SAP for pricing and inventory data.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Automate warranty registration, claims, recalls, and maintenance reminders. Integrate with SAP and DMS for parts inventory, repair orders, and connected vehicle data.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Deploy self-service portals with Salesforce Experience Cloud for vehicle deals, financing, inventory tracking, document management, and secure communication.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Use Salesforce Marketing Cloud and Data Cloud to create personalized journeys, AI-powered next-best-actions, behavioral triggers, and co-branded dealer campaigns.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Equip sales and service agents with a unified view of buyer history, preferences, warranties, and omnichannel engagement for improved upsell and retention strategies.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Unify customer and vehicle data from OEMs, dealers, and connected vehicles to power real-time insights, predictive maintenance, and personalized service campaigns.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Ensure seamless integration of SAP S/4HANA with Salesforce Automotive Cloud, DMS, and telematics platforms for synchronized operations, mobility services, and compliance.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Deploy pre-built accelerators for dealer operations, vehicle lifecycle management, buyer graphs, and warranty administration to reduce time-to-value and ensure compliance.",
          },
        },
      ],
    },
  ...
  return (
    <section className="relative w-full xl:mt-[84px] mt-[64px]">
      ...
      <div className="block md:hidden">
        ...
        />
        <div
          className="border-none px-[30px] pt-[42px] z-10  xl:pb-[144px] pb-[57px]"
          style={{
            background: "#073259",
          }}
        >
          ...
          <UnorderedList
            arrName={keyIndustryChallenges}
            ulClassName="list-disc pl-[20px] text-[#FFFFFF] mt-[17px]"
            liClassName="mt-[19px] text-[16px] leading-[19px]"
          />
          <h4 className="text-[#FFFFFF] text-[18px] mt-[61px] leading-[19px] font-semibold">
            Rialtes Solutions:
          </h4>
          <UnorderedList
            arrName={rialtesSolutions}
            ulClassName="list-disc pl-[20px] text-[#FFFFFF]"
            liClassName="mt-[19px] text-[16px] leading-[19px]"
          />
        </div>
      </div>
          ...
          <div className="custom-container w-full h-full flex items-start justify-end">
            <div className="relative 2xl:w-[55%] lg:w-[58%] w-[60%] h-full">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center px-[26px] xl:px-[40px] overflow-y-auto">
                ...
                <UnorderedList
                  arrName={keyIndustryChallenges}
                  ulClassName="list-disc pl-[22px] text-[#FFFFFF] xl:mt-[23px] mt-[16px]"
                  liClassName="mt-[19px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[16px] text-[15px]"
                />
                ...
                <UnorderedList
                  arrName={rialtesSolutions}
                  ulClassName="list-disc pl-[22px] text-[#FFFFFF] xl:mt-[26px] mt-[16px]"
                  liClassName="mt-[19px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] md:text-[16px] text-[15px] leading-tight"
                />
              </div>
            </div>
          </div>
...
const PreDeliveredSection = ({ onTalkClick }) => {
      ...
      <div className="relative z-10 pt-[64px] xl:pt-[82px] max-[350px]:h-[1100px] h-[1050px] sm:h-[760px] md:h-full  ">
        <div className="custom-container">
          ...
          <p className="text-white 4xl:text-[22px] 2xl:text-[20px] xl:text-[16px] lg:text-[18px] md:text-[18px] text-[16px] leading-[19px] xl:leading-[30px] font-light xl:mt-[35px] mt-[21px] xl:w-[80%] w-[90%]">
            Our proprietary accelerators are designed to streamline and
            future-proof automotive operations:
          </p>
        </div>
...
const EndToEndAutomativeSection = ({ onTalkClick }) => {
  const endtoendautomativesection = [
    {
      imgUrlMobile:
        "/images/industry/auto-industry/Mobile/lead-mgmt-mob-img.webp",
    ...
    {
      imgUrlMobile:
        "/images/industry/auto-industry/Mobile/deal-finance-mob-img.webp",
          ...
          {endtoendautomativesection.map((section, index) => (
            ...
            >
              ...
              <Image
                ...
                priority
              />
              <h4 className="mt-[29px] xl:mt-[63px] 4xl:text-[36px] 2xl:text-[32px] xl:text-[28px] lg:text-[28px] md:text-[28px] xl:font-semibold font-medium text-[20px] leading-tight">
                {section.title}
              </h4>
              <UnorderedList
                arrName={section.list}
                ulClassName="list-disc xl:mt-[13px] mt-[6px] pl-[22px]"
                liClassName="mt-[19px] 4xl:text-[20px] 2xl:text-[18px] xl:text-[16px] lg:text-[16px] md:text-[18px] text-[16px] xl:leading-[24px] leading-[19px] w-[90%] lg:w-full"
              />
            </div>
          ))}
        </div>
...
const ComprehensiveCustomerSection = ({ onTalkClick }) => {
  ...
  return (
    <section className="relative xl:mt-[93px] mt-[107px] w-full">
      ...
      <div className="custom-container xl:mt-[64px] mt-[33px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:gap-x-[87px] gap-y-[58px]">
          {comprehensiveCustomerData.map((section, index) => (
            <div key={index}>
              ...
              <UnorderedList
                arrName={section.list}
                ulClassName="list-disc pl-[22px] xl:mt-[21px]"
                liClassName="mt-[19px] xl:mt-[19px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] md:text-[18px] text-[16px] leading-tight"
              />
            </div>
          ))}
        </div>
        <div className=" xl:mt-[66px] mt-[39px] cursor-pointer">
          <LearnMore onClick={onTalkClick} btnName="Talk to Us" className="cursor-pointer" />
        </div>
      </div>
    </section>
  );
};
const PersonalizingSection = ({ onTalkClick }) => {
  ...
  return (
    <section className="relative h-full xl:mt-[96px] mt-[91px] custom-container md:pr-0 max-md:px-0">
      ...
      <div
        className="relative z-10 flex items-start justify-start xl:pt-[64px] pt-[38px] xl:pb-[104px] pb-[73px] 
"
      >
        <div className="relative md:pl-[76px] 2xl:w-[61%] xl:w-[81%] lg:w-[60%] md:w-[70%] sm:w-[80%] max-md:pl-[36px]">
          ...
          <UnorderedList
            arrName={personalizedData}
            ulClassName="list-disc pl-[22px]  4xl:w-[520px] 2xl:w-[519px] xl:w-[470px] lg:w-[420px] md:w-[380px] w-[340px] max-[400px]:w-[270px]"
            liClassName="text-[#FFFFFF] mt-[19px] xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] md:text-[18px] text-[16px] leading-tight"
          />
...
const RevolutionizingServiceSection = ({ onTalkClick }) => {
        ...
        <div className="xl:pl-[72px] px-[31px] lg:mt-[-200px] mt-[-30px] xl:pt-[56px] pt-[32px] xl:pb-[0px] pb-[60px] bg-[#073259] relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:gap-[71px] gap-[20px]">
            ...
            <div className="flex flex-col">
              <UnorderedList
                arrName={revolutionizingData}
                ulClassName="list-disc pl-[22px] 4xl:w-[431px] 2xl:w-[426px] xl:w-[400px] lg:w-[350px] xl:mt-[20px]"
                liClassName="text-[#FFFFFF] mt-[19px] first:mt-0 xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] md:text-[18px] text-[16px] leading-tight"
              />
...
const EnablingDynamicSection = ({ onTalkClick }) => {
        ...
        <div className="md:ml-[-220px] xl:ml-[-200px] relative z-0 bg-[#A16B4D] flex flex-col md:pl-[240px] xl:pl-[260px] md:pr-[55px] 2xl:pr-[75px]  px-[40px] xl:pt-[94px] md:pt-[44px] pb-0 h-auto md:h-full md:min-h-full min-h-[810px] sm:min-h-[820px] max-[460px]:min-h-[800px]">
          <div className="max-md:absolute bottom-0">
            <div className="max-md:pr-[36px]">
              ...
              <UnorderedList
                arrName={enablingDynamicData}
                ulClassName="list-disc pl-[22px] xl:mt-[30px] mt-[23px] xl:mb-[74px] mb:[42px] 2xl:w-full xl:w-[95%] lg:w-[90%]"
                liClassName="text-white first:mt-0 mt-[19px] xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] leading-tight font-light"
              />
...
const DealerBuyerSection = ({ onTalkClick }) => {
  const enablingDynamicData = [
      ...
      <div className="flex flex-col md:flex-row-reverse relative">
        ...
        <div className="w-full relative md:-mr-[180px] z-0 bg-[#3B4E59] flex flex-col md:pl-[30px] lg:pl-[50px] md:pr-[194px] lg:pr-[204px] px-[35px] xl:pt-[104px] md:pt-[54px] pb-0h-auto md:h-full md:min-h-full min-h-[810px] sm:min-h-[820px] max-[460px]:min-h-[800px]">
          <div className="max-md:absolute max-md:bottom-0 pr-[36px] ">
            ...
            <UnorderedList
              arrName={enablingDynamicData}
              ulClassName="list-disc pl-[22px] 2xl:w-[90%] xl:w-[90%] lg:w-[95%] xl:mt-[40px] mt-[28px]"
              liClassName="text-[#FFFFFF] mt-[19px] first:mt-0  xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] leading-tight xl:leading-[24px] font-light"
            />
...
const EmpoweringDealersSection = ({ onTalkClick }) => {
  const enablingDynamicData = [
        ...
        <div className="md:ml-[-220px] xl:ml-[-200px] relative z-0 bg-[#4087C7] flex flex-col md:pl-[240px] xl:pl-[260px] md:pr-[55px] 2xl:pr-[75px] px-[35px] xl:pt-[94px] md:pt-[44px] pb-0 h-auto md:h-full md:min-h-full min-h-[810px] sm:min-h-[820px] max-[460px]:min-h-[800px]">
          <div className="max-md:absolute bottom-0">
            <div className="max-md:pr-[36px]">
              ...
              <UnorderedList
                arrName={enablingDynamicData}
                ulClassName="list-disc pl-[22px] 2xl:w-[90%] xl:w-[90%] lg:w-[95%] xl:mt-[40px] mt-[23px]"
                liClassName="text-white mt-[19px] first:mt-0 xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] leading-tight xl:leading-[24px] font-light"
              />
...
const UnlockingDataSection = ({ onTalkClick }) => {
  const unlockingData = [
      ...
      <div className="flex flex-col md:flex-row-reverse relative">
        ...
        <div className="w-full relative md:-mr-[180px] z-0 bg-[#3B4E59] flex flex-col md:pl-[30px] lg:pl-[50px] md:pr-[194px] lg:pr-[204px] px-[35px] xl:pt-[104px] md:pt-[54px] pb-0h-auto md:h-full md:min-h-full min-h-[810px] sm:min-h-[820px] max-[460px]:min-h-[800px]">
          <div className="max-md:absolute max-md:bottom-0 pr-[36px]">
            ...
            <UnorderedList
              arrName={unlockingData}
              ulClassName="list-disc pl-[22px] 2xl:w-[90%] xl:w-[90%] lg:w-[95%] mt-[23px] xl:mt-[38px]"
              liClassName="text-white mt-[19px] first:mt-0 xl:mt-[24px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] xl:leading-[24px] leading-[19px] font-light"
            />
...
const IntegratingAutomativeSection = ({ onTalkClick }) => {
    ...
    <section className="relative xl:mt-[106px] mt-[99px] w-full">
      ...
      <div className="relative block md:hidden">
        ...
        <div className="sm:mx-[100px] mx-[40px] absolute bottom-0 left-0 right-0 bg-[rgba(0,111,190,0.8)] px-[22px] pt-[32px]">
          ...
          <UnorderedList
            arrName={integratingAutomativeData}
            ulClassName="list-disc pl-[22px] text-[#FFFFFF] mt-[16px]"
            liClassName="mt-[19px] first:mt-0 text-[16px] leading-[19px]"
          />
        ...
        <div className="custom-container">
          <div className="relative 2xl:w-[61%] w-[55%] xl:w-[56%] ">
            ...
            <div className="relative z-10 xl:pt-[70px] pt-[32px] xl:pb-[55px] pb-[27px] px-[26px] xl:px-[61px] ">
              ...
              <UnorderedList
                arrName={integratingAutomativeData}
                ulClassName="list-disc pl-[22px] text-[#FFFFFF] xl:mt-[40px] mt-[16px] 4xl:w-[85%] 2xl:w-[89%] xl:w-[90%] lg:w-[95%]"
                liClassName="mt-[19px] first:mt-0 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] leading-tight font-light"
              />
...
const PartenringPowerSection = ({ onTalkClick }) => {
      ...
      <div className="2xl:h-[900px] xl:h-[1000px] md:h-[700px] block md:hidden">
        ...
        <div className="sm:mx-[100px] mx-[40px] absolute bottom-0 left-0 right-0 bg-[rgba(255,255,255,0.8)] px-[14px] pt-[32px] z-10">
          ...
          <p className="text-[#000000] text-[16px] mt-[16px] leading-[19px] font-normal">
            With deep alliances with SAP and Salesforce, Rialtes delivers the
            most comprehensive, agile, and future-ready automotive solutions on
            the market. Our experts hold certifications in:
          </p>
          <UnorderedList
            arrName={partenringPowerData}
            ulClassName="list-disc pl-[20px] text-[#000000] mt-[45px]"
            liClassName="mt-[19px] first:mt-0 text-[16px] leading-[19px]"
          />
            ...
            <div className="custom-container w-full h-full flex items-start justify-end">
              <div className="relative bg-white h-full xl:pt-[66px] pt-[32px] px-[26px] xl:px-[61px] md:w-[55%] w-full">
                ...
                <p className="text-[#000000] 2xl:text-[20px] xl:text-[16px] lg:text-[16px]  text-[16px] leading-tight font-normal xl:mt-[11px] mt-[16px]  xl:leading-[24px]">
                  With deep alliances with SAP and Salesforce, Rialtes delivers
                  the most comprehensive, agile, and future-ready automotive
                  solutions on the market. Our experts hold certifications in:
                </p>
                <UnorderedList
                  arrName={partenringPowerData}
                  ulClassName="list-disc pl-[22px] text-[#000000] xl:mt-[26px] mt-[16px]"
                  liClassName="mt-[19px] 2xl:text-[20px] xl:text-[16px] lg:text-[16px] text-[16px] xl:leading-[24px] leading-[19px]"
                />
...
const RelatedSolutionsSection = ({ onTalkClick }) => {
      ...
      >
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:mt-[45px] mt-[33px] gap-[30px] lg:gap-0">
          {relatedSolutionsData.map((item, index) => {
            // Border
            const borderRight =
              index < 2 ? "xl:border-r-[2px] xl:border-[#FFFFFF]" : "";
            const borderBottom =
              "border-b-[2px] border-[#FFFFFF] md:border-0 pb-[33px] last:border-b-0 last:pb-0";
            // Padding
            let paddingClass = "";
            if (index === 0) {
            ...
            return (
              <div
                key={index}
                className={`flex xl:flex-col xl:justify-between md:w-[80%] xl:w-full ${borderRight} ${borderBottom} ${paddingClass} h-full`}
              >
                <div className="flex flex-col flex-1 xl:min-h-[300px]">
                  ...
                  <div
                    className={`mt-auto pt-[20px] ${index === relatedSolutionsData.length - 1 ? "xl:mt-[37px] 2xl:mt-[72px]" : ""}`}
                  >
                    <LearnMore onClick={onTalkClick} btnName="Talk to Us" />
                  </div>
                </div>
...
export default function page() {
  ...
  return (
    <>
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Automotive" />
      ...
      <section className="custom-container xl:mt-[112px] mt-[62px]">
        <h2 className="4xl:text-[60px] 2xl:text-[58px] xl:text-[40px] lg:text-[40px] md:text-[35px] text-[26px] max-[400px]:text-[22px]  leading-tight xl:w-[69%] 2xl:w-[85%] lg:w-[77%] font-light">
          Powering the Next-Generation Automotive Ecosystem with Rialtes
        </h2>
        <div className="mt-[22px] xl:mt-[48px]">
          <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[16px]   text-[16px] font-normal lg:w-[78%] w-[96%]">
            The automotive industry is in the midst of a seismic shift — from
            traditional dealer-centric models to a connected, customer-first
            mobility ecosystem. OEMs, dealers, and suppliers are challenged to
            deliver seamless omnichannel experiences, manage complex vehicle
            lifecycles, and foster brand loyalty in a hyper-competitive market.
          </p>
          <p className="4xl:text-[22px] 2xl:text-[20px] xl:text-[16px]   text-[16px] font-normal  mt-[22px] xl:mt[48px] lg:w-[78%] w-[96%]">
            {" "}
            Rialtes partners with leading automotive brands to navigate these
            disruptions, combining deep domain expertise with cutting-edge
            technologies like SAP, Salesforce Automotive Cloud, Marketing Cloud,
            Revenue Cloud, and more. With offices in the U.S., Canada, India,
            and Singapore, and certified automotive solution experts, we deliver
            end-to-end digital transformation — from lead capture to warranty
            service and beyond.
          </p>
        </div>
      </section>
      <ThoughtLeadershipSection onTalkClick={handleScrollToContact} />
      <PreDeliveredSection onTalkClick={handleScrollToContact} />
      <EndToEndAutomativeSection onTalkClick={handleScrollToContact} />
      <ComprehensiveCustomerSection onTalkClick={handleScrollToContact} />
      <PersonalizingSection onTalkClick={handleScrollToContact} />
      <RevolutionizingServiceSection onTalkClick={handleScrollToContact} />
      <EnablingDynamicSection onTalkClick={handleScrollToContact} />
      <DealerBuyerSection onTalkClick={handleScrollToContact} />
      <EmpoweringDealersSection onTalkClick={handleScrollToContact} />
      <UnlockingDataSection onTalkClick={handleScrollToContact} />
      <IntegratingAutomativeSection onTalkClick={handleScrollToContact} />
      <PartenringPowerSection onTalkClick={handleScrollToContact} />
      <RelatedSolutionsSection onTalkClick={handleScrollToContact} />
      {/* Contact Form */}
      <div className="custom-container pb-10 scroll-mt-28" ref={contactRef}>
        <ContactForm
          title={"Ready to Transform Your Automotive Customer Experience?"}
          className={
            "max-w-[66rem] xl:font-normal 4xl:text-[60px] 2xl:text-[56px] xl:text-[40px] lg:text-[40px] text-[26px] leading-tight mt-[52px] xl:mt-[89px]"
          }
        />
      </div>
    </>
