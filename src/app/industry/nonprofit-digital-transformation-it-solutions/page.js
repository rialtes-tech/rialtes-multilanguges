...
export default function retailPage() {
  ...
  const schemaData = {
    ...
    description:
      "Smart IT solutions and digital transformation by Rialtes empower nonprofits to streamline grants, donors, volunteers, and mission-critical operations.",
    publisher: {
      "@type": "Organization",
      name: "Rialtes",
    ...
    mainEntity: {
      ...
      name: "Nonprofit Digital Transformation and IT Solutions",
      description:
        "Salesforce and SAP-powered IT transformation for nonprofits. Streamline donor journeys, grants, volunteers, and outcomes with AI and automation.",
      areaServed: [
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Create personalized, multichannel donor campaigns with real-time engagement tracking and automated impact reporting.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Visualize household giving patterns, uncover networks, and manage legacy or collective donor relationships.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Run AI-powered donor journeys, trigger-based outreach, and personalized communications for increased retention.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Manage 360-degree donor profiles, major gift planning, and loyalty programs with transparency and insight.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Optimize volunteer recruitment, scheduling, and retention with personalized communication and self-service portals.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Track real-time program impact, outcome metrics, and performance dashboards for stakeholders and funders.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Automate grant applications, approvals, fund allocation, compliance, and reporting with integrated workflows.",
            },
          },
        ],
      },
  ...
  const commonSectionData = [
    {
      ...
      mobImg:
        "/images/industry/non-profit-industry/Mobile/fundraising-mob.webp",
    },
    {
    ...
    },
    {
      ...
      mobImg:
        "/images/industry/non-profit-industry/Mobile/personalized-mob.webp",
    },
    {
  ...
  return (
    <section className="min-h-screen">
      ...
      />
      {/* breadcrumb schema */}
      <BreadcrumbSchema currPage="Nonprofit" />
      {/* herosection */}
      <section className="relative group overflow-hidden h-[420px] lg:h-[550px] 4xl:h-[650px]">
        ...
        <div className="relative h-full custom-container sm:flex sm:items-center pt-[123px] sm:pt-0 ">
          <div className="grid grid-cols-12 w-full">
            ...
            <div className="4xl:col-span-5 sm:col-span-5 md:col-span-6 lg:col-span-6 col-span-3"></div>
          </div>
        </div>
      </section>
      {/* breadcrumb */}
      ...
      <section className="custom-container xl:mt-[99px] mt-[50px]">
        <div className="md:w-[80%] lg:w-[70%] 4xl:w-[80%] sm:w-[90%]">
          <h1 className="text-[26px] leading-tight xl:text-[40px] 4xl:text-[56px] ">
            Driving Mission Impact for Non-Profits Through Technology and
            Strategy
          </h1>
          <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[43px] mt-[30px] w-[94%] md:w-[90%] lg:w-[90%]">
            Rialtes empowers non-profits to overcome operational challenges and
            amplify their mission using Salesforce and SAP-based solutions. From
            donor and volunteer management to fundraising, grant tracking, and
            outcome measurement, our end-to-end services, including strategy,
            implementation, and ongoing support, help organizations achieve
            scalable growth. With ready-to-deploy accelerators tailored for
            non-profits, we fast-track digital transformation and maximize
            ...
            <div className="grid md:grid-cols-12 grid-cols-1 lg:gap-[40px]">
              ...
              <div className="4xl:col-span-7 xl:col-span-7 md:col-span-6 col-span-12 max-md:px-[36px]">
                ...
                <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] xl:mt-[19px] mt-[26px] sm:w-[80%] md:w-[90%] lg:w-[84%]">
                  Non-profits today need to move beyond traditional ways of
                  donor and program management to stay relevant and impactful.
                </p>
              </div>
            </div>
          </div>
            ...
            return (
              <div key={ind}>
                ...
                <UnorderedList
                  ...
                  ulClassName="xl:space-y-[24px] space-y-[19px] list-disc xl:mt-[19px] mt-[20px] pl-[20px]"
                  liClassName="text-[16px] xl:text-[20px] leading-tight font-normal"
                />
              </div>
            );
          })}
      ...
      <section className="custom-container xl:mt-[110px] mt-[89px]">
        ...
        <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight mb-[34px] xl:mb-[46px] xl:mt-[41px] mt-[26px] font-normal md:w-[80%] xl:w-[70%]">
          Our proprietary, ready-to-deploy solutions drastically reduce
          deployment times and improve process efficiencies for non-profits.
        </p>
        <div className="grid md:grid-cols-2 grid-cols-1 xl:mt-[56px] mt-[26px] sm:w-[80%] md:gap-[40px] md:gap-y-[21px] gap-y-[16px]">
          {preDeliveredData.map((data, ind) => {
            return (
              <div
                className="pt-[33px] px-[28px] pb-[46px] xl:px-[48px] xl:pt-[52px] xl:pb-[42px] border border-[#707070] hover:bg-[#D9F2FF]"
                key={ind}
              >
      ...
      {/* common sections */}
      <section
        className={`md:mt-[133px] mt-[90px] md:space-y-[190px] space-y-[89px]`}
      >
            ...
            <div key={ind} className="custom-container !pr-0 max-md:px-0 ">
              <div className="relative max-md:pl-[36px]">
                <div className="absolute z-20 mt-[-36px] md:mt-[-40px] xl:mt-[-50px]">
                  <p className="xl:text-[60px] 4xl:text-[70px] text-[50px] text-[#006FBE] ml-[32px] font-bold">
                    {ind + 1}
                  </p>
                </div>
                <div
                  className="custom-container !pl-0 xl:pt-[88px] pt-[58px] border-b-4 border-[#006FBE]"
                ...
                >
                  ...
                  <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] 4xl:gap-[40px] gap-y-[22px]">
                    ...
                    <div className="md:col-span-6 col-span-12">
                      {data.title2 && (
                        <h2
                          className={`text-[20px] leading-tight xl:text-[30px] 4xl:text-[36px] font-bold`}
                        >
                          {data.title2}
                        </h2>
                      )}
                      <p
                        className={`xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight ${ind == 2 ? "xl:mt-4" : "xl:mt-[32px]"}  mt-[16px] font-normal`}
                      >
                        {data.desc}
                      </p>
                    </div>
                  ...
                  <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[40px] 4xl:gap-[60px] gap-y-[26px] md:mt-0 mt-[34px] relative">
                    <div className="md:order-1 order-2">
                      <p
                        className={`xl:text-[28px] 4xl:text-[32px] text-[18px] leading-tight font-semibold md:mt-[80px] ${ind == 2 && "xl:mt-[51px]"}`}
                      >
                        Significance:
                      </p>
                      <UnorderedList
                        arrName={data.dataList}
                        ulClassName={`xl:space-y-[24px] space-y-[19px] list-disc xl:mt-[19px] mt-[22px] pl-[20px] xl:w-[88%] xl:pb-[182px] pb-[87px] ${ind == 2 && "xl:pb-[108px]"}`}
                        liClassName="text-[16px] xl:text-[20px] leading-tight font-normal"
                      />
                    </div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:mt-[87px] mt-[43px] lg:gap-y-[127px] md:gap-[40px] lg:gap-0 md:gap-y-[50px] gap-y-[50px]">
          ...
          <div className="md:flex md:flex-col md:h-full">
            <div className="md:flex md:flex-grow md:flex-col sm:w-[80%] lg:w-full lg:border-r lg:border-gray-700 lg:pr-[40px] max-lg:border-b max-lg:border-gray-700 max-lg:pb-[40px]">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mb-[46px] xl:mt-[19px] mt-[14px] font-normal">
                Manage financials, procurement, and donor fund allocation with
                full transparency.
              </p>
          ...
          <div className="md:flex md:flex-col md:h-full">
            <div className="md:flex md:flex-grow md:flex-col sm:w-[80%] lg:w-full lg:pl-[40px] lg:border-r lg:border-gray-700 lg:pr-[40px] max-lg:border-b max-lg:border-gray-700 max-lg:pb-[40px]">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mb-[46px] xl:mt-[19px] mt-[14px] font-normal">
                Enhance donor, volunteer, and program engagement through
                intuitive platforms.
              </p>
              <div className="md:mt-auto mt-[30px]">
                <LearnMore
          ...
          <div className="md:flex md:flex-col md:h-full">
            <div className="md:flex md:flex-grow md:flex-col sm:w-[80%] lg:w-full lg:border-r lg:border-gray-700 lg:pr-[40px] max-lg:border-b max-lg:border-gray-700 max-lg:pb-[40px]">
              <p className="xl:text-[26px] 4xl:text-[30px] text-[20px] leading-tight font-bold text-[#006FBE]">
                SAP CPI <br />
                <span className="xl:text-[18px] 4xl:text-[24px] text-[16px]">
                  (Cloud Platform Integration)
                </span>
              </p>
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mb-[46px] xl:mt-[19px] mt-[14px] font-normal">
                Ensure seamless data flow between Salesforce, SAP, and
                third-party solutions like donor portals.
              </p>
              <div className="md:mt-auto mt-[30px]">
                <LearnMore
                  onClick={handleScrollToContact}
          ...
          <div className="md:flex md:flex-col md:h-full">
            <div className="md:flex md:flex-grow md:flex-col sm:w-[80%] lg:w-full lg:pl-[40px]">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mb-[46px] xl:mt-[19px] mt-[14px] font-normal">
                Build custom apps, automate workflows, and integrate AI for
                smarter operations.
              </p>
              <div className="md:mt-auto mt-[30px]">
                <LearnMore
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 xl:mt-[48px] mt-[47px] md:gap-[20px] gap-y-[93px] sm:gap-y-[0px]">
          ...
          <div>
            ...
            <div className="sm:w-[80%] xl:w-[90%] 4xl:w-[80%]">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[20px]">
                Personalized dashboards and engagement tools for donors and
                volunteers.
                <br /> <br /> Seamless access to giving history, event
                registrations, and communication preferences.
              </p>
            </div>
          </div>
          {/* col 2 */}
          <div>
            ...
            <div className="sm:w-[80%] xl:w-[90%] 4xl:w-[80%]">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[20px]">
                AI-powered donor and volunteer support, automating common
                queries and cases. <br /> <br /> Proactive service alerts for
                donor opportunities and engagement milestones.
              </p>
            </div>
          </div>
        </div>
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[75px] gap-y-[29px] md:mt-[148px] xl:mt-[188px] sm:mt-[0px] mt-[93px]">
          ...
          <div className="4xl:col-span-5 md:col-span-5 lg:col-span-6 col-span-12">
            <div className="sm:w-[80%] md:w-[90%] lg:w-[80%] flex flex-col items-center xl:w-full">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[20px]">
                Consolidated 360-degree views for smarter donor segmentation and
                program targeting.
                <br />
                <br />
                AI-driven models to predict donor retention and volunteer
                engagement trends.
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] max-md:gap-y-[34px]">
          <div className="md:col-span-6 col-span-12 md:order-1 order-2 xl:w-[90%]">
            ...
            <UnorderedList
              ...
              ulClassName="xl:space-y-[24px] space-y-[19px] list-disc xl:mt-[61px] mt-[24px] pl-[20px] 4xl:w-[74%]"
              liClassName="text-[16px] xl:text-[20px] leading-tight font-normal"
            />
      ...
      {/* Contact Form */}
      <div
        className="custom-container lg:mt-[120px] lg:mb-[92px] mt-[73px] mb-[45px] scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Ready to Amplify Your Non-Profit’s Impact?"}
          subtitle="Partner with Rialtes to accelerate your automation journey. Our UiPath-certified experts are ready to help you unlock efficiency, reduce costs, and scale innovation."
          subtitle1="Contact us today for a free automation assessment!"
          className={
            "xl:text-[40px] 4xl:text-[60px] text-[26px] xl:w-[50%] 4xl:w-[50%] md:w-[50%]"
          }
        />
      </div>
    </section>
