...
export default function Page() {
    return (
        <div className="min-h-screen bg-white">
            ...
            />
            <section className="relative  pb-20 xl:h-[650px]">
        ...
        custom-container"
                >
                    <div className="grid xl:grid-cols-12 grid-cols-1 gap-2 mt-20 text-black">
                        <div className="xl:col-span-6 col-span-12 pt-40">
                            <h3 className="text-[20px] xl:text-[24px] font-bold mb-2 break-words">
                                SAP Digital Desk
                            </h3>
                            <h2 className="leading-tight break-words mt-10">
            ...
            <section className="relative  xl:mt-32 mt-10">
                ...
                <div
                    ...
                    custom-container">
                    <div className="grid xl:grid-cols-12 grid-cols-1 text-white  p-5">
                        ...
                        <div className="xl:col-span-6 col-span-12 xl:mt-16 mt-5 pr-20">
                            <p className="xl:text-[22px] text-[16px] font-light">At Rialtes, we know that SAP systems are mission-critical — downtime is not an option. That’s why our SAP Digital Desk is built on a global support model that delivers uninterrupted 24x7 coverage through a flexible combination of Onsite, Hybrid, and Fully Offshore delivery options to meet your unique operational needs and cost expectations.</p>
                        </div>
                    </div>
                     <div className="grid xl:grid-cols-12 grid-cols-1 text-white  p-5">
                        <div className="xl:col-span-7 col-span-12">
                            <h3 className="text-[20px] xl:text-[32px]  mt-16 leading-tight xl:pr-20">
                                Our Support Delivery Models
                            </h3>
                        </div>
                        <div className="xl:col-span-3 col-span-12 xl:mt-16 mt-5 pr-20 border-b-2 border border-white">
                        </div>
                    </div>

                    <div className="grid xl:grid-cols-12 grid-cols-1 text-white xl:pt-10 pt-16 xl:pb-20 xl:pr-10 xl:pl-10  p-5">
            ...
            <div
                ...
                <ContactForm title={'Ready to Unlock Maximum Value from SAP? Let’s Talk!'} subtitle={"Contact us today to explore how SAP Digital Desk can transform your SAP operations."} className={"leading-tight max-w-[71%]"} />
            </div >
        </div >
    );
}