...
const Home = () => {
    ...
    const slides = [
        {  link: "/insights/news/rialtes-joins-elite-group-as-an-official-salesforce-reseller-partner", image: '/images/news/news-b.webp', imageMobile: '/images/news/ba-mobile.webp' },
