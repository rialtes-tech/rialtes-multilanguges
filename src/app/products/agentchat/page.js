...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-[#E8E8E8] xl:h-[1100px] h-[1300px] xl:mt-[14rem]">
                <div className="mt-20  h-[700px] absolute
                        ...
                        py-6">
                    <div className="bg-[url('/images/industry/rialchat/headernew.png')] h-full w-full bg-cover bg-right overflow-hidden xl:mt-[-14rem]">
                        <div className="absolute bg-[#134874] text-white p-10 xl:w-[20%] w-full xl:left-[6%] top-[20%] xl:top-[-30%]">
                            <p className="text-xl">Introducing  </p>
                            <h2>AgentChat:</h2>
                            <p className="text-xl">Seamless WhatsApp Conversations Inside Salesforce</p>
                        </div>

                        <div className="absolute xl:right-[200px] xl:top-[16rem] top-[68%]">
                            <Image
                                className="xl:w-full w-[20%]"
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1 mt-32 xl:gap-20">
                ...
                <div className="grid xl:grid-cols-3 md:grid-cols-2 gris-cols-1 mt-10">
                    ...
                    <div>
                        <div className="border p-8 h-full hover:bg-[#134874] hover:text-white">
                            ...
                            <p className="mt-20">Connect and respond to customers over WhatsApp from any Salesforce record — Leads, Cases, Opportunities, Work Orders, or Custom Objects.</p>
                            <Image
                                className="w-[50px] mt-20 hover:invert hover:grayscale hover:contrast-100"
                    ...
                    <div>
                        <div className="border p-8 h-full hover:bg-[#134874] hover:text-white">
                            ...
                            <p className="mt-20">No complex integrations. Plug-and-play setup within minutes. Start engaging right away.</p>
                            <Image
                                className="w-[50px] mt-20 hover:invert hover:grayscale hover:contrast-100"
                ...
                <div className="grid xl:grid-cols-3 md:grid-cols-2 gris-cols-1">
                    <div>
                        <div className="border p-8 h-full hover:bg-[#134874] hover:text-white">
                            ...
                            <p className="mt-20">Conversations sync in real-time — whether initiated from WhatsApp or Salesforce.</p>
                            <Image
                                className="w-[50px] mt-20 hover:invert hover:grayscale hover:contrast-100"
                    ...
                    <div>
                        <div className="border p-8 h-full hover:bg-[#134874] hover:text-white">
                            ...
                            <p className="mt-20">Automatically route conversations by record type (e.g., Cases, Leads, Work Orders), ensuring the right team responds fast.</p>
                            <Image
                                className="w-[50px] mt-20 hover:invert hover:grayscale hover:contrast-100"
                    ...
                    <div>
                        <div className="border p-8 h-full hover:bg-[#134874] hover:text-white">
                            ...
                            <p className="mt-20">Control who can chat, view, and manage conversations with advanced role-based permissions and Salesforce’s native security model.</p>
                            <Image
                                className="w-[50px] mt-20 hover:invert hover:grayscale hover:contrast-100"
                                src='/images/industry/rialchat/Rapid Setup.svg'
                                alt="Our Solution to Success"
            ...
            >
                ...
                <div className="grid xl:grid-cols-2 md:grid-cols-2 gris-cols-1 mt-10 border-b-2 hover:bg-gray-100 hover:p-5 hover:shadow-lg  transition-all duration-500 ease-in-out origin-left">
                    <div>
                        ...
                        <button className="bg-[#134874] hover:bg-[#ffffff] hover:text-[#134874] border-[1px] border-[solid] border-[#134874] font-semibold text-white py-2 px-6 transition duration-300 order-4 mt-8">
  ...
  text-black py-6"
            >
                ...
                <div className="grid xl:grid-cols-4  bg-[#D0EEFF] p-5 mt-10">
                    <div className="xl:col-span-1"> <h3 className="font-bold">Use Case</h3></div>
                    <div className="xl:col-span-2"> <h3 className="font-bold">How AgentChat Helps</h3></div>
                </div>
                <div className="grid xl:grid-cols-4 bg-[#F2F2F2] p-5 mt-5">
                    <div className="xl:col-span-1"> <h3>Customer Support</h3></div>
                    <div className="xl:col-span-2"> <h3>Manage support cases via WhatsApp, instantly.</h3></div>
                </div>
                <div className="grid xl:grid-cols-4  mt-10">
                    <div className="xl:col-span-1"> <h3>Sales Outreach</h3></div>
                    <div className="xl:col-span-2">   <h3>Engage leads, close deals with real-time chats.</h3></div>
                </div>
                <div className="grid xl:grid-cols-4 bg-[#F2F2F2] p-5 mt-10">
                    <div className="xl:col-span-1">
                        <h3>Field Operations</h3></div>
                    <div className="xl:col-span-2"> <h3>Coordinate work orders and updates in real time.</h3></div>
                </div>
                <div className="grid xl:grid-cols-4 mt-10">
                    <div className="xl:col-span-1">  <h3>Student Engagement</h3></div>
                    <div className="xl:col-span-2"> <h3>Connect with students and alumni seamlessly.</h3></div>
                </div>
                <div className="grid xl:grid-cols-4 bg-[#F2F2F2] p-5 mt-10">
                    <div className="xl:col-span-1">  <h3>Donor Management</h3></div>
                    <div className="xl:col-span-2"> <h3>Stay in touch with donors via personalized chats.</h3></div>
                </div>
            </div>



            <div className="bg-[url('/images/industry/rialchat/bg2.png')] bg-cover bg-right overflow-hidden h-[500px]">
                <div
 ...
 py-6"
                >
                    ...
                    <div className="flex xl:flex-row flex-col mt-20 xl:gap-20">
                ...
                >
                    ...
                    <div className="grid xl:grid-cols-4">
                        ...
                        <div className="xl:col-span-2">
                            ...
                            <div className="flex xl:flex-row flex-col mt-16 items-center gap-10">
                                <Image
                                    className="w-[50px]"
