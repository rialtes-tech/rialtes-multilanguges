        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-[#E8E8E8] xl:h-[1100px] h-[900px] xl:mt-[14rem]">
                <div className="xl:mt-20  h-[700px] absolute
                        ...
                        xl:py-6">
                    <div className="bg-[url('/images/industry/rialchat/headernew.png')] xl:h-full h-[300px] w-full bg-cover xl:bg-right overflow-hidden bg-left xl:mt-[-14rem]">
                        <div className="absolute bg-[#134874] text-white p-10 xl:w-[20%] w-full xl:left-[6%] top-[-5%] xl:top-[-30%]">
                            <p className="text-xl">Introducing  </p>
                            <h1>AgentChat:</h1>
                            <p className="text-xl">Seamless WhatsApp Conversations Inside Salesforce</p>
                        </div>

                        <div className="absolute xl:right-[200px] xl:top-[16rem] top-[42%]">
                            <Image
                                className="xl:w-full w-[30%]"
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1 mt-32 xl:gap-20 gap-5">
