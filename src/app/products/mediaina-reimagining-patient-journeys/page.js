                    ...
                    <div className="xl:pt-10">
                        <div className="xl:grid xl:grid-cols-12 grid-cols-1 xl:mt-10  xl:gap-16 4xl:gap-10  flex flex-col-reverse">
                            <div className="xl:col-span-8 col-span-12">
                                ...
                                <p className="mt-5 font-normal 4xl:pr-32 md:text-[18px] 4xl:text-[20px] text-[16px]">Backed by LifeAI+, Rialtes’ specialized healthcare consulting suite, MediAIna offers intelligent, scalable, and compliant solutions that accelerate innovation, improve outcomes, and deliver human-centered healthcare at scale.</p>
                            </div>
            ...
            <section>
                <div className="custom-container mx-auto grid  4xl:grid-cols-[620px,991px] xl:mt-[-85px] 2xl:mt-[-100px] xl:grid-cols-[465px,710px]  grid-cols-1  gap-0 items-center 4xl:pr-0 2xl:pr-0 xl:pr-0  4xl:mt-0 mt-10">
                    ...
                    <div className="bg-[#05ACA6] text-white p-12 z-10  relative order-2 xl:order-1 2xl:mt-[60px] 4xl:mt-0 xl:mt-[80px]">
                        <h2 className="4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] leading-tight  md:text-[32px]">Rialtes LifeAI+</h2>
                        ...
                        <div className="mt-10 space-y-4 pb-20">
                            <p className="font-bold md:text-[18px] 4xl:text-[20px] text-[16px]">Benefits</p>
                            <ul className="list-disc pl-6 space-y-8 md:text-[18px] 4xl:text-[20px] text-[16px] leading-tight 4xl:pr-8">
                                <li>Accelerate product-to-market timelines with agile delivery models.</li>
                                <li>Enable smarter clinical trials, connected care, and digital therapeutics.</li>
                                <li>Leverage Salesforce, AI, and cloud platforms for compliant innovation.</li>
                            </ul>
                        </div>
            ...
            <section className="custom-container 4xl:px-0 2xl:pr-[60px] xl:pr-[60px] xl:pl-0  mt-10 max-md:px-0 max-md:mt-24">
                <div className="grid xl:grid-cols-12">
                    <div className="xl:col-span-8 bg-[#CCF7F5] pt-10 4xl:pl-[280px] xl:pl-[75px] 2xl:pl-[135px] order-2 xl:order-1 max-md:px-[35px] md:px-10 max-md:mt-[-200px]">
                        <h2 className="leading-tight max-md:pt-[13rem] 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px]  md:text-[32px]">Patient Identification</h2>
                        <p className="mt-5 4xl:pr-[26rem] 2xl:pr-[20rem] xl:pr-[12rem] font-light md:text-[18px] 4xl:text-[20px] text-[16px]">Leverage AI to detect, segment, and activate the right candidates for therapies, care plans, and trials.</p>
                        ...
                        <div className="xl:flex grid flex-wrap gap-4 xl:gap-8 mt-10 xl:mt-16">
                            ...
                            {/* <Link href="/contact-us">
                                <button className="bg-[#0A6BB8] md:text-[18px] 4xl:text-[20px] text-[16px] hover:bg-[#ffffff] text-left hover:text-[#134874] border-[solid] border-[#134874]  text-white py-3 px-8 transition duration-300">
            ...
            <section className="custom-container 4xl:px-0 mt-5 max-md:px-0 max-md:mt-20 xl:px-0 xl:mt-32">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-8 bg-[#C6E7FF] pt-10 4xl:pl-[200px] xl:pl-[180px] xl:pr-[100px] 2xl:pr-[200px]  max-md:px-[35px] max-md:mt-[-200px] md:px-10">
                        <h2 className="leading-tight max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Candidate Education</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] font-light">Transforming candidates into informed partners with personalized digital education, a crucial step in optimizing the patient engagement journey for successful therapy adoption.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10  4xl:pr-[4rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>Multilingual, interactive content for devices and therapies.</li>
                                    <li>Adaptive learning based on candidate behavior and feedback.</li>
                        ...
                        <div className="xl:flex grid flex-wrap gap-4 xl:gap-8 mt-10 xl:mt-16">
                            ...
                            {/* <Link href="/contact-us">
                                <button className="bg-[#0A6BB8] text-left md:text-[18px] 4xl:text-[20px] text-[16px] hover:bg-[#ffffff] hover:text-[#134874] border-[solid] border-[#134874]  text-white py-3 px-8 transition duration-300">
                                    Explore intelligent patient discovery
                                </button>
                            </Link> */}
            ...
            <section className="custom-container 4xl:px-0 mt-20 max-md:px-0 xl:px-0">
                <div className="grid xl:grid-cols-12">
                    <div className="xl:col-span-8 bg-[#EDEDED] pt-10 4xl:pl-[280px] xl:pl-[75px] 2xl:pl-[140px] order-2 xl:order-1 max-md:px-[35px] max-md:mt-[-200px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-[11rem] 2xl:pr-[14rem] xl:pr-[15rem] max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px]">Digital Prior Authorization (PA)</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] xl:pr-20 4xl:pr-32 2xl:pr-32 font-light">Automate complex prior authorization workflows and reduce treatment delays—an essential part of seamless patient journey in healthcare delivery.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 xl:gap-10 mb-6 mt-10 4xl:pr-[8rem] xl:pr-[10rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>End-to-end PA workflow automation with real-time payer integration.</li>
                                    <li> Preconfigured rules for top payers and regulatory standards.</li>
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li> Faster time-to-care with lower administrative overhead.</li>
                                </ul>
                            </div>
            ...
            <section className="custom-container 4xl:px-0 mt-5 max-md:mt-20 max-md:px-0 xl:px-0 xl:mt-32 relative">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-9 bg-[#CCF7F5] 2xl:h-[575px] 4xl:h-[615px] xl:h-[590px] pt-10 4xl:pl-[280px] xl:pl-[200px] 2xl:pl-[170px] max-md:px-[35px] max-md:mt-[-200px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-[5rem] max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px]">Clinical Trial Management with 360° Patient View</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] font-light">Centralize trial operations with unified patient intelligence.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10  4xl:pr-[4rem] xl:pr-20">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>Real-time patient profiles from EHR, labs, and wearables.</li>
                                    <li> Eligibility verification, onboarding, and compliance tracking.</li>
                                    <li>  Integrated digital diaries and adverse event capture.</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>Better trial outcomes through continuous patient engagement.  </li>
                        ...
                        <div className="xl:flex grid flex-wrap gap-4 xl:gap-8 mt-10 xl:mt-16  xl:absolute bottom-0">
                            ...
                            {/* <Link href="/contact-us">
                                <button className="bg-[#0A6BB8] md:text-[18px] 4xl:text-[20px] text-[16px] hover:bg-[#ffffff] hover:text-[#134874] border-[solid] border-[#134874]  text-white py-3 px-8 transition duration-300">
            ...
            <section className="custom-container 4xl:px-0 mt-20 max-md:px-0 xl:px-0">
                <div className="grid xl:grid-cols-12 relative">
                    <div className="xl:col-span-8 4xl:h-[674px] 2xl:h-[600px] xl:h-[600px] bg-[#C6E7FF] pt-16 4xl:pl-[280px] 2xl:pl-[150px] xl:pl-[75px] order-2 xl:order-1 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight max-md:pt-[13rem] 4xl:text-[52px] 2xl:text-[48px] xl:text-[42px]  md:text-[32px]">Long-Term Care Management</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] xl:pr-20 4xl:pr-40 font-light">Extend care beyond the clinic with automated, connected long-term care—empowering ongoing patient journey management and improving health outcomes.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 xl:gap-10 mb-6 mt-10 xl:mt-16 4xl:pr-[10rem] xl:pr-[10rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li> Real-time alerts for risk scores and care deviations.</li>
            ...
            <section className="custom-container 4xl:px-0 mt-10 max-md:px-0 max-md:mt-20 xl:px-0 relative">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-9 bg-[#EDEDED] 4xl:h-[650px] xl:h-[600px] 2xl:h-[600px] pt-16 4xl:px-[280px] xl:px-[150px] xl:mt-24 4xl:mt-24 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-32 2xl:pr-0 max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Body MAP App – Track Pain & Progress Visually</h2>
                        <p className="mt-5 font-light md:text-[18px] 4xl:text-[20px] text-[16px]">A visual-first approach to understanding the patient’s symptoms and responses.</p>
            ...
            <section className="custom-container 4xl:px-0 mt-20 max-md:px-0 xl:px-0">
                <div className="grid xl:grid-cols-12">
                    <div className="xl:col-span-8 bg-[#CCF7F5] pt-10 4xl:pl-[280px] xl:pl-[75px] 2xl:pl-[135px] order-2 xl:order-1 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-32 max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Conversational Insights with Agentforce</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] font-light">Ask questions. Get instant answers. Act faster—powered by Agentforce.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10 xl:mt-16 4xl:pr-[11rem] xl:pr-[10rem] 2xl:pr-[5rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li> Automated insights on care gaps, patient status, and trial KPIs.</li>
            ...
            <section className="custom-container 4xl:px-0 mt-10 max-md:mt-20 max-md:px-0 xl:px-0 relative">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-9 bg-[#C6E7FF] 4xl:h-[660px] 2xl:h-[600px] xl:h-[600px] pt-10 4xl:px-[280px] xl:mt-20 xl:pl-[180px] 2xl:pr-[200px] 4xl:mt-24 max-md:mt-[-200px] max-md:px-[35px] md:px-10 2xl:mt-32">
                        <h2 className="leading-tight max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Unified Intelligence with Salesforce Data Cloud</h2>
                        <p className="mt-5 font-light md:text-[18px] 4xl:text-[20px] text-[16px]">Bring every interaction, record, and insight into one powerful data platform.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10  4xl:pr-[4rem]">
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
                                    Benefits
            ...
            <section className="custom-container 4xl:px-0 mt-20 max-md:px-0 max-md:mt-20 xl:px-0 relative">
                <div className="grid xl:grid-cols-12">
                    <div className="xl:col-span-8 4xl:h-[698px] 2xl:h-[570px] xl:h-[600px]  bg-[#EDEDED] pt-10 4xl:pl-[280px] xl:pl-[75px] 2xl:pl-[135px] order-2 xl:order-1 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight xl:pr-10 4xl:pr-[10rem] max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Seamless Integration with MuleSoft + Athenahealth</h2>
                        <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px] font-light">Enable a truly connected care ecosystem with secure, scalable integrations.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10 xl:mt-16 4xl:pr-[11rem] xl:pr-[8rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>API-led connectivity with Athenahealth, Epic, Cerner, and SAP. </li>
                                    <li> Bi-directional data flow across EHR, CRM, and ERP systems.</li>
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li>  Faster implementation and interoperability at scale. </li>
                                </ul>
                            </div>
            ...
            <section className="custom-container 4xl:px-0 mt-10 max-md:px-0 max-md:mt-20 xl:px-0 relative">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-9 4xl:h-[660px] 2xl:h-[600px] xl:h-[600px] bg-[#CCF7F5] pt-10 4xl:pl-[280px] xl:mt-20 2xl:mt-24 4xl:pr-[200px] xl:px-[150px] 4xl:mt-24 max-md:px-[35px] max-md:mt-[-200px] md:px-10">
                        <h2 className="leading-tight max-md:pt-[13rem] 4xl:text-[60px] 2xl:text-[48px] xl:text-[42px] md:text-[32px]">Real-Time Patient Engagement with AgentChat</h2>
                        <p className="mt-5 font-light md:text-[18px] 4xl:text-[20px] text-[16px]">Drive proactive communication across the patient care journey with intelligent chat.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10  4xl:pr-[4rem]">
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
                                    Benefits
            ...
            <section className="custom-container 4xl:px-0 mt-20 max-md:px-0 max-md:mt-20 xl:px-0">
                <div className="grid xl:grid-cols-12">
                    <div className="xl:col-span-8 bg-[#C6E7FF] pt-10 4xl:pl-[280px] xl:pl-[75px] 2xl:pl-[135px] order-2 xl:order-1 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-[11rem] max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Order & Inventory Management Integration with ERP (SAP)</h2>
                        <p className="mt-5 4xl:pr-[28rem] font-light md:text-[18px] 4xl:text-[20px] text-[16px]">Bridge clinical care with operational excellence.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10 xl:mt-16 4xl:pr-[11rem] xl:pr-[5rem]">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    <li>Real-time inventory visibility across warehouses and hospitals.</li>
                                    <li>Integration with SAP for procurement, fulfillment, and billing.</li>
                                    <li>Automated alerts for replenishment and stock optimization. </li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
                                ...
                                <ul className="list-disc pl-5 space-y-5 text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li>Improved device availability and logistics efficiency.<li>
                                    </li>  Better compliance and cost control. </li>
                                </ul>
                            </div>
                        ...
                        <div className="xl:flex grid flex-wrap gap-4 xl:gap-8 mt-10 xl:mt-16">
                            ...
                            {/* <Link href="/contact-us">
                                <button className="bg-[#0A6BB8] text-left w-full md:text-[18px] 4xl:text-[20px] text-[16px] hover:bg-[#ffffff] hover:text-[#134874] border-[solid] border-[#134874]  text-white py-3 px-8 transition duration-300">
            ...
            <section className="custom-container 4xl:px-0 mt-10 max-md:px-0 max-md:mt-20 xl:px-0 relative">
                <div className="grid xl:grid-cols-12">
                    ...
                    <div className="xl:col-span-9 bg-[#EDEDED] 2xl:h-[750px] xl:h-[700px] 4xl:h-[830px] pt-16 4xl:px-[280px] xl:pl-[150px] 2xl:pr-[200px] xl:pr-0 2xl:mt-32 xl:mt-20 4xl:mt-24 max-md:mt-[-200px] max-md:px-[35px] md:px-10">
                        <h2 className="leading-tight 4xl:pr-[10rem] max-md:pt-[13rem] text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] ">Trusted by Salesforce. Certified by Rialtes.</h2>
                        <p className="mt-5 4xl:pr-48 font-light pr-20 md:text-[18px] 4xl:text-[20px] text-[16px]">Built on the Salesforce platform, MediAIna adheres to the most rigorous global security and privacy standards.</p>
                        <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-16 gap-5 mb-6 mt-10  4xl:pr-[4rem]">
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
                                    Benefits
                                ...
                                <ul className="list-disc pl-5 space-y-5  text-gray-800 text-base md:text-[18px] 4xl:text-[20px] text-[16px]">
                                    ...
                                    <li>Rialtes Certified Security Team – Continuous audits and governance.</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-[#006FBE] font-semibold mb-2 text-lg xl:4xl:text-[22px]">
