...
export default function page({ url }) {
  ...
  //   },
  {
    ...
    },
    {
      id: 76,
      image:
        "/images/blog/smart-city-digital-network-iot-technology-thumb.webp",
    ...
    },
    {
      ...
      title:
        "Building a Real-Time, Resilient Supply Chain with Rialtes Demand+",
    ...
    },
    {
      id: 57,
      image:
        "/images/blog/digital-data-interface-with-futuristic-touch-interaction-mobile.webp",
    ...
    },
    {
      id: 3,
      image:
        "/images/blog/digital-brain-ai-circuit-technology-illustration-mobile.webp",
    ...
    },
    {
      id: 55,
      image:
        "/images/blog/digital-network-touch-data-connection-visualization-mobile.webp",
      category: "Integration",
      industry: "Generic",
      date: "Nov. 12, 2025",
    ...
    },
    {
      id: 47,
      image:
        "/images/blog/ai-property-operations-predictive-maintenance-mobile.webp",
      category: "Exelona",
      industry: "Real Estate",
      date: "Oct. 13, 2025",
    ...
    },
    {
      id: 46,
      image:
        "/images/blog/Salesforce Consulting Cluster 1.1_Blog feature thumb.webp",
      category: "Salesforce Consulting",
      industry: "Generic",
      date: "Oct. 10, 2025",
    ...
    <section className="relative pb-8 lg:pb-4">
      <div className="mb-[36px] mx-auto">
        <div className="flex flex-row justify-between md:mr-24 mr-0">
          <p className="mb-[43px] leading-tight 4xl:text-[60px] 2xl:text-[48px] xl:text-[42px] md:text-[28px] text-[26px] font-normal">
            {" "}
            Latest Blogs
          </p>
        </div>
        ...
        >
          {filteredBlogs.map((blog) => (
            <div
              key={blog.id}
              className="flex flex-col sm:basis-1/4 border border-gray-300 hover:border-white sm:mr-6 mb-4 sm:h-[580px] md:h-full h-full lg:h-[580px] xl:h-[580px] 4xl:h-[650px] group"
            >
              ...
              <div className="p-6 flex-grow flex flex-col transition duration-300 ease-in-out group-hover:bg-[#F0F0F0]">
                <div>
                  <div className="pb-2 md:pb-4 4xl:text-[20px] xl:text-[18px] text-[16px] leading-tight">
                    ...
                    <span
                      className={`${blog.category.length > 21 && "block mt-1"}`}
                    >
                      {blog.date}
                    </span>
                  </div>
