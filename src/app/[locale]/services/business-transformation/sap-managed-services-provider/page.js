...
const schemaData = {
  ...
  description:
    "As a next-gen SAP Managed Services Provider, Rialtes future-proofs your SAP stack with AI, automation, cloud-native apps, and continuous innovation.",
...
const sapFeatureGrid = [
  ...
  },
  {
    ...
    description:
      "Every solution is aligned to SAP’s latest standards and innovations.",
  },
  {
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="custom-container mt-4">
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1 mt-20">
          <div className="xl:col-span-10 col-span-12">
            ...
            <p className="md:text-[18px] 4xl:text-[20px] text-[16px] mt-5 xl:pr-32">
              At Rialtes, we empower organizations to run their SAP landscapes
              more efficiently, securely, and effectively. SAP Digital Desk, our
              next-gen managed services platform, brings together end-to-end SAP
              expertise, from stabilization and innovation to continuous
              optimization, ensuring your SAP systems become a strategic driver
              for business growth, not just an operational tool.
            </p>
            <p className="md:text-[18px] 4xl:text-[20px] text-[16px] mt-5 xl:pr-40">
              As a global SAP-certified partner with a presence in India, the
              USA, Canada, and Singapore, and a team of top-tier, SAP-certified
              experts, Rialtes is committed to delivering unparalleled value,
              agility, and innovation for every client.
            </p>
          </div>
        ...
        <div className="h-full relative custom-container">
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white">
            ...
            <div className="xl:col-span-5 col-span-12 xl:mt-16 mt-5">
              <p className="md:text-[18px] 4xl:text-[20px] text-[16px] font-medium">
                At Rialtes, we know that SAP systems are mission-critical —
                downtime is not an option. That’s why our SAP Digital Desk is
                built on a global support model that delivers uninterrupted 24x7
                coverage through a flexible combination of Onsite, Hybrid, and
                Fully Offshore delivery options to meet your unique operational
          ...
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white  items-center xl:pt-20 pt-10">
            ...
            <div className="xl:col-span-7 col-span-12  xl:border-b-2 xl:border-white"></div>
          </div>
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white pt-10  xl:pb-20">
            <div className="xl:col-span-6 col-span-12">
              <h3 className="xl:text-[28px] text-[18px] xl:font-bold font-medium">
                24x7 “Follow-the-Sun” Global Support
              </h3>
              <UnorderedList
                arrName={[
                  "Always-On SAP system monitoring, incident management, and functional/technical support.",
                  "Proactive alerts, real-time resolution, and service continuity — anywhere, anytime.",
                ]}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3 xl:pr-20"
                liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px]"
              />
              <h3 className="xl:text-[28px] text-[18px] xl:font-bold font-medium xl:pr-20 xl:pt-10 2xl:pt-20 pt-10">
                Hybrid Delivery Model (Onsite + Offshore)
              </h3>
              <UnorderedList
                arrName={[
                  "Strategic blend of onsite expertise and offshore delivery for cost-effective yet personalized support.",
                  "Local leadership and customer-facing consultants backed by offshore SAP CoE teams for scalability.",
                ]}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3 xl:pr-20"
                liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px]"
              />
            ...
            <div className="xl:col-span-5 col-span-12 mt-10 xl:mt-0">
              <h3 className="xl:text-[28px] text-[18px] font-bold">
                Onsite Delivery Model
              </h3>
              <UnorderedList
                arrName={[
                  "SAP experts embedded within your business to provide hands-on, real-time collaboration.",
                  "Ideal for high-touch implementations, critical go-lives, and executive stakeholder alignment.",
                ]}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3"
                liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px]"
              />
              <h3 className="xl:text-[28px] text-[18px] font-bold xl:pt-20 pt-10">
                Fully Offshore Model
              </h3>
              <UnorderedList
                arrName={[
                  "100% remote delivery from our global SAP Centers of Excellence in India and Singapore for optimized costs and continuous delivery.",
                  "Best suited for steady-state AMS (Application Management Services), developments, and enhancements.",
                ]}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3"
                liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px]"
              />
        ...
        <div className="md:grid xl:grid-cols-12 grid-cols-1 h-full gap-10">
          ...
          <div className="col-span-5 order-2 xl:order-1 mt-10 xl:mt-0 mx-[35px] xl:mx-0 md:mx-0">
            ...
            <p className="mt-5 4xl:pr-40 font-medium md:text-[18px] 4xl:text-[20px] text-[16px]">
              All our engagements are driven by PMP® and Scrum®-certified
              Project Managers, ensuring that every project is delivered on
              time, within budget, and aligned to business goals.
            </p>
            <UnorderedList
              arrName={[
                "Agile and Waterfall methodologies are based on business needs.",
                "Strong governance, communication, and risk management frameworks.",
                "Transparent, KPI-driven service reporting and business outcome focus.",
              ]}
              ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3 4xl:pr-32 font-medium"
              liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px] "
            />
            <p className="mt-10 4xl:pr-40 pb-10 font-medium md:text-[18px] 4xl:text-[20px] text-[16px]">
              Our SAP-certified consultants are strategically located across the
              USA, Canada, and India, giving you the right mix of proximity,
      ...
      <section className="relative  4xl:mt-24 xl:mt-20">
        ...
        <div className="h-full relative custom-container">
          ...
          <div className="grid xl:grid-cols-12 grid-cols-1 text-[#006FBE] items-center pt-10">
            ...
            <div className="xl:col-span-6 col-span-12  xl:border-b-2 xl:border-black"></div>
          </div>
          <div className="grid xl:grid-cols-12 grid-cols-1 text-black xl:pb-20">
            <div className="xl:col-span-6 col-span-12">
              <UnorderedList
                arrName={sapCertificationData}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 xl:mt-10 mt-3 xl:pr-20"
          ...
          <div className="grid xl:grid-cols-12 grid-cols-1 text-[#006FBE]  items-center mt-10 xl:mt-0">
            ...
            <div className="xl:col-span-8 col-span-12 xl:border-b-2 xl:border-black"></div>
          </div>
          ...
          <div className="xl:pr-64">
            <div className="bg-[#163055] p-8 md:text-[18px] 4xl:text-[20px] text-[16px] text-white mt-16 leading-tight">
              With Rialtes, you’re gaining a long-term partner to drive
              continuous SAP innovation and value realization.
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1  xl:gap-20">
          ...
          <div className="col-span-5 4xl:pr-32 mt-10 xl:mt-0 mx-[35px] xl:mx-0">
            ...
            <h3 className="4xl:text-[36px] text-[22px] mt-5 font-semibold leading-tight">
              Complete SAP S/4HANA Post-Go-Live Support
            </h3>
            <p className="mt-5 font-normal md:text-[18px] 4xl:text-[20px] text-[16px]">
              Keep your SAP S/4HANA running at peak performance with our
              functional, technical, and Basis expertise:
            </p>
            <UnorderedList
              arrName={futureData}
              ulClassName="list-disc 4xl:space-y-3 xl:space-y-2 marker:font-bold marker:text-2xl pl-5 4xl:mt-10 mt-3 4xl:pr-24"
              liClassName="md:text-[18px] 4xl:text-[20px] text-[16px]"
            />
            ...
            <div className="col-span-6">
              <div className="relative xl:p-12 p-10 mt-40 xl:mt-0">
                ...
                <div className="relative bg-opacity-80 text-white z-10 rounded-lg">
                  ...
                  <h3 className="4xl:text-[36px] text-[20px] mt-5 leading-tight font-semibold">
                    SAP Fiori/UI5 — Built for Your Business
                  </h3>
                  <p className="mt-5 font-normal md:text-[18px] 4xl:text-[20px] text-[16px]">
                    Modernize and streamline user interactions with intuitive
                    SAP Fiori/UI5 apps
                  </p>
                  <UnorderedList
                    arrName={revolutionizeData}
                    ulClassName="list-disc 4xl:space-y-5 xl:space-y-5 marker:font-bold marker:text-2xl pl-5 4xl:mt-10 mt-3"
                    liClassName="md:text-[18px] 4xl:text-[20px] text-[16px] font-normal"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 xl:gap-24  xl:!pr-0">
          ...
          <div className="xl:col-span-6 col-span-12 order-2 xl:order-1 h-full px-[35px] xl:px-0 md:px-0">
            ...
            <p className="mt-5 leading-tight pr-2 4xl:pr-40 font-normal md:text-[18px] 4xl:text-[20px] text-[16px]">
              Take advantage of SAP Business Technology Platform (BTP) to build
              innovations that drive competitive advantage:
            </p>
            <UnorderedList
              arrName={unleashData}
              ulClassName="list-disc 4xl:space-y-5 md:text-[18px] 4xl:text-[20px] text-[16px] pl-5 marker:font-bold marker:text-2xl leading-tight pr-5 xl:pr-0"
              liClassName="first:mt-3"
            />
      ...
      <section className="mt-16">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="xl:col-span-6 col-span-12 bg-[#068EDA] p-8 text-white xl:mt-10 mb-10 z-[9]  mt-[-175px] custom-container xl:!pr-0  !w-[85%] xl:!w-full">
            <h2 className="leading-tight  xl:mt-0 text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px]">
              Seamless Connectivity
            </h2>
            <h3 className="mt-5 xl:text-[36px] text-[20px] leading-tight font-semibold">
              End-to-End SAP CPI & Integration Expertise
            </h3>
            ...
            <UnorderedList
              ...
              ulClassName="list-disc xl:space-y-5 md:text-[18px] 4xl:text-[20px] text-[16px] pl-5 marker:font-bold marker:text-2xl leading-tight xl:pr-32 font-light"
              liClassName="first:mt-5"
            />
          </div>
      ...
      <section className="custom-container xl:mt-24  h-full xl:!pl-0 max-md:px-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 h-full xl:gap-20 items-center">
          ...
          <div className="col-span-4 mx-[35px] xl:mx-0 mt-10 xl:mt-0 md:mx-0">
            ...
            <h3 className="4xl:text-[36px] text-[22px] mt-5 font-semibold leading-tight">
              SAP ABAP on Cloud — Smarter, Leaner, Faster
            </h3>
            <p className="mt-5 leading-tight md:text-[18px] 4xl:text-[20px] text-[16px]">
              Unlock the next-gen power of ABAP in the cloud:
            </p>
            <UnorderedList
              arrName={codeData}
              ulClassName="list-disc 4xl:space-y-3 marker:font-bold marker:text-2xl pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] 4xl:mt-10 mt-3"
              liClassName="first:mt-5"
            />
          </div>
        </div>
      ...
      <section className="mt-16 custom-container xl:!pr-0 max-md:px-0">
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="col-span-5  order-2 xl:order-1 xl:h-[640px] 2xl:h-[650px] 4xl:h-[650px] bg-[#073259] xl:pb-0 pb-20 p-8 text-white xl:mt-24 z-[9] mx-[35px] xl:mx-0 mt-[-115px] xl:!pr-0 xl:pl-[80px]">
            <h2 className="leading-tight xl:mt-10 text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px]">
            ...
            <UnorderedList
              arrName={intelligentData}
              ulClassName="list-disc xl:space-y-5 md:text-[18px] 4xl:text-[20px] text-[16px] pl-5 marker:font-bold marker:text-2xl leading-tight font-light"
              liClassName="first:mt-5"
            />
          ...
          <div className="relative">
            ...
            <div className="absolute xl:inset-0 items-start px-[35px] md:px-0 grid xl:grid-cols-12 xl:px-20 py-11 text-black xl:pr-40">
              <div className="col-span-10 2xl:col-span-6">
                ...
                <UnorderedList
                  arrName={winningSectionData}
                  ulClassName="list-disc 4xl:space-y-5 xl:space-y-3 pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] mt-5"
                  liClassName=""
                />
      ...
      <section className="custom-container xl:mt-20 mt-[30rem] max-[500px]:mt-[500px] max-[378px]:mt-[624px] md:mt-[25rem] ">
        <div className="grid xl:grid-cols-12 grid-cols-12">
          <div className="xl:col-span-6 col-span-12">
            ...
            <h3 className="4xl:text-[36px] xl:text-[30px] text-[20px] mt-5 leading-tight font-semibold">
              SAP Ariba Managed Services
            </h3>
            <UnorderedList
              arrName={sapAribaData}
              ulClassName="list-disc space-y-3 pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] mt-5"
              liClassName=""
            />
          </div>
          <div className="xl:col-span-6 col-span-12 mt-20 xl:mt-0">
            ...
            <h3 className="4xl:text-[36px] xl:text-[30px] text-[20px] mt-5 leading-tight font-semibold">
              SAP Datasphere Management for Unified Data Access
            </h3>
            <UnorderedList
              arrName={sapDatasphereData}
              ulClassName="list-disc space-y-3 pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] mt-5"
              liClassName=""
            />
          </div>
        ...
        <div className="h-full relative custom-container">
          ...
          <div className="grid xl:grid-cols-12 grid-cols-1 text-black">
            <div className="xl:col-span-7 col-span-12">
              <p className="mt-5 md:text-[18px] 4xl:text-[20px] text-[16px]">
                Rialtes’ Proven SAP Activate Approach Combined with Process
                Intelligence
              </p>
            </div>
          </div>
          <div className="grid xl:grid-cols-12 xl:gap-x-12 gap-y-6 mt-16">
            <div className="grid gap-6 xl:col-span-5 col-span-12">
              {sapTransformationSteps
                .slice(0, 3)
                .map(({ step, title, description }, index) => (
                  <div
                    key={step}
                    className="flex w-full gap-x-4 items-start min-h-[100px]"
                  >
                    ...
                    <div className="flex flex-col xl:flex-row xl:gap-10 justify-center w-full xl:items-center">
                      <p className="font-bold 4xl:text-[22px] xl:text-[20px] text-[18px] text-black">
                        {title}
                      </p>
                      <p
                        className={`font-normal xl:text-[18px] 4xl:text-[20px] text-[16px] text-black mt-1`}
                      >
                        {description}
                      </p>
                    </div>
            ...
            <div className="grid xl:col-span-5 col-span-12 gap-6">
              {sapTransformationSteps
                .slice(3)
                .map(({ step, title, description, plOverride }, index) => (
                  <div
                    key={step}
                    className="flex w-full gap-x-4 items-start min-h-[100px]"
                  >
                    ...
                    <div className="flex flex-col xl:items-center xl:flex-row xl:gap-10 justify-center w-full">
                      ...
                      <p
                        className={`font-normal md:text-[18px] 4xl:text-[20px] text-[16px] text-black mt-1`}
                      >
                        {description}
                      </p>
                    </div>
            ...
            <div className="bg-[#163055] xl:mb-[-60px] col-span-10 z-[20] p-8 xl:text-[26px] text-[20px] text-white mt-16 leading-tight font-normal">
              With Signavio’s real-time process intelligence, we ensure you run
              SAP based on best-in-class benchmarks.
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative">
          ...
          <div className="py-10 xl:py-20 text-black relative xl:absolute xl:inset-0 xl:flex xl:items-end xl:justify-end  -mt-[39rem] md:mt-[-32rem] xl:mt-0 px-[35px] xl:px-7">
            <div className="4xl:max-w-[710px] xl:max-w-[440px]">
              ...
              <p className="mt-5 font-normal md:text-[18px] 4xl:text-[20px] text-[16px]">
                Meet SAP Joule, your AI-powered business assistant for HR and
                enterprise processes in SuccessFactors. Rialtes helps you
                leverage Joule for impactful automation and insights:
              </p>
              <UnorderedList
                arrName={superchargeData}
                ulClassName="list-disc space-y-3 pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] text-[16px] mt-5"
                liClassName=""
              />
            </div>
          </div>
      ...
      <section className="h-full custom-container xl:pr-0 max-md:px-0 mt-0 ">
        <div className="grid xl:grid-cols-12 grid-cols-1 h-full 4xl:gap-20 xl:gap-10 items-center">
          ...
          <div className="xl:col-span-5 col-span-12 order-2 xl:order-1 mx-[35px] xl:mx-0 xl:mt-0 md:mx-0 ">
            <h2 className="leading-tight text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] mt-10">
              Rialtes’ BTP Center of Excellence
            </h2>
            <h3 className="4xl:text-[36px] text-[22px] mt-5 font-semibold leading-tight">
            ...
            <p className="4xl:mt-8 xl:mt-4 mt-4 font-normal md:text-[18px] 4xl:text-[20px] text-[16px]">
              From AI-driven workflows to mobile apps and event-driven
              architectures, our Certified SAP BTP experts ensure:
            </p>
            <UnorderedList
              arrName={btpData}
              ulClassName="list-disc space-y-3 4xl:space-y-5 marker:font-bold marker:text-2xl pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] 4xl:mt-10 mt-3 xl:pr-10"
              liClassName=""
            />
        ...
        <div className="h-full relative custom-container">
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white">
            <div className="xl:col-span-9 col-span-12">
              ...
              <h3 className="xl:text-[36px] text-[20px] xl:mt-12 mt-5">
                Success+ by Rialtes
              </h3>
            </div>
          </div>
          <div className="grid xl:grid-cols-12 grid-cols-1 text-white xl:pt-10 pt-5 xl:pb-20">
            <div className="xl:col-span-6 col-span-12">
              <h3 className="xl:text-[28px] text-[18px] xl:font-semibold font-medium">
                Workday to SAP SuccessFactors Migration Services
              </h3>
              <UnorderedList
                arrName={migrateData1}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] xl:mt-10 mt-3 xl:pr-20"
                liClassName=""
              />
            </div>
            <div className="xl:col-span-6 col-span-12 mt-10 xl:mt-0">
              <h3 className="xl:text-[28px] text-[18px] xl:font-semibold font-medium xl:pr-20">
                ZOHO HR to SAP SuccessFactors Migration
              </h3>
              <UnorderedList
                arrName={migrateData2}
                ulClassName="list-disc xl:space-y-5 marker:font-bold marker:text-2xl pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] xl:mt-10 mt-3 xl:pr-20"
                liClassName=""
              />
            </div>
      ...
      <section className="custom-container  h-full xl:!pl-[142px] max-md:px-0 mt-10 xl:mt-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 h-full xl:gap-20">
          ...
          <div className="col-span-5 xl:mt-20 mx-[35px] xl:mx-0 mt-10 md:mx-0">
            ...
            <h3 className="4xl:text-[36px] text-[20px] mt-5 font-semibold leading-tight">
              Your Success Is Our Mission
            </h3>
            <UnorderedList
              arrName={whyPartnerData}
              ulClassName="list-disc 4xl:space-y-5 xl:space-y-3 marker:font-bold marker:text-2xl pl-5 md:text-[18px] 4xl:text-[20px] text-[16px] xl:mt-5 4xl:mt-10 mt-3"
              liClassName=""
            />
          </div>
        </div>
      ...
      {/* contact form */}
      <div className="custom-container text-black py-20 scroll-mt-28" ref={contactRef}>
        <ContactForm
          title={"Ready to Unlock Maximum Value from SAP? Let’s Talk!"}
          subtitle={
            "Contact us today to explore how SAP Digital Desk can transform your SAP operations."
          }
          className={
            "leading-tight text-[26px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] 4xl:text-[60px] xl:max-w-[71%]"
          }
        />
      </div>
    </div>
