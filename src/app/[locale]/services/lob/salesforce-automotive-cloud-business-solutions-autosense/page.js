        ...
        return (
            <section className="xl:mt-[95px] mt-[70px]">
                <div className="custom-container">
                    <h2 className="text-[000000] 4xl:text-[30px] xl:text-[24px] md:text-[20px] text-[20px] leading-tight font-bold">
                        {t('keyPillarsTitle')}
                    </h2>
                                    ...
                                    {ind % 2 === 0 ? (
                                        <>
                                            <div
                                                ...
                                                <h3 className="text-[22px] md:text-[26px] xl:text-[30px] 4xl:text-[36px] leading-tight font-semibold text-[#FFFFFF] xl:pt-[31px] xl:pl-[34px] ">
                                                    {data.title}
                                                </h3>
                                        ...
                                        <>
                                            ...
                                            <div style={{ backgroundColor: data.bgColor, padding: '32px 22px 0px 22px' }}
                                                className="xl:pt-[46px] xl:px-[79px] pb-0 px-[22px] pt-[32px] order-2 md:order-none flex flex-col justify-between h-full">
                                                <h3 className="text-[22px] md:text-[26px] xl:text-[30px] 4xl:text-[36px] font-semibold text-[#FFFFFF] xl:pt-[31px] xl:pl-[34px] xl:leading-[44px] leading-[27px]">
                                                    {data.title}
                                                </h3>
    ...
    const ChooseRialtes = () => {
        return (
            <section className="custom-container xl:mt-[135px] mt-[74px]">
                <h2 className="leading-tight text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px] font-light">
                            ...
                            <div key={ind} className="xl:p-[47px] p-[42px] border-[1px] border-[#707070] hover:border-[#D9F2FF] hover:bg-[#D9F2FF] transition-colors duration-300">
                                ...
                                <div>
                                    {item.listItems.map((listItem, index) => (
                                        <p key={index} className="xl:mt-[33px] mt-[26px] text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px] leading-tight font-normal ">{listItem}</p>
                                    ))}
                                </div>
                            </div>
                        );
    ...
    const RialtesMakesWork = () => {
        return (
            <section className="custom-container xl:mt-[110px] mt-[70px]">
                <h2 className="leading-tight text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px]">{t('makesItWorkTitle')}</h2>
                <h3 className="4xl:text-[42px] xl:text-[36px] md:text-[26px] text-[22px] leading-tight font-semibold xl:mt-[16px] mt-[17px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-[60px] lg:gap-[100px] xl:gap-[158px] xl:mt-[61px] mt-[29px]">
                    ...
                    {rialtesMakesWorkData[0] && (
                        <div className="rialtesmakecard-1">
                            ...
                            <h4
                                className="xl:mt-[63px] mt-[33px] 4xl:text-[36px] xl:text-[28px] md:text-[20px] text-[18px] leading-tight  font-semibold ">
                                {rialtesMakesWorkData[0].title}
                            </h4>
                            <UnorderedList arrName={rialtesMakesWorkData[0].list} ulClassName="list-disc pl-5 xl:mt-[33px] mt-[29px] w-[90%]" liClassName="xl:mt-[24px] mt-[19px] text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px] leading-tight" />
                        </div>
                    )}
                    {/* Right Column */}
                    {rialtesMakesWorkData[1] && (
                        <div className="rialtesmakecard-2 mt-[47px] md:mt-[160px] xl:mt-[230px]">
                            ...
                            <h4 className="xl:mt-[63px] mt-[33px] 4xl:text-[36px] xl:text-[28px] md:text-[20px] text-[18px] leading-tight  font-semibold ">
                                {rialtesMakesWorkData[1].title}
                            </h4>
                            <UnorderedList arrName={rialtesMakesWorkData[1].list} ulClassName="list-disc pl-5 text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px] xl:mt-[33px] mt-[29px]  w-[90%]" liClassName="text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px] leading-tight xl:mt-[24px] mt-[19px]" />
                        </div>
                    )}
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 mt-[40px] md:mt-[-60px] xl:mt-[-40px] 3xl:mt-[-80px]">
                    ...
                    {rialtesMakesWorkData[2] && (
                        <div className="rialtesmakecard-1">
                            ...
                            <UnorderedList arrName={rialtesMakesWorkData[2].list} ulClassName="list-disc pl-5 xl:mt-[33px] mt-[29px] w-[90%]" liClassName="text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px] leading-tight xl:mt-[24px] mt-[19px]" />
                        </div>
                    )}
                </div>
            </section>
        ...
        return (
            <section
                ...
                <div className="custom-container max-lg:px-0">
                    <div>
                        <h2 className="text-[#FFFFFF] leading-tight text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px] w-[100%] xl:w-[55%] 4xl:w-[65%] ">
                            {t('thoughtLeadershipTitle')}
                        </h2>
                        <p className="text-[#FFFFFF] font-semibold xl:mt[29px] mt-[26px]  xl:w-[71%] tmd:text-[20px] text-[18px] xl:text-[25px] 4xl:text-[30px] leading-tight">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:gap-[89px] gap-[20px] md:gap-[40px] xl:gap-y-auto gap-y-[54px] xl:mt-[84px] mt-[40px]">
                            {thoughtLeadershipData.map((item, index) => (
                                <div key={index}>
                                    <h3 className="text-[18px] md:text-[20px] xl:text-[25px] 4xl:text-[30px] leading-tight font-semibold text-[#FFFFFF]">
                                        {item.title}
                                    </h3>
                                    <p className="text-[16px] md:text-[18px] xl:text-[20px] 4xl:text-[24px] leading-tight mt-[15px] xl:mt-[29px] text-[#FFFFFF] w-[90%] font-light">
                                        {item.description}
                                    </p>
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="h-full relative custom-container">
                    <div className="grid md:grid-cols-12 grid-cols-1">
                        <div className="lg:col-span-5 2xl:col-span-5 4xl:col-span-7 col-span-12 mt-16 md:mt-28 2xl:mt-28 2xl:pr-[34px]">
                            ...
                            <h1 className="text-white leading-tight text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px] mt-5 sm:w-[70%] lg:w-full">
                                {t('headerSubTitle')}
                            </h1>
                        </div>
            ...
            <section className="custom-container xl:mt-[105px] mt-[55px] xl:mb-[114px] mb-[42px]">
                <p className="4xl:text-[22px] md:text-[18px] text-[16px] leading-tight xl:w-[70%] w-[96%]">{t('pageDesc')}</p>
            </section>
            {/* introducing rialtes */}
            <section className="custom-container">
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className="flex flex-col w-full lg:max-w-xl lg:mb-0 mb-4">
                        ...
                        <p className="text-[#000000] leading-tight 4xl:text-[50px] xl:text-[40px] text-[26px] md:text-[30px] font-medium ">{t('introducingSubTitle')}</p>
                        <div className="text-[#000000] text-[22px] md:text-[26px] xl:text-[30px] 4xl:text-[36px] leading-tight font-semibold xl:mt-[31px] mt-[12px] xl:w-full w-[76%]">{t('introducingSubTitle2')}</div>
                    </div>
                    <div className="flex flex-col w-full">
                        <p className="text-[#000000] 4xl:text-[22px] md:text-[18px] text-[16px] leading-tight xl:w-[90%] w-[90%]">{t('introducingDesc')} </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="relative z-10 bg-[#073259] mt-[-60px] xl:mt-[-60px] xl:p-[71px] p-[32px] mx-auto">
                        <div className="mx-auto custom-container md:pl-0 max-md:px-0">
                            <div className="grid lg:grid-cols-2 grid-cols-1 xl:gap-[10px]">
                                <div className="">
                                    <h2 className="text-[#FFFFFF] leading-tight text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px] lg:w-[80%] xl:w-full 2xl:w-[90%] 4xl:w-[100%]">
                                        {t('partnerTitle')}
                                    </h2>
                                </div>
                                <div className="lg:mt-0 2xl:mt-[14px] mt-[27px] xl:ml-[61px] xl:w-[80%] lg:pl-[40px]">
                                    <p className="text-[#FFFFFF] text-[16px] md:text-[18px]  xl:text-[20px] 4xl:text-[24px] leading-tight font-normal lg:w-[80%] xl:w-full">
                                        {t('partnerDesc')}
                                    </p>
                                </div>
                            </div>
            ...
            <div className="custom-container text-black xl:pb-20 pb-10 pt-[115px] xl:pt-[138px]">
                <ContactForm title={t('contactTitle')} className={"max-w-[62rem] xl:font-light xl:leading-[73px] leading-[32px] text-[26px] md:text-[30px] xl:text-[40px] 4xl:text-[60px]"} />
            </div >
        </div>
    )
}