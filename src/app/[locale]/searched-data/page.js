...
export default function page() {
    ...
    const data = [
        ...
        },
        {
            ...
            "industry": "Generic",
            "date": "Sep. 08, 2025",
            "url": "/how-agentforce-ai-predicts-prevents-downtime-in-industry-4-0-manufacturing",
        ...
        <section className="mb-20">
            <div className="custom-container">
                ...
                <div className="sm:flex justify-between md:w-[74%]">
                    <p className="mt-5 4xl:text-[24px] 2xl:text-[21px] xl:text-[20px] md:text-[20px] text-[20px] font-bold leading-tight hover:text-[#0092E0]">Yielded {filtered.length} results</p>
                    <div className="max-sm:mt-5 relative sm:mt-2 flex gap-3 items-center" ref={dropdownRef}>
                        Sort By :
                        <button
                        ...
                        {slicedData.map((data, i) => (
                            <div className="mt-10" key={i}>
                                <Link key={i} href={"/insights/blogs/" + data.url}>
                                    ...
                                    <p className="mt-5 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] text-gray-400">https://www.rialtes.com/insights/blogs{data.url}</p>
                                    <p className="mt-2 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{data.description}</p>
                                </Link>
                            </div>
                        ))}
                    </div>
