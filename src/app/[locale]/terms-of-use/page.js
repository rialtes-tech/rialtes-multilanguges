            ...
            <section className="custom-container pt-[40px] pb-[80px]">
                <div className="grid lg:grid-cols-12">
                    <div className="4xl:col-span-9 xl:col-span-10 lg:col-span-11">
                        ...
                        <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('termsDesc')}</p>
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('useDesc')}</p>
                            <UnorderedList arrName={useRestrictions} ulClassName="list-disc 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] mt-5 space-y-3 pl-[34px] font-medium" liClassName="" />
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('noDesc')}</p>
                            <UnorderedList arrName={noWarranties} ulClassName="list-disc 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] mt-5 space-y-3 pl-[34px] font-medium" liClassName="" />
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('limitationDesc')}</p>
                            <UnorderedList arrName={limitationOfLiability} ulClassName="list-disc 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] mt-5 space-y-3 pl-[34px] font-medium" liClassName="" />
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('linksDesc')}</p>
                        </div>
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('lawDesc')}</p>
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('complianceDesc')}</p>
                        </div>
                        ...
                        <div className="md:mt-[50px] mt-[40px]">
                            ...
                            <p className="mt-[22px] xl:mt-[28px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('submissionOne')}</p>
                            <UnorderedList arrName={submissionTerms} ulClassName="list-disc 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] mt-5 space-y-3 pl-[34px] font-medium" liClassName="" />
