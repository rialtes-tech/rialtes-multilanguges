...
const schemaData = {
  ...
  description:
    "Rialtes provides Salesforce Revenue Cloud Consulting services to streamline quote-to-cash, automate pricing, improve billing, and integrate revenue operations for business growth.",
  inLanguage: "en",
  publisher: {
    "@type": "Organization",
    name: "Rialtes",
  ...
  mainEntity: {
    ...
    serviceType:
      "Revenue Operations Optimization, CPQ Implementation, Billing Integration",
    provider: {
      "@type": "Organization",
      name: "Rialtes",
      url: "https://www.rialtes.com",
    ...
    audience: {
      "@type": "Audience",
      audienceType:
        "Revenue Operations Leaders, Sales Directors, Finance Teams, CPQ Admins, CRM Managers",
    },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Tailored Revenue Cloud solutions for pricing, quoting, billing, and revenue recognition optimization.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Review and optimize your existing Revenue Cloud configuration for better performance and stability.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Streamline CPQ and billing processes through efficient platform setup and customization.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Data Migration",
            description:
              "Seamless transition from legacy systems to Revenue Cloud with secure CPQ and billing data migration.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Integrate Revenue Cloud with Sales Cloud, ERPs, and CRMs for unified revenue management.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Post-implementation support, upgrades, admin help, and issue resolution for Salesforce Revenue Cloud.",
          },
        },
      ],
    },
  ...
  return (
    <section>
          ...
          <div className="2xl:pr-72 xl:pr-40 md:pr-20 4xl:pr-20">
            <div className="flex flex-col lg:flex-row items-center py-6 ">
              <div className="flex flex-col  xl:mb-0 mb-4 ">
                <h1 className=" md:pb-0 pb-4 2xl:text-[56px] xl:text-[52px] xl:w-[650px] 2xl:w-[700px]  4xl:text-[60px] 4xl:w-[740px] lg:text-[42px] lg:w-[520px] leading-tight text-[26px] md:text-[32px] ">
                  {t("simplifyTitle")}
                </h1>
              </div>
              <div className="flex flex-col w-full ">
                <p className="text-[#000000]  2xl:text-[18px] 2xl:w-[520px] 4xl:text-[20px] 4xl:w-[580px]  xl:text-[16px] xl:w-[460px] lg:text-[14px] lg:w-[400px] md:text-[18px] 4xl:pl-10 2xl:pl-8 xl:pl-8 lg:pl-6">
                  {t("simplifyDesc")}
                </p>
              </div>
            </div>
      ...
      <section className="lg:mt-20 custom-container mt-10 pb-10">
        <h2 className="text-[24px] md:text-[40px] lg:text-[40px] xl:text-[46px] 2xl:text-[54px] 4xl:text-[60px] leading-tight   font-normal">
          {t("streamlineTitle")}
        </h2>
        ...
        <h2 className="text-[24px] md:text-[40px] lg:text-[40px] xl:text-[46px] 2xl:text-[54px] 4xl:text-[60px] leading-tight  font-normal mt-20 lg:mt-40 2xl:w-[980px] 4xl:w-[1084px] xl:w-[860px] lg:w-[730px] ">
          {t("pipelineTitle")}
        </h2>
        <div className="my-10">
            ...
            {salesForce2.map((sales) => {
              return (
                ...
                >
                  ...
                  <p className="mt-5 text-[16px] md:text-[18px] lg:text-[14px] xl:text-[18px] 2xl:text-[20px] 4xl:text-[22px] 4xl:w-[304px] 2xl:w-[290px] xl:w-[260px] lg:w-[200px]">
                    {sales.description}
                  </p>
                </div>
              );
