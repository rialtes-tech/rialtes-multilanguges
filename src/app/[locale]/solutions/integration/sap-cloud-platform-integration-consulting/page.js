        ...
        <section className="min-h-screen">
                ...
                <div className="relative h-full custom-container flex items-center text-[#ffffff]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 w-full">
                        <div className="col-span-12">
                            ...
                            <h2 className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight mt-[11.5px] md:mt-[28.5px] sm:w-[60%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 custom-container sm:mt-[-14%] mt-[-20%] md:mt-0">
                    ...
                    <div className="col-span-6 lg:col-span-5 xl:col-span-6 3xl:col-span-5 4xl:col-span-6">
                        <div className="md:bg-[#073259] md:mix-blend-hard-light bg-[#0A6BB8]/90 text-[#ffffff] xl:pt-[52px] pt-[29px] xl:pb-[40px] pb-[47px] xl:px-[63px] px-[23px]">
                            <h2 className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light md:w-[50%]">
                                {t('thoughtTitle')}
                            </h2>
                            <h3 className="xl:text-[30px] 4xl:text-[36px] md:text-[20px] text-[18px] mt-[14px] xl:mt-[27px] leading-tight font-semibold">
                                {t('thoughtSubTitle')}
                            </h3>
                            <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[27px] mt-[14px] font-normal">
                                {t('thoughtDesc')}
                            </p>
                            <UnorderedList arrName={thoughtLeadershipData} ulClassName="list-disc xl:mt-[27px] mt-[22px] md:ml-[26px] ml-[20px] space-y-[19px] xl:space-y-[27px]" liClassName="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight" />
                            <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[33px] mt-[22px] font-normal">
                                {t('thoughtDesc2')}
                            </p>
                        </div>
                    </div>
            ...
            <section className="xl:mt-[189px] mt-[90px] custom-container" >
                <div className="lg:mr-[80px] sm:mr-[60px] md:mr-0 border border-[#707070] lg:pl-[46px] xl:pr-[60px] 4xl:pr-[100px] sm:px-[36px] px-[28px] xl:pb-[75px] pb-[80px]">
                    <h2 className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[80%] bg-[#ffffff] mt-[-40px] xl:mt-[-50px]">
                        {t('endToEndTitle')}
                    </h2>
                            ...
                            endToEndData.map((data, ind) => {
                                return (
                                    <div className="border-l-[3px] border-[#006FBE] xl:pl-[32px] pl-[20px]" key={ind}>
                                        <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] xl:mb-[27px] mb-[24px] leading-tight font-semibold text-[#0A6BB8]">
                                            {data.title}
                                        </p>
                                        <ul>
                                            {data?.dataList?.map((item, ind) => {
                                                ...
                                                return (
                                                    <React.Fragment key={ind}>
                                                        <li className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight">
                                                            {item}
                                                        </li>
                                                        {!isLastItem && (
            ...
            <section className="custom-container xl:mt-[168px] mt-[89px]">
                <h2 className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light sm:w-[70%] md:w-[50%] xl:w-[52%] 4xl:w-[70%]">
                    {t('specializedTitle')}
                </h2>
                            ...
                            return (
                                <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-x-[40px] 4xl:gap-x-[60px]" key={ind} >
                                    <div className="lg:order-1 order-2 max-lg:mt-[43px]">
                                        <h3 className="4xl:text-[42px] 2xl:text-[36px] xl:text-[36px] md:text-[26px] text-[22px] leading-tight font-bold text-[#006FBE]">
                                            {data.title}
                                        </h3>
                                        <h4 className="4xl:text-[36px] 2xl:text-[30px] xl:text-[30px] md:text-[26px] text-[22px] leading-tight font-bold xl:mt-[48px] mt-[19px]">
                                            {data.subtitle}
                                        </h4>
                                        <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[42px] mt-[19px] font-normal md:w-[80%] lg:w-full">
                                            {data.desc}
                                        </p>
                                        <div className="grid lg:grid-cols-2 grid-cols-1 xl:mt-[56px] mt-[32px] md:gap-x-[20px] gap-y-[34px] ">
                                            <div>
                                                <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight font-semibold">
                                                    {t('keyTitle')}
                                                </p>
                                                <UnorderedList arrName={data.keyData} ulClassName="list-disc xl:space-y-[24px] space-y-[19px] xl:mt-[19px] mt-[19px] pl-[18px]" liClassName="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight" />
                                            </div>
                                            <div>
                                                <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight font-semibold">
                                                    {t('benefitsTitle')}
                                                </p>
                                                <UnorderedList arrName={data.businessData} ulClassName="list-disc xl:space-y-[24px] space-y-[19px] xl:mt-[19px] mt-[19px] pl-[18px]" liClassName="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight" />
                                            </div>
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12">
                        ...
                        <div className="col-span-6 xl:col-span-6">
                            <div className="bg-[#ffffff]/20 md:bg-[#ffffff]/50 text-[#000000] px-[36px] lg:pt-[76px] pt-[45px] md:pb-[91px] pb-[109px] md:pl-[43px] md:pr-[63px]">
                                <h2 className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light">
                                    {t('integrationTitle')}
                                </h2>
                                <h3 className="4xl:text-[36px] 2xl:text-[30px] xl:text-[30px] md:text-[26px] text-[22px] mt-[19px] xl:mt-[34px] leading-tight font-semibold">
                                    {t('integrationSubTitle')}
                                </h3>
                                <p className="text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[44px] mt-[19px] font-normal">
                                    {t('integrationDesc')}
                                </p>
                                    ...
                                    evenSection ?
                                        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] xl:gap-[60px] gap-y-[28px] sm:gap-y-0">
                                            <div className="md:col-span-5 col-span-12 md:order-1 order-2">
                                                <h2 className="md:block hidden 4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light">
                                                    {data.title}
                                                </h2>
                                                <h3 className="md:block hidden 4xl:text-[36px] 2xl:text-[30px] xl:text-[30px] md:text-[26px] text-[22px] mt-[19px] xl:mt-[34px] leading-tight font-semibold">
                                                    {data?.subtitle}
                                                </h3>
                                                <p className={`text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight md:mt-[34px] mt-[20px] max-[360px]:mt-[58px] ${data?.subtitle && "mt-[60px]  "} font-normal sm:w-[80%] md:w-full`}>
                                                    {data.desc}
                                                </p>
                                            ...
                                            <div className="md:col-span-7 col-span-12 md:order-2 order-1">
                                                ...
                                                <div>
                                                    <p className="md:hidden block 4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light sm:w-[80%]">
                                                        {data.title}
                                                    </p>
                                                    <p className="md:hidden block 4xl:text-[36px] 2xl:text-[30px] xl:text-[30px] md:text-[26px] text-[22px] mt-[19px] xl:mt-[34px] leading-tight font-semibold">
                                                        {data?.subtitle}
                                                    </p>
                                                </div>
                                                {/* Desktop Image */}
                                        ...
                                        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[40px] xl:gap-[60px] 4xl:gap-[80px] gap-y-[28px] sm:gap-y-0">
                                            ...
                                            <div className="md:col-span-5 col-span-12 order-2">
                                                ...
                                                <h3 className="md:block hidden 4xl:text-[42px] 2xl:text-[36px] xl:text-[36px] md:text-[26px] text-[22px] mt-[19px] xl:mt-[34px] leading-tight font-semibold">
                                                    {data?.subtitle}
                                                </h3>
                                                <p className={`text-[16px] md:text-[18px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px] leading-tight font-normal sm:w-[80%] md:w-full ${data?.subtitle ? "mt-[30px]" : "mt-[20px]"} md:mt-[34px]`}>
                                                    {data.desc}
                                                </p>
            ...
            <div className="custom-container xl:mt-[224px] lg:mt-[164px] xl:mb-[104px] mt-[104px] mb-[45px]">
                <ContactForm title={t('contactTitle')} subtitle={t('contactSubTitle1')} subtitle1={t('contactSubTitle2')} className="4xl:text-[60px] 2xl:text-[40px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight lg:w-[70%] 4xl:w-[80%]" />
            </div>
        </section>
    )
}
