    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="py-10 bg-white 4xl:max-w-[1084px] 4xl:w-[1084px] xl:w-[800px]">
          <div className="">
            <h1 className="text-[#000000] py-6 leading-tight text-[24px]  4xl:text-[60px] xl:text-[45px] ">Automating ACH and Journal Entries with Our Exelona Banking Module</h1>
          </div>
