                    ...
                    <div className="4xl:col-span-10 xl:col-span-10 lg:col-span-11 col-span-12">
                        ...
                        <div className="xl:mt-[60px] mt-[42px]">
                            ...
                            <div className="md:mt-[50px] mt-[40px]">
                                ...
                                <p className="mt-10 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{t('predictiveDesc4')} <a href={t('href')} className='text-[#0092E0] transition duration-300 ease-out hover:text-gray-400 underline'>{t('predictiveDesc4Link')}</a>.</p>
