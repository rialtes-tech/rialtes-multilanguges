      ...
      <section className="custom-container 4xl:mt-[80px] xl:mt-[60px] mt-[40px]">
        <div className="grid lg:grid-cols-12">
          <div className="4xl:col-span-10 xl:col-span-10 lg:col-span-11">
            ...
            {/* date and icons */}
            <BlogSocialIcons fullUrl={fullUrl} topic={t('blogTopic')} date="03 February 2025" />
              ...
              <div className="mt-[29px] xl:mt-[30px]">
                {
                  blogMainData.map((data, ind) => {
                    return (
                      <p className="mt-5 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]" key={ind}>{data}</p>
                    )
                  })
                }
              </div>
                  ...
                  commonData.map((data, ind) => {
                    return (
                      <div key={ind} className="md:mt-[50px] mt-[40px]">
                        ...
                        <p className="text-black mt-[29px] xl:mt-[30px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{data.desc}</p>
                        <ul className="list-disc font-medium marker:text-xl 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] mt-5 pl-[34px] space-y-4">
                          {
                            data.data.map((elem, ind) => {
                              return (
                                <li key={ind}><h3 className="inline font-bold 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]">{elem.title}{" "}</h3>{elem.desc}</li>
                              )
                            })
                          }
                        </ul>
