...
export default function Page() {
    ...
    const { mainData,schemaData, faqdata, whySalesforceData, salesforceData, howSalesforceData, commonData } = content.salesforceConsulting;
    ...
    return (
        <section className="min-h-screen">
            <Seo
                ...
                canonical={`https://www.rialtes.com/${locale}/insights/blogs/salesforce-consulting-playbook-enterprise-growth`}
            />
            ...
            <section className="custom-container 4xl:mt-[80px] xl:mt-[60px] mt-[40px]">
                <div className="grid lg:grid-cols-12">
                    <div className="4xl:col-span-10 xl:col-span-10 lg:col-span-11">
                        ...
                        {/* date and icons */}
                        <BlogSocialIcons fullUrl={fullUrl} topic={t('blogTopic')} date="23 December 2025" />
