...
export default function Page() {
    ...
    const t = useTranslations("whatMakesSap");
    ...
    const { mainData, whyTrustData, howEnterpriseData, faqdata, sapConsultingData, howTrustData, commonTrustData, whyEnterpriseData,schemaData } = blogsContent.whatMakesSap
            ...
            <section className="custom-container 4xl:mt-[80px] xl:mt-[60px] mt-[40px]">
                <div className="grid lg:grid-cols-12">
                    <div className="4xl:col-span-10 xl:col-span-10 lg:col-span-11">
                        ...
                        {/* date and icons */}
                        <BlogSocialIcons fullUrl={fullUrl} date="29 December 2025" topic={t('blogTopic')} />
