...
export default function Page() {
    ...
    const { salesforceData, driveData, predectiveData, empowerData, faqs } = blogsContent.ecommerceDataCloud;
                ...
                <div className="py-10 bg-white">
                    ...
                    <div className="grid xl:grid-cols-12">
                        <div className="col-span-9">
                            <p className="mt-5 4xl:pr-20 4xl:text-[20px] xl:text-[17px] text-[16px]">{t('blogMainData')}</p>
                            <p className="mt-5 4xl:pr-20 4xl:text-[20px] xl:text-[17px] text-[16px]">{t('blogMainData2')}</p>

                            <h2 className="font-semibold mt-20 text-[#0092E0] 4xl:text-[30px] xl:text-[26px] text-[22px]">{t('salesforceTitle')}</h2>
                            ...
                            <p className="mt-5 4xl:pr-20 4xl:text-[20px] xl:text-[17px] text-[16px]">{t('salesforceDesc')}</p>


                            <h2 className="font-semibold mt-20 text-[#0092E0] 4xl:text-[30px] xl:text-[26px] text-[22px]">{t('driveTitle')}</h2>

                            <p className="mt-5 4xl:pr-20 4xl:text-[20px] xl:text-[17px] text-[16px]">{t('driveDesc')}</p>
                            ...
                            <h2 className="font-semibold mt-20 text-[#0092E0] 4xl:text-[30px] xl:text-[26px] text-[22px] pr-10 xl:pr-0">{t('predictiveTitle')}</h2>
                                                        ...
                                                        <ul className="list-disc marker:text-[#006FBE] pl-[32px] space-y-2">
                                                            {
                                                                data.list.map((item, ind) => (
                                                                    <li
                                                                        className="mt-5"
                                                                        key={ind}>
                                                                        <p className="inline font-bold text-[16px] xl:text-[18px] 4xl:text-[20px]">{item.title} : </p>
                            ...
                            <h2 className="font-semibold mt-20 text-[#0092E0] 4xl:text-[30px] xl:text-[26px] text-[22px]">{t('empowerTitle')}</h2>
                            ...
                            <h2 className="font-semibold mt-16 mb-10 text-[#0092E0] 4xl:text-[30px] xl:text-[26px] text-[22px] pr-10 xl:pr-0">{t('faqTitle')}</h2>
