                    ...
                    <div className="4xl:col-span-10 xl:col-span-10 lg:col-span-11">
                        ...
                        <div className="xl:mt-[60px] mt-[42px]">
                            ...
                            <div className="md:mt-[50px] mt-[40px]">
                                ...
                                <h3 className="4xl:text-[24px] 2xl:text-[21px] xl:text-[20px] md:text-[20px] text-[20px] mt-[48px] xl:mt-[80px] font-bold">{t("topSalesforce")}</h3>
                                            ...
                                            <div
                                                ...
                                                <h3
                                                    className="md:absolute md:flex items-center justify-center
                                                                ...
                                                                4xl:w-[340px] xl:w-[280px] md:w-[240px] w-fit 4xl:h-[120px]">
                                                    {data.title}
                                                </h3>
