    ...
    return (
        <section className="min-h-screen">
                ...
                <div className="relative h-full custom-container flex items-center">
                    <div className="grid grid-cols-1 lg:grid-cols-12 w-full pt-[80px] md:pt-0">
                        <div className="col-span-12">
                            <h1 className="text-[#FFFFFF] text-[18px] xl:text-[20px] 4xl:text-[24px] font-bold lg:w-full">
                                {t('headerTitle')}
                                <div className="text-[#FFFFFF] text-[26px] md:text-[30px] leading-tight xl:text-[40px] 4xl:text-[60px] mt-[11.5px] md:mt-[28.5px]">
            ...
            <div className="custom-container xl:mt-[124px] mt-[53px]">
                <div className="grid lg:grid-cols-12 grid-cols-1 xl:gap-[30px] 4xl:gap-[40px] gap-y-[28px]">
                    <div className="lg:col-span-6 xl:col-span-7 col-span-12">
                        <h2 className="4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight md:w-[80%] xl:w-[90%] 4xl:w-full">
                            {t('pageDescTitle')}
                        </h2>
                    </div>
                    <div className="lg:col-span-6 xl:col-span-5 col-span-12">
                        <p className="text-[16px] 4xl:text-[22px] md:text-[18px] xl:text-[18px] font-normal mt-[6px] w-[90%] md:w-[80%] lg:w-full">
                            {t('pageDesc')}
                        </p>
                    </div>
                </div>
            ...
            <section className="custom-container xl:mt-[166px] mt-[49px]">
                <h2 className="4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight lg:w-[60%] 4xl:w-[70%]">
                    {t('addressingTitle')}
                </h2>
                <p className="text-[16px] 4xl:text-[22px] md:text-[18px] xl:text-[18px] font-normal xl:mt-[39px] mt-[28px] w-[90%] lg:w-[65%] 4xl:w-[70%]">
                    {t('addressingDesc')}
                </p>
                {
                ...
                <div className="grid lg:grid-cols-12 grid-cols-1">
                    <div className="lg:col-span-5 col-span-12 lg:my-[40px] max-md:mx-[36px] lg:mr-[-90px] max-md:mt-[-120px] relative z-20 lg:order-1 order-2">
                        <div className="bg-[#006FBE] text-[#ffffff] xl:pt-[69px] xl:pb-[96px] lg:pl-[63px] xl:pr-[20px] pt-[39px] pb-[70px] px-[26px]">
                            <h2 className="4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light w-[95%] lg:w-[60%] xl:w-full">{t('globalTitle')}</h2>
                            <p className="text-[16px] 4xl:text-[22px] md:text-[18px] xl:text-[18px] font-normal xl:mt-[65px] mt-[25px] w-[94%] lg:w-[90%]">{t('globalSubTitle')}</p>
            ...
            <section className="custom-container xl:mt-[119px] mt-[85px]">
                <div className="grid xl:grid-cols-12 grid-cols-1 gap-y-[29px] xl:gap-[60px]">
                    <div className="xl:col-span-7 col-span-12">
                        <h2 className="4xl:text-[55px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight">
                            {t('howAiTitle')}
                        </h2>
                    </div>
                    <div className="xl:col-span-5 col-span-12">
                        <p className="text-[16px] 4xl:text-[20px] md:text-[18px] xl:text-[16px] font-normal md:w-[80%] xl:w-full">{t('howAiDesc')}</p>
                    </div>
                </div>
                            ...
                            aiRovolutionizingData.map((data, ind) => {
                                return (
                                    <div key={ind} className="border border-[#707070] xl:pt-[52px] xl:pb-[56px] xl:px-[40px] pt-[32px] pb-[32px] px-[26px]">
                                        <h3 className="4xl:text-[30px] xl:text-[24px] md:text-[22px] text-[20px] leading-tight text-[#006FBE] font-semibold">
                                            {data.title}
                                        </h3>
                                        <p className="text-[16px] 4xl:text-[22px] md:text-[18px] xl:text-[18px] font-normal xl:mt-[31px] mt-[22px] w-[90%] xl:w-full 4xl:w-[86%]">
                                            {data.desc}
                                        </p>
                                    </div>
                                )
                ...
                <div className="custom-container text-[#ffffff]">
                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 xl:mt-[36px] mt-[17px] lg:gap-[60px] gap-y-[17px]">
                        <div className="lg:col-span-5 col-span-12">
                            <h3 className="4xl:text-[42px] xl:text-[36px] md:text-[26px] text-[22px] leading-tight">
                                {t('ourCapabSubTitle')}
                            </h3>
                        </div>
                        <div className="lg:col-span-7 col-span-12">
                            <p className="text-[16px] 4xl:text-[20px] xl:text-[16px] md:text-[18px] font-normal w-[90%] md:w-[70%] lg:w-full 4xl:w-[90%]">
                                {t('ourCapabDesc')}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 xl:mt-[79px] mt-[34px] md:w-[70%] lg:w-[90%] xl:w-[87%] lg:gap-x-[80px] lg:gap-y-[91px] gap-y-[55px]">
                        {
                            capabilitiesData.map((data, ind) => {
                                return (
                                    <div key={ind}>
                                        <h4 className="4xl:text-[36px] xl:text-[30px] md:text-[22px] text-[20px] leading-tight w-[90%] lg:w-full">
                                            {data.title}
                                        </h4>
                                        <p className="text-[16px] 4xl:text-[20px] md:text-[18px] xl:text-[16px] font-normal w-[90%] lg:w-full xl:mt-[35px] mt-[16px] 4xl:w-[98%]">
                                            {data.desc && data.desc}
                                        </p>
                                        <UnorderedList arrName={data.dataList} ulClassName="xl:space-y-[24px] space-y-[19px] list-disc xl:mt-[35px] mt-[17px] pl-[20px] w-[90%] md:w-full 4xl:w-[90%]" liClassName="text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] leading-tight font-normal" />
                                    </div>
                                )
                            })
                        }
            ...
            <section className="custom-container bg-[#0A6BB8] text-[#ffffff] xl:mt-[247px] mt-[174px] relative">
                <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[80px] gap-y-[40px]">
                    ...
                    <div>
                        <h2 className="4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight lg:mt-[46px]">
                            {t('agentChatTitle')}
                        </h2>
                        <h3 className="4xl:text-[42px] xl:text-[36px] md:text-[26px] text-[22px] leading-tight xl:mt-[35px] mt-[17px] font-semibold w-[85%] md:w-full">
                            {t('agentChatSubTitle')}
                        </h3>
                        <p className="text-[16px] 4xl:text-[20px] xl:text-[16px] md:text-[18px] font-normal w-[90%] lg:w-full xl:mt-[35px] mt-[24px]">
                            {t('agentChatDesc')}
                        </p>
                    </div>
                </div>
                        ...
                        agentChat.map((data, ind) => {
                            ...
                            return (
                                <div
                                    ...
                                    <h4 className="4xl:text-[32px] xl:text-[26px] md:text-[22px] text-[20px] leading-tight w-[90%] lg:w-full">
                                        {data.title}
                                    </h4>
                                    <p className="text-[16px] 4xl:text-[20px] md:text-[18px] xl:text-[16px] font-normal w-[90%] lg:w-full xl:mt-[21px] mt-[19px] 4xl:w-[98%]">
                                        {data.desc && data.desc}
                                    </p>
                                </div>
                            )
                ...
                <div className="relative">
                    <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] gap-y-[19px] mt-[40px] xl:mt-[80px] items-stretch">
                        ...
                        <div className="lg:col-span-6 xl:col-span-7 col-span-12">
                            <UnorderedList arrName={homeHealth} ulClassName="xl:space-y-[24px] space-y-[19px] list-disc pl-[20px] w-[90%] md:w-full 4xl:w-[90%] lg:pb-[120px]" liClassName="text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] leading-tight font-normal" />
                        </div>
                        ...
                        relatedData.map((data, ind) => {
                            ...
                            return (
                                <div className={`${paddingRight(ind)} flex flex-col pb-[30px] xl:pb-0`} key={ind}>
                                    <h3 className="4xl:text-[30px] xl:text-[24px]  text-[20px] leading-tight font-semibold text-[#006FBE]">
                                        {data.title}
                                    </h3>
                                    <p className="text-[16px] md:text-[18px] 4xl:text-[24px] xl:text-[18px] font-normal w-[90%] lg:w-full xl:mt-[31px] mt-[10px] xl:mb-[31px] mb-[18px]">
                                        {data.desc}
                                    </p>
            ...
            <section className="custom-container xl:mt-[130px] xl:mb-[130px] mt-[65px] mb-[48px]">
                <ContactForm title={t('contactTitle')} subtitle={t('contactSubTitle')} className={"font-normal text-[26px] leading-tight xl:text-[40px] md:text-[30px] 4xl:text-[60px] xl:w-[60%] 4xl:w-[80%]"} />
            </section >
        </section>
    )
}
