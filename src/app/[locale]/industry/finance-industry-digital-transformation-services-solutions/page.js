    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[350px] md:h-[500px] 4xl:h-[650px]">
        <div className="xl:block hidden">
          <Image
            src="/images/finance-img/finance-digital-technology-network-visualization.webp"
            alt={t("bannerAlt")}
            fill
            priority
            sizes="100vw"
        ...
        <div className="xl:hidden block">
          <Image
            src="/images/finance-img/mobile/finance-digital-technology-network-visualization-mobile.webp"
            alt={t("bannerAlt")}
            fill
            priority
            sizes="100vw"
      ...
      <section>
        <div className="relative pb-10 xl:pb-0 xl:mt-0">
          ...
          <div className="md:block hidden">
            <Image
              src="/images/finance-img/financial-analyst-data-charts-presentation.webp"
          ...
          <div className="md:hidden block relative w-full">
            <Image
              src="/images/finance-img/mobile/financial-analyst-data-charts-presentation-mobile.webp"
              alt={t("thoughtLeadershipAlt")}
              width={0}
              height={0}
              className="h-full w-full"
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 md:grid-cols-2 lg:mt-[27px] mt-[20px] md:gap-10 lg:gap-15 ">
            ...
            <div className="lg:col-span-6 col-span-12 md:col-span-1">
              <UnorderedList
                ...
                ulClassName="list-disc xl:space-y-5 text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] pl-5 marker:font-bold marker:text-2xl leading-tight pb-[40px]"
                liClassName=""
              />
            ...
            {challenges.map((item, i) => (
              <div key={i} className="relative h-full">
                <div className="border border-gray-300 xl:p-12  p-8  xl:mt-[40px] h-full">
                  ...
                  <p className="mt-3 4xl:text-[40px] xl:text-[30px] md:text-[26px]  text-[22px] leading-tight font-bold text-[#006FBE]">
                    {item.title}
                  </p>
                  <UnorderedList
                    arrName={item.points}
                    ulClassName="list-disc xl:space-y-5 4xl:text-[20px] xl:text-[16px] md:text-[18px] text-[16px] pl-5 marker:font-bold marker:text-2xl leading-tight pb-[7px] my-6"
                    liClassName=""
                  />
                </div>
              </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[70px] 4xl:gap-[127px] gap-y-[22px] xl:mt-9 mt-7 ml-1">
                <div className="md:col-span-5 col-span-12">
                  <div className="">
                    <Image
                      src="/images/finance-img/financial-advisors-client-consultation-meeting.webp"
                ...
                <div className="md:col-span-5 col-span-12 xl:mt-[100px] mt-0">
                  <div className="">
                    <Image
                      src="/images/finance-img/financial-professional-sap-hana-analytics-work.webp"
      ...
      <section className="custom-container pt-[105px] pb-[50px]">
        <div>
          <>
            {/* Mobile Image */}
            <Image
              src="/images/finance-img/mobile/business-woman-financial-data-wall-analysis-mobile.webp"
            ...
            {/* Desktop Image */}
            <Image
              src="/images/finance-img/business-woman-financial-data-wall-analysis.webp"
              alt={t("revolutionizingAlt")}
        ...
        <div className="grid  md:grid-cols-12 xl:gap-14 gap-1">
          ...
          <div className="md:col-span-6 xl:ml-[70px] xl:my-9 my-5 ">
            <UnorderedList
              arrName={aiData}
              ulClassName="list-disc xl:space-y-5 text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] pl-5 marker:font-bold marker:text-2xl leading-tight"
              liClassName=""
            />
            <div className="mt-10">
              <LearnMore btnName={t('learnMoreBtn')} locale={locale} />
        ...
        <p className="4xl:text-[26px] xl:text-[22px] md:text-[20px] text-[18px] xl:mt-[28px] mt-[10px] w-fit bg-[#0E3157] p-[24px] text-white leading-tight">
          {t('futureDescOne')}
        </p>
      </section>
      {/* Exelona section */}
      <section className="relative py-7">
        <div className="h-full w-full relative z-0">
          {/* Desktop */}
          <div className=" hidden md:block h-full w-full md:h-[1000px] lg:h-[800px] 3xl:h-full">
            <Image
              src="/images/finance-img/exelona-real-estate-finance-salesforce-integration.webp"
          ...
          <div className="block md:hidden">
            <Image
              src="/images/finance-img/mobile/exelona-real-estate-finance-salesforce-integration-mobile.webp"
              alt={t("exelonaSectionAlt")}
              width={800}
              height={600}
              priority
          ...
          <div className="grid grid-cols-12 gap-2 custom-container max-md:px-0">
            ...
            <div className="md:col-span-6 col-span-12 h-full relative overflow-hidden">
              ...
              <div className="hidden md:block absolute inset-0 z-0">
                <Image
                  src="/images/finance-img/modern-glass-skyscrapers-upward-view-blue-sky.jpg"
              ...
              <div className="relative z-10 lg:px-[54px] 4xl:pt-[50px] 2xl:pt-[50px] xl:pt-[30px] px-[36px] pt-[40px] max-md:bg-[#606060]">
                ...
                <UnorderedList
                  arrName={exelonaData}
                  ulClassName="list-disc leading-tight p-4 text-white font-light pt-4 text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] space-y-4"
                  liClassName="pb-1"
                />
                {/* Desktop  */}
      ...
      <section className="custom-container xl:pr-0 max-md:px-0 md:pt-14 pt-20">
        <div>
          <>
            {/* Mobile Image */}
            <Image
              src="/images/finance-img/mobile/professional-woman-mobile-banking-outdoors-mobile.webp"
              alt={t("agentchatAlt")}
              className="w-full h-full block md:hidden"
              priority
              width={0}
            ...
            {/* Desktop Image */}
            <Image
              src="/images/finance-img/professional-woman-mobile-banking-outdoors.webp"
              alt={t("agentchatAlt")}
              className="w-full h-full hidden md:block"
              priority
              width={0}
      ...
      <section className="pt-[61px] xl:pt-[163px] custom-container xl:pr-0 max-md:px-0">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-center ">
          <div className="order-1 xl:order-2 w-full h-full xl:col-span-7 ">
            <Image
              src="/images/finance-img/interactive-financial-dashboard-tablet-analytics.webp"
            ...
            />
            <Image
              src="/images/finance-img/mobile/interactive-financial-dashboard-tablet-analytics-mobile.webp"
              alt={t("dataDrivenSectionAlt")}
              width={0}
              height={0}
          ...
          <div className="order-2 xl:order-1 xl:col-span-5 max-md:px-[37px] ">
            ...
            <p className="leading-tight  font-normal text-[16px] md:text-[18px] xl:text-[16px] 4xl:text-[20px]  ">
              {t('dataDesc')}
            </p>
            <div>
              <UnorderedList
                arrName={drivenData}
                ulClassName="list-disc pt-4 text-black pl-4 text-[16px] xl:text-[16px] md:text-[18px] 4xl:text-[20px] leading-tight"
                liClassName="pb-2"
              />
              <p className="4xl:text-[26px] xl:text-[22px] md:text-[20px] text-[18px] xl:mt-[60px] mt-[26px] w-fit bg-[#0E3157] p-[24px] text-white leading-tight xl:w-[80%]">
                {t('dataDescOne')}
              </p>
            ...
            <div className="mx-auto ">
              <div className="flex flex-col xl:flex-row mb-8 mt-16 xl:gap-[80px] gap-10">
                <div className="grid flex-start items-center">
                  <Image
                    src="/images/finance-img/certified-financial-experts-icon.svg"
                    alt={t("certifiedAlt")}
                    width={100}
                    height={100}
                    priority
                  ...
                  />
                  <p className="mt-5 4xl:text-[28px] xl:text-[24px] md:text-[22px] text-[20px] text-[#006FBE] font-bold leading-tight">
                    {t('unmatchedDescOne')}
                  </p>
                ...
                <div className="grid flex-start items-center">
                  <Image
                    src="/images/finance-img/financial-certifications-document-icon.svg"
                ...
                <div className="grid flex-start items-center">
                  <Image
                    src="/images/finance-img/global-financial-services-delivery-icon.svg"
                  ...
                  <p className="mt-5  4xl:text-[28px] xl:text-[24px] md:text-[20px] text-[20px] text-[#006FBE] font-bold leading-tight ">
                    {t('globalDesc')}
                  </p>
                </div>
                <div className="grid flex-start items-center ">
                  <Image
                    src="/images/finance-img/24-7-financial-customer-support-icon.svg"
                    alt={t("supportAlt")}
                    width={100}
                    height={100}
                    priority
      ...
      <section className="xl:mt-0 mt-[58px] custom-container max-lg:px-0 xl:!pr-0">
        <div className="grid grid-cols-1 xl:grid-cols-[6fr_6fr]">
          <div className="block md:hidden w-full h-auto">
            <Image
              src="/images/finance-img/mobile/financial-presenter-holographic-data-visualization-mobile.webp"
          ...
          <div className="w-full h-full">
            <Image
              src="/images/finance-img/financial-presenter-holographic-data-visualization.webp"
              alt={t("financialSectionAlt")}
          ...
          <div className="">
            <div className="relative  text-[#FFFFFF] xl:mr-[142px] xl:pl-[72px] xl:ml-[-20%] xl:mt-[100px] mx-[0px] px-[35px] xl:pt-[74px] pt-[42px] bg-[#A87867] xl:pb-[125px] pb-[79px] overflow-visible">
              <h2 className="4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] leading-tight font-light 4xl:w-[90%] 3xl:w-[78%] xl:w-[94%]">
                {t('whyTitle')}
              </h2>
              <UnorderedList
                arrName={whyChooseData}
                ulClassName="list-disc pl-[22px] w-[90%] xl:mt-[48px] mt-[34px] 4xl:space-y-[24px] space-y-[19px] 4xl:text-[22px] xl:text-[18px] md:text-[18px] text-[16px] leading-tight"
                liClassName=""
              />
              <div className="absolute bottom-0">
                <LearnMore btnName={t('learnMoreBtn')} locale={locale} />
      ...
      <div className="mx-[35px] custom-container text-black py-20">
        <ContactForm className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[30px] text-[26px] xl:w-[60%] 2xl:w-[60%] 4xl:w-[70%]"
