...
const schemaData = {
  ...
  description:
    "Global expert in IT services and IT consulting, Rialtes delivers AI-powered Salesforce and SAP solutions across industries.",
...
const carouselData = [
  {
    title: "Blogs",
    description: "SAP PI PO to SAP CPI Migration: A Complete Guide",
...
const successStoryData = [
  ...
  },
  {
    ...
    title: "Public Sector",
    description:
      "YARDI Transformation Journey with North America's Largest PHA",
    theme: "light",
  ...
  },
  {
    ...
    title: "Real Estate",
    description:
      "Automating ACH and Journal Entries with Our Exelona Banking Module",
...
const Home = () => {
  ...
  const slides = useMemo(
    () => [
      {
  link: "https://www.rialtes.com/products/mediaina-reimagining-patient-journeys",
  alt: "MediAIna AI-powered healthcare platform reimagining patient journeys with intelligent digital care solutions",
  title: "MediAIna",
  image: "/images/homepage/medina.webp",
  imageMobile: "/images/homepage/medina-mobile.webp",
},
{
  link: "https://www.rialtes.com/services/spend-management/sapbuyplus-ariba-implementation-partner",
  alt: "SAPBuy+ SAP Ariba implementation and spend management solution for streamlined procurement operations",
  image: "/images/homepage/sapbuyplus.webp",
  title: "SAPBuy+",
  imageMobile: "/images/homepage/sapbuy-mobile.webp",
},
{
  link: "https://www.rialtes.com/industry/hitech-semiconductor-ai-it-solutions",
  alt: "Semiconductor industry AI and IT solutions enabling innovation and digital transformation in high-tech manufacturing",
  image: "/images/homepage/semiconductor.webp",
  title: "Semiconductor",
  imageMobile: "/images/homepage/semiconductor-mobile.webp",
},
{
  link: "https://www.rialtes.com/services/application-services/salesforce-managed-services-provider-salesforceagentplus",
  alt: "SalesforceAgent+ managed services solution enhancing Salesforce performance, automation, and customer engagement",
  image: "/images/homepage/salesforceAgentplus.webp",
  title: "SalesforceAgent+",
  imageMobile: "/images/homepage/salesforceplus.webp",
},
    ],
    [],
  );
  ...
  return (
    <div>
            ...
            <Link key={i} href={s.link}>
              <div
                className={`absolute inset-0 transition-opacity duration-1000 ease-in-out ${
                  i === currentSlide ? "opacity-100 z-30" : "opacity-0 z-20"
                }`}
              >
                {/* Desktop */}
      ...
      <section className="custom-container xl:mt-[98px] mt-[55px]">
        ...
        <div
          ref={refs[7]}
          className={`transition-all duration-1000 ease-out transform grid xl:grid-cols-12 grid-cols-1 ${
            inViews[7]
        ...
        >
          ...
          <div className="lg:col-span-8 col-span-12 2xl:pl-[78px] xl:pl-[42px]">
            <h3 className="4xl:text-[110px] xl:text-[80px] md:text-[60px] sm:text-[46px] font-bold text-[33px] outline-text border-l-[2px] xl:border-none border-gay-300 ml-[34%] sm:ml-[35%] md:ml-[32%] pl-[20px] xl:pl-0 xl:ml-auto mt-[20px] leading-tight">
              with Impact
            </h3>
            <h2 className="4xl:text-[32px] xl:text-[28px] text-[26px] text-[#0077CE] xl:mt-[30px] mt-[30px] font-bold leading-tight">
              Beyond Business: A Commitment to Change
            </h2>
            <p className="xl:mt-[27px] mt-[16px] 4xl:text-[20px] md:text-[18px] text-[16px] leading-tight">
              Rialtes is more than a technology leader — we are advocates for
              positive change. From sustainability initiatives to empowering
              underrepresented voices, we’re dedicated to making a meaningful
              impact
            </p>
          </div>
        </div>
      ...
      <section className="custom-container lg:pr-0 xl:mt-[147px] mt-[87px]">
        ...
        >
          <div className="col-span-5">
            <h2 className="4xl:text-[60px] md:text-[32px] xl:text-[40px] 2xl:text-[48px] text-[26px]">
              Success Stories
            </h2>
          </div>
          <div className="col-span-7">
            <p className="mt-5 xl:mt-0 md:mt-5 lg:mt-mt-5 pr-8 xl:pr-0 lg:w-[80%] text-[16px] md:text-[18px] 4xl:text-[20px]">
              Discover how we’ve harnessed the disruptive power of cutting-edge
              AI to help companies anticipate and act with insight and speed
              with IT consulting services.
            </p>
          </div>
      ...
      <section className="xl:mt-[158px] mt-[87px]">
        ...
        >
          <div className="col-span-6">
            <h2 className="4xl:text-[60px] 2xl:text-[48px] md:text-[32px] xl:text-[40px] text-[26px] leading-tight">
              Industry Expertise & Solutions
            </h2>
          </div>
          <div className="col-span-6">
            <p className="mt-5 xl:mt-0 sm:mt-5 lg:mt-5 4xl:text-[20px] md:text-[18px] text-[16px]">
              We have domain expertise across various industries, enabling us to
              offer tailored IT consulting services to meet your specific
              industry needs. Transform your business with a quantifiable and
              pre-focussed system.
            </p>
          </div>
        </div>
        ...
        <div className="custom-container grid lg:grid-cols-2 lg:mt-[182px] mt-[97px] lg:h-[850px]">
          ...
          >
            ...
            <p className="mt-6 xl:mt-10 text-[16px] 2xl:w-[70%] 4xl:text-[20px] xl:text-[18px] sm:w-[70%] mb-10">
              Stay ahead of the curve with expert perspectives, success stories,
              and the latest innovations in AI.
            </p>
          </div>
          ...
          <div className="h-full flex flex-col justify-between pt-0">
            <div
              ref={refs[2]}
              className={`transition-all duration-1000 ease-out transform lg:pl-[68px] lg:block hidden ${
                inViews[2]
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-12"
              }`}
            >
              ...
              <p className="mt-6 lg:mt-10 text-[16px] 3xl:w-[80%] 4xl:text-[20px] xl:text-[18px] leading-tight text-gray-700">
                Stay ahead of the curve with expert perspectives, success
                stories, and the latest innovations in AI.
              </p>
            </div>
            ...
            <div className="text-white space-y-6 bg-[#184671] lg:pl-[65px] pl-[29px] pt-[35px] lg:pt-[78px] lg:mt-0">
              ...
              <Link href={carouselData[activeIndexInsights].link}>
                <p
                  ref={refs[5]}
                  className={`transition-all 4xl:text-[38px] xl:text-[30px] text-[24px] font-normal lg:pb-[60px] lg:pr-[40px] pr-[40px] lg:mt-[38px] mt-[13px] duration-1000 ease-out transform ${
                    inViews[5]
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-12"
                  }`}
              ...
              <div className="flex items-center float-end gap-6">
                ...
                <div className="flex">
                  <button
                    ...
                    className="xl:h-[60px] xl:w-[60px] h-[45px] w-[45px] bg-white flex items-center justify-center shadow-md hover:bg-gray-100"
                  >
      ...
      <section className="custom-container xl:mt-[113px] mt-[77px] grid grid-cols-1 xl:grid-cols-12 gap-y-[40px] xl:gap-0">
        <div
          ref={refs[3]}
          className={`transition-all duration-1000 col-span-12 xl:col-span-5 ease-out transform ${
            inViews[3]
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-12"
          }`}
        >
          <div className="text-[#073259] text-[56px] leading-[68px] md:text-[100px] md:leading-[120px] 4xl:text-[140px] 4xl:leading-[219px] lg:text-[80px] font-extrabold">
            ...
            <p className="text-[16px] md:text-[18px] 4xl:text-[20px] leading-tight font-medium xl:mt-[27px] mt-[19px] xl:w-[90%] lg:w-[70%] md:w-[80%] w-[90%] ">
              Driven by innovation and fueled by human potential, our IT
              consulting company tackles the digital world’s toughest problems.
              Together, let’s simplify problems, enable solutions, and empower
              each other.
            </p>
          </div>
        </div>
        <div
          ref={refs[4]}
          className={`transition-all col-span-12 xl:col-span-7 duration-1000  ease-out transform ${
            inViews[4]
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-12"
          }`}
      ...
      <section className="pb-20 mt-20 custom-container">
        <ContactForm
          className="xl:w-[80%] 4xl:w-full w-full 4xl:text-[60px] 2xl:text-[48px] xl:text-[40px] md:text-[32px] text-[26px] leading-tight"
