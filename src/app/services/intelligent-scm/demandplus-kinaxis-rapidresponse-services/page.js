...
export default function DemandPlusSection() {
  ...
  const schemaData = {
    ...
    description:
      "Kinaxis rapid response meets AI-driven planning. Rialtes DemandPlus delivers supply chain visibility, predictive agility, and smarter control.",
    inLanguage: "en",
    publisher: {
      "@type": "Organization",
  ...
  const services = [
    {
      ...
      description: "Seamless ERP Integrations Across SAP, Oracle, and Kinaxis",
    ...
    },
    {
      ...
      knowMore:
        "/services/intelligent-scm/demandplus-kinaxis-rapidresponse-services",
    },
  ];
  const endToEndData = [
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Breadcrumb Schema */}
      <BreadcrumbSchema
        currPage="Kinaxis RapidResponse"
        subPath="Supply Chain Management"
      />
      {/* hero section */}
          ...
          <div className="grid xl:grid-cols-12  grid-cols-1 gap-2 2xl:mt-10 4xl:mt-20 mt-10">
            <div className="xl:col-span-7 md:col-span-2 col-span-12">
              ...
              <h1 className="text-white leading-tight mt-5  xl:pr-0 md:text-[42px] 4xl:text-[60px] xl:text-[45px] text-[26px]">
                Transform Your Supply Chain with Rialtes ‘DemandPlus’ for
      ...
      <section className="custom-container xl:!pr-0 mt-4">
        {/* breadcrumbs */}
        <BreadCrumbs
          currPage="Kinaxis RapidResponse"
          subPath="Supply Chain Management"
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:mt-20 mt-10">
          <div className="xl:col-span-8 xl:pr-0 ">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Agility, Accuracy, and Resilience in Supply Chain — Powered by
              Kinaxis and Rialtes
            </h2>
            <p className="mt-12 text-[16px] 4xl:text-[20px] md:text-[18px]">
              In today’s volatile and complex supply chain landscape, businesses
              need real-time visibility, agile planning, and predictive insights
              to stay competitive. Rialtes’ DemandPlus Services, built around
              Kinaxis RapidResponse, deliver end-to-end supply chain
              transformation, enabling companies to plan, monitor, and respond
              to supply chain dynamics in real-time.{" "}
            </p>
            <p className="mt-8 pb-16 text-[16px] 4xl:text-[20px] md:text-[18px]">
              As a certified Kinaxis and SAP partner with offices in United
              States, Canada, India, and Singapore, and a team of highly
              certified Kinaxis experts, Rialtes helps clients leverage
              RapidResponse to unlock connected, intelligent, and resilient
              supply chains — ready for tomorrow’s challenges.
            </p>
          </div>
      ...
      <section className="relative 4xl:h-[700px] 2xl:h-[660px] xl:h-[650px] group overflow-hidden">
        ...
        {/* Content Block */}
        <div
          className={`custom-container z-10 relative xl:absolute 4xl:top-[45%] 2xl:top-[43%] xl:top-[43%] top-[-100px]  xl:-translate-y-1/2`}
        >
          <div className="bg-[#016FBE] bg-opacity-90 text-white p-[20px] md:p-8 xl:w-[720px] xl:pb-20 4xl:pb-20 pb-32">
            ...
            <h3 className="4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px] max-[350px]:text-[20px] leading-[60px]">
              Rialtes DemandPlus
            </h3>
            <h3 className="4xl:text-[36px] xl:text-[25px] text-[22px] mt-5">
              End-to-End Kinaxis Services
            </h3>
            <p className="mt-8 text-[16px] 4xl:text-[20px] md:text-[18px] leading-tight font-normal">
              Our DemandPlus suite offers a holistic approach to deploying
              Kinaxis RapidResponse, combining:
            </p>
            <UnorderedList
              arrName={endToEndData}
              ulClassName="list-disc leading-tight xl:space-y-3 font-light marker:font-bold marker:text-2xl pl-5 mt-5  xl:pr-0"
      ...
      <div className="grid xl:grid-cols-12 grid-cols-1 4xl:mt-[-67px] 2xl:mt-[-77px] xl:mt-[-67px] sticky mt-[-7rem] md:mt-[-7rem] mx-[35px] xl:mx-0 z-[20]">
        ...
        <div className="col-span-7 bg-[#163055] p-8">
          <p className="4xl:text-[26px] text-[18px] text-white leading-tight font-normal xl:pr-10">
            From strategy to execution, Rialtes enables a seamless and
            accelerated journey to Kinaxis-driven supply chain transformation.
          </p>
        </div>
      ...
      <section className="relative group overflow-hidden xl:mt-16 xl:mr-[142px]">
        <div className="w-full xl:h-[1046px] ">
          ...
          <div className="absolute  text-white grid lg:grid-cols-12 grid-cols-12 xl:top-[25rem] max-[390px]:top-[210px] top-[280px] md:top-[400px] ">
            <div className="lg:col-span-6 col-span-10 bg-[#0B3A66] pl-[35px] xl:py-16 py-8 xl:pr-20   xl:mr-0 custom-container">
              <h2 className="lg-4 leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
                Why Kinaxis RapidResponse?
              </h2>
              <p className="font-light xl:pr-0 xl:mt-10 mt-5 text-[16px] 4xl:text-[20px] md:text-[18px]">
                Kinaxis RapidResponse is a cloud-based supply chain planning
        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 relative xl:-mt-10 mt-[-30px] md:mt-[-60px]  xl:mr-[50px] custom-container xl:!pr-16">
          {[
            ...
            >
              <p className="font-semibold 4xl:text-[24px] text-[20px] 2xl:text-[20px] xl:text-[18px]">
                {item}
              </p>
            </div>
          ))}
      ...
      <section className="mt-20 custom-container xl:!pr-0 max-md:px-0">
        <div className="grid xl:grid-cols-12">
          <div className="col-span-6">
            <h2 className="leading-tight pr-16 4xl:text-[60px] xl:text-[40px] text-[26px] md:text-[32px] max-md:px-[35px]">
              Supply Chain Planning Reimagined with Rialtes and Kinaxis
            </h2>
          </div>
        </div>
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="col-span-7 bg-[#006FBE] 4xl:mt-[-2rem] xl:mt-[-1rem] mt-[-4rem] text-white 4xl:ml-[-90px] xl:ml-[-108px] 4xl:mb-[75px] xl:pl-[10rem] px-[35px] pb-16  xl:pb-20">
            <h3 className="4xl:pt-20 xl:pt-10 pt-24 text-[22px] 4xl:text-[30px] 4xl:pr-[20rem] xl:pr-[14rem]">
              End-to-End Supply Chain Planning Capabilities:
            </h3>
            <UnorderedList
              arrName={supplyChain}
              ulClassName="list-disc leading-tight 4xl:space-y-5 xl:space-y-2 font-light marker:font-bold marker:text-2xl pl-5 mt-8 xl:pr-0"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
      ...
      <section className="mt-24 custom-container xl:!pr-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-20">
          ...
          <div className="xl:col-span-5 order-2 xl:order-1">
            <h2 className="leading-tight mt-10 xl:mt-0  xl:pr-0 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Sales & Operations Planning (S&OP)
            </h2>
            <h3 className="4xl:text-[42px] xl:text-[32px] text-[22px] xl:mt-10 mt-5 leading-tight font-semibold">
              Drive Cross-Functional Alignment
            </h3>
            <p className="mt-5 font-normal 4xl:text-[20px] text-[16px] xl:text-[18px]">
              Rialtes leverages Kinaxis to deliver best-in-class S&OP
              capabilities, enabling companies to:
            </p>
            <UnorderedList
              arrName={salesData}
              ulClassName="list-disc leading-tight xl:space-y-2 font-normal marker:font-bold marker:text-2xl pl-5 4xl:mt-8 2xl:mt-8 xl:mt-4 mt-5"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
          </div>
        </div>
      </section>
      <p className="bg-[#163055] p-8  xl:!mx-[280px]  z-[15] max-md:mx-[35px]  text-white 4xl:mt-[-50px] 2xl:mt[-70px] xl:mt-[-20px] mt-10 relative 4xl:text-[26px] 2xl:text-[22px] xl:text-[18px] text-[18px] font-normal">
        Outcome: Greater forecast accuracy, lower inventory, and improved
        service levels.
      </p>
      <section className="relative w-full 4xl:mt-[-53px] 2xl:mt-[-80px] xl:mt-[-98px] mt-16">
        <div className="w-full xl:h-[1083px]">
          ...
          <div className="absolute text-white grid xl:grid-cols-12 grid-cols-1  top-[23rem] md:top-[46rem] max-[390px]:mt-[-100px] max-[320px]:mt-[-200px] md:mt-[300px] 4xl:top-[13rem] 2xl:top-[16rem] xl:top-[18rem]">
            <div className="xl:col-span-7  custom-container xl:!pr-0 pl-[35px] xl:py-16 py-8">
              <h2 className="mb-4 leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
                Inventory Optimization & Enterprise Scheduling
              </h2>
              <h3 className="4xl:text-[42px] xl:text-[32px] text-[22px] mt-5">
                Maximize Efficiency
              </h3>
              <p className="font-light xl:pr-24 md:pr-16  mt-5 leading-tight text-[16px] 4xl:text-[20px] md:text-[18px]">
                With Kinaxis, Rialtes helps clients achieve precision inventory
      ...
      <div className="grid xl:grid-cols-12 grid-cols-1 absolute xl:mt-[-100px] mt-[-75px] md:mt-0 custom-container">
        <div className="xl:col-span-5 col-span-12 bg-[#163055] px-10 py-12 text-white">
          ...
          <UnorderedList
            arrName={inventeryOptimizationData}
            ulClassName="list-disc leading-tight xl:space-y-5 font-normal marker:font-bold marker:text-2xl pl-5 xl:mt-8 mt-5"
            liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
          />
        </div>
        ...
        <div className="xl:col-span-5 col-span-12 bg-[#163055] px-10 py-12 text-white">
          ...
          <UnorderedList
            arrName={enterpriseSchedulingData}
            ulClassName="list-disc leading-tight xl:space-y-5 font-normal marker:font-bold marker:text-2xl pl-5 xl:mt-8 mt-5"
            liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
          />
        </div>
      ...
      <section className="relative h-auto 4xl:mt-[17rem] 2xl:mt-[16rem] xl:mt-[16rem] custom-container max-[360px]:mt-[45rem] max-[390px]:mt-[36rem] max-[400px]:mt-[38rem] mt-[34rem] xl:!pr-0 max-md:px-0 md:mt-[32rem] max-[320px]:mt-[53rem]">
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:absolute max-md:px-[35px] top-0 xl:pl-20 4xl:pt-20  xl:pt-10">
          <div className="xl:col-span-5 col-span-12">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] mt-6 xl:mt-0 text-[26px]">
              Scenario Planning
            </h2>
            <h3 className="4xl:text-[42px] xl:text-[30px] text-[22px] mt-5 font-semibold leading-tight">
              Prepare for Every Possibility
            </h3>
            <p className="xl:mt-8 mt-5 font-medium leading-tight text-[16px] 4xl:text-[20px] md:text-[18px]">
              What-if analysis and scenario simulation are at the heart of
              Kinaxis RapidResponse, and Rialtes brings the expertise to fully
              leverage them:
            </p>
            <UnorderedList
              arrName={scenarioData}
              ulClassName="list-disc xl:space-y-3 font-medium marker:font-bold marker:text-2xl pl-5  mt-8 leading-tight"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
      ...
      <section className="mt-[10rem] xl:mt-0">
        <div className="grid xl:grid-cols-12 grid-cols-1 mx-[35px] xl:mx-0">
          ...
          <div className="col-span-6 xl:bg-[#EAEAEA] xl:p-20 pt-8 xl:pr-[120px]">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Seamless Integration with SAP, Oracle, and Non-SAP Systems
            </h2>
            <h3 className="mt-10 4xl:text-[42px] xl:text-[32px] text-[22px] font-semibold leading-tight">
              Integrate Kinaxis with Your Existing ERP Ecosystem
            </h3>
            <p className="mt-5 xl:pr-20 pr-10 font-normal leading-tight text-[16px] 4xl:text-[20px] md:text-[18px]">
              Rialtes delivers robust integration services using SAP Cloud
              Platform Integration (SAP CPI) and Kinaxis-certified connectors:
            </p>
            <UnorderedList
              arrName={seamlessIntegrationData}
              ulClassName="list-disc leading-normal xl:space-y-3 font-normal marker:font-bold marker:text-2xl pl-5 mt-5  xl:pr-16"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
          </div>
        </div>
      ...
      <div className="grid xl:grid-cols-12 grid-cols-1 4xl:mt-[-110px] 2xl:mt-[-90px] xl:mt-[-60px] mt-10 mx-[35px] xl:mx-0">
        ...
        <div className="col-span-5">
          <p className="4xl:text-[26px] text-[18px] bg-[#163055] p-8 text-white font-normal 4xl:pr-32 xl:pl-20 leading-tight">
            Our pre-built accelerators and custom APIs ensure real-time data
            flow for synchronized planning.
          </p>
        </div>
        <div className="col-span-1"></div>
      </div>
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="xl:order-1 order-2 col-span-6">
            <div className="bg-[#006FBE] xl:p-20 p-10 text-white xl:pb-32 pb-[20rem]">
              <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
                Rialtes’ Strong SAP BTP Competency
              </h2>
              <h3 className="4xl:text-[42px] xl:text-[30px] text-[22px] mt-5 leading-tight">
                Extending S/4 HANA Value
              </h3>
              <p className="mt-5 font-light leading-tight text-[16px] 4xl:text-[20px] md:text-[18px]">
                Rialtes brings deep expertise in SAP Business Technology
                Platform (BTP) to extend, customize, and enhance S/4 HANA
                integration with Kinaxis:
              </p>
              <UnorderedList
                arrName={rialtesStrongData}
                ulClassName="list-disc leading-normal xl:space-y-4 font-light marker:font-bold marker:text-2xl pl-5 mt-8 xl:pr-16"
                liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
              />
              <div className="mt-5 absolute">
                <LearnMore
            ...
            <p className="4xl:text-[26px] text-[18px] bg-[#163055] xl:p-8 p-6 xl:pl-14 pl-10 4xl:pr-32 text-white font-light mx-[35px] xl:mx-0 mt-[-172px] xl:mt-0 leading-tight">
              Our certified BTP consultants ensure secure, scalable, and
              future-proof solutions for every client.
            </p>
          </div>
        </div>
      </section>
      <section className="relative">
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1 custom-container mx-[35px] xl:mx-0 absolute top-0">
          <div className="col-span-7 pt-20">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Bringing Together Kinaxis and the Broader Enterprise Ecosystem
            </h2>
            <h3 className="4xl:text-[42px] xl:text-[32px] text-[22px] mt-10 font-bold leading-tight pr-20">
              Related SAP and Procurement Solutions with Rialtes:
            </h3>
          </div>
        </div>
        <div className="custom-container mx-[35px] xl:mx-0 xl:mr-[464px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5 absolute bottom-[-3rem] z-[9]">
          {services.map((service, index) => (
            ...
            >
              <h3 className="mb-8 text-[#0A6BB8] font-semibold leading-tight 4xl:text-[30px] 2xl:text-[26px] xl:text-[22px] ">
                {service.title}
              </h3>
              <p className="text-[#000000] leading-tight 4xl:text-[24px] 2xl:text-[22px] xl:text-[20px] text-[16px]">
                {service.description}
              </p>
              <div className="xl:bottom-[30px] xl:absolute">
                <Link
                  href={service.knowMore}
                  className={`inline-block  text-[16px] 4xl:text-[20px] md:text-[18px] hover:bg-[#134874] bg-[#134874] border-[1px] border-[solid] font-semibold text-white py-3 px-8 transition duration-300 mt-6`}
                >
                  Know More
                </Link>
              </div>
      ...
      <section className="relative xl:h-[700px]">
        ...
        {/* Text Block */}
        <div
          className={`custom-container text-white xl:absolute xl:top-[20%] relative xl:w-[62%] w-full z-10 max-md:px-0`}
        >
          <div className="bg-[#073259] xl:p-16 p-10">
            <h2 className="leading-tight pr-20 xl:pr-0 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              SAP ARIBA & Procurement
            </h2>
            <h3 className="xl:text-[42px] text-[22px] font-semibold leading-tight mt-5  xl:pr-0">
              Direct/indirect procurement visibility connected to supply chain
              plans.
            </h3>
            <h3 className="mt-5 leading-tight">
              SAP CPI — Connect S/4 HANA with Non-SAP Systems
            </h3>
            <p className="mt-5 mb-5 font-normal leading-tight text-[16px] 4xl:text-[20px] md:text-[18px]">
              Rialtes leverages SAP CPI to connect S/4 HANA, Kinaxis, and other
              enterprise systems for a fully synchronized supply chain.
            </p>
      ...
      <div className="bg-[#555555] mt-0">
        ...
        <div className="custom-container mx-[35px] grid xl:grid-cols-12 grid-cols-1 text-white mt-16 xl:gap-20">
          <div className="col-span-6">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Enhance Supply Chain Conversations with AgentChat
            </h2>
            <h3 className="mt-10 xl:text-[42px] text-[22px] leading-tight font-bold">
              WhatsApp for Supply Chain Teams
            </h3>
          </div>
          <div className="col-span-6">
            <h3 className="mt-8 xl:mt-0  xl:pr-0 4xl:text-[30px] xl:text-[25px] text-[20px] leading-tight">
              Introducing AgentChat Your Conversational AI for Supply Chain
            </h3>
            <p className="mt-5 font-normal text-[16px] 4xl:text-[20px] md:text-[18px]">
              AgentChat is a bi-directional WhatsApp conversational app,
              enabling instant collaboration across supply chain teams.
            </p>
            <h3 className="xl:text-[24px] text-[18px] mt-10">
              AgentChat Highlights:
            </h3>
            <UnorderedList
              arrName={agentChatData}
              ulClassName="list-disc leading-tight xl:space-y-4 mb-10 font-light marker:font-bold marker:text-2xl pl-5 mt-5  xl:pr-0"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
        ...
        <div className="custom-container mx-[35px] xl:mx-0 grid xl:grid-cols-12 grid-cols-1 mt-16">
          <div className="col-span-9 bg-[#068EDA] p-8 pl-12 text-white">
            <p className="4xl:text-[26px] 2xl:text-[24px] xl:text-[24px] text-[18px] font-normal xl:pr-32 4xl:pr-16 leading-tight">
              Now, connect your supply chain teams, suppliers, and partners with
              a familiar and powerful interface — WhatsApp + ERP + CRM.
            </p>
          </div>
        </div>
      </div>
      <section className="custom-container relative xl:!pr-0 max-md:px-0">
        ...
        <div className="grid xl:grid-cols-12  grid-cols-1 absolute 4xl:top-40 2xl:top-40 xl:top-10 top-[20rem] text-white">
          <div className="col-span-6 xl:px-16  px-10">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px]">
              Leading the Future with AI, Data, and Integrated Planning
            </h2>
            <p className="mt-8 font-light text-[16px] 4xl:text-[20px] md:text-[18px]">
              At Rialtes, we go beyond standard implementations — combining AI,
              data science, and advanced planning tools to create responsive and
              resilient supply chains.
            </p>
            <UnorderedList
              arrName={leadingData}
              ulClassName="list-disc leading-tight xl:space-y-4 font-light marker:font-bold marker:text-2xl pl-5 mt-5  xl:pr-0"
              liClassName="text-[16px] 4xl:text-[20px] md:text-[18px]"
            />
      ...
      {/* contact form */}
      <div
        className="mt-20 custom-container text-black pb-20 scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Start Your Kinaxis Journey with Rialtes DemandPlus Today"}
          subtitle={
            "Ready to transform your supply chain planning and resilience with Kinaxis RapidResponse? Let Rialtes DemandPlus guide you through every step — from strategy to execution."
          }
          className={
            "4xl:max-w-[60rem] xl:max-w-[40rem] leading-tight font-light 4xl:text-[60px] xl:text-[40px] md:text-[32px] text-[26px] xl:pr-0"
          }
        />
      </div>
    </div>
