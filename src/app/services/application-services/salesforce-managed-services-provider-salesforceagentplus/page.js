...
export default function page() {
  const schemaData = {
    ...
    description:
      "Rialtes' SalesforceAgent+ is a next-gen Salesforce managed services offering that delivers 24x7 support, AI-powered innovations, seamless MuleSoft integrations, and specialized industry cloud expertise. Empower your Salesforce with Agentforce, Einstein GPT, and zero-copy SAP data cloud integration.",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Conversational AI, Einstein GPT, and Agentforce for sales, service, and field operations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Custom LWC and responsive UX for modern Salesforce experiences.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Secure, API-led integrations with SAP, Oracle, NetSuite, Workday, and more.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Secure, compliant transitions from legacy CRMs to Salesforce.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Healthcare, Manufacturing, Education, Automotive, and more — with compliance-ready workflows.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Unified customer profiles, zero-copy data, and predictive analytics.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Free WhatsApp messaging, AI bots, and notifications — embedded inside Salesforce.",
          },
        },
      ],
    },
    ...
    <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 w-full">
            <div className="col-span-12 text-[#ffffff]">
              ...
              <h1 className="text-[26px] leading-tight xl:text-[40px] 4xl:text-[60px] mt-[11.5px] md:mt-[28.5px]">
                Unleash the Power <br /> of Salesforce with <br />{" "}
                SalesforceAgent+
              </h1>
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] xl:mt-[125px] mt-[42px]">
          ...
          <div className="lg:col-span-6 xl:col-span-5 col-span-12">
            <p className="xl:text-19px] 4xl:text-[22px] text-[16px] leading-tight mt-[23px] lg:mt-[10px]">
              At Rialtes, we go beyond traditional Salesforce support.
              SalesforceAgent+ is our next-gen Managed Services offering,
              designed to keep your Salesforce platform future-ready,
              AI-enabled, and continuously optimized — with 24x7 global support,
              AI-driven solutions like Agentforce, and seamless integration
            ...
            <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] 2xl:gap-[80px] bg-[#006FBE] xl:pt-[64px] pt-[26px] xl:pl-[61px] 2xl:pl-[81px] xl:pr-[81px] px-[26px] pl-[36px] pr-[46px] max-[360px]:px-[26px] md:px-[36px] text-[#ffffff]">
                ...
                <div className="h-full flex flex-col">
                  <div className="xl:mb-[61px]">
                    ...
                    <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[28px] mt-[23px] font-light">
                      Agentforce is revolutionizing customer and agent
                      interactions — and Rialtes makes adoption easy and
                      impactful:
                    </p>
                  </div>
              ...
              <div className="lg:col-span-6 xl:col-span-6 col-span-12">
                ...
                <p className="xl:text-[20px] 4xl:text-[24px] text-[17px] leading-tight xl:mt-[36px] mt-[38px] font-light lg:mb-[56px]">
                  Accelerate your AI strategy with Rialtes — seamlessly,
                  securely, and fast.
                </p>
      ...
      <section className="custom-container lg:mt-[98px] mt-[48px]">
        ...
        <h3 className="xl:text-[36px] 4xl:text-[30px] text-[22px] leading-tight font-semibold xl:mt-[34px] mt-[15px] max-[345px]:w-full max-sm:w-[90%]">
          Powering Continuous Salesforce Innovation. <br /> Always-On Support.
          AI-Driven Innovation. <br /> Industry-Specific Solutions.
        </h3>
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[40px] xl:gap-y-[89px] lg:gap-y-[59px] gap-y-[68px] xl:mt-[106px] mt-[59px] 2xl:w-[80%] xl:w-[90%] md:w-[86%] sm:w-[70%]">
          {salesforceagentData.map((data, ind) => {
            return (
              <div
                key={ind}
                className="border border-[#707070] xl:px-[40px] xl:pb-[46px] xl:pt-[90px] px-[21px] pb-[34px] pt-[55px]"
              >
                <h4
                  className={`w-fit max-xl:pr-[20px] pl-[10px] xl:text-[26px] 4xl:text-[30px] text-[20px] leading-tight text-[#006FBE] font-semibold bg-[#ffffff] ${ind == 1 || (ind == 2 && "xl:w-[88%]")} ${ind == 4 ? "xl:mt-[-110px]" : "xl:mt-[-124px]"} md:mt-[-73px] mt-[-70px]`}
                >
                  {data.title}
                </h4>
                <UnorderedList
                  arrName={data.list}
                  ulClassName="list-disc xl:space-y-[27px] space-y-[19px] xl:mt-[54px] mt-[30px] xl:ml-[26px] ml-[20px]"
                  liClassName="xl:text-[21px] 4xl:text-[22px] text-[16px] leading-tight"
                />
              </div>
            );
          })}
      ...
      <section className="custom-container xl:mt-[71px] mt-[72px]">
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[40px] gap-y-[36px] lg:gap-[60px] 2xl:gap-[80px]">
          ...
          <div className="my-auto">
            ...
            <UnorderedList
              arrName={unlockData}
              ulClassName="list-disc xl:mt-[35px] mt-[29px] lg:ml-[26px] ml-[20px]"
              liClassName="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[23px]"
            />
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 gap-y-[21px] lg:gap-[60px] 2xl:gap-[80px] lg:bg-[#006FBE] bg-[#068EDA] xl:pb-[106px] pb-[77px] xl:pt-[64px] pt-[26px] xl:pl-[61px] 2xl:pl-[81px] xl:pr-[81px] px-[36px] md:px-[36px] text-[#ffffff]">
              ...
              <div className="h-full flex flex-col">
                <div>
                  <h2 className="4xl:text-[58px] xl:text-[40px] text-[26px] leading-tight font-light w-[80%] lg:w-[70%] xl:w-full 3xl:w-[80%] 4xl:w-full">
                    AgentChat – FREE WhatsApp Service Included with
                    SalesforceAgent+!
                  </h2>
            ...
            <div className="lg:col-span-6 xl:col-span-6 col-span-12">
              <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight font-light w-[90%] md:w-[70%] lg:w-full">
                With every SalesforceAgent+ subscription, you get AgentChat —
                our enterprise-grade WhatsApp integration for Salesforce — FREE.
              </p>
              <UnorderedList
                arrName={rialChatData}
                ulClassName="list-disc xl:space-y-[27px] space-y-[19px] xl:mt-[36px] mt-[25px] xl:ml-[26px] ml-[20px] w-[90%] lg:w-[90%] xl:w-full 3xl:w-[80%]"
                liClassName="xl:text-[19px] 4xl:text-[22x] text-[16px] leading-tight lg:mt-0 mt-[23px]"
              />
            </div>
          </div>
      ...
      <section className="custom-container xl:mt-[117px] mt-[58px]">
        ...
        <UnorderedList
          arrName={ourGlobalData}
          ulClassName="list-disc xl:space-y-[27px] space-y-[19px] xl:mt-[58px] mt-[25px] xl:ml-[26px] ml-[20px] md:w-[65%] lg:w-[55%] 2xl:w-[50%]"
          liClassName="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight"
        />
      </section>
      ...
      <section className="custom-container xl:mt-[129px] mt-[72px]">
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[40px] gap-y-[36px] lg:gap-[60px] xl:gap-[40px] 2xl:gap-[60px]">
          ...
          <div className="my-auto">
            ...
            <UnorderedList
              arrName={rialtesSalesforceData}
              ulClassName="list-disc xl:mt-[52px] mt-[31px] lg:ml-[26px] ml-[20px]"
              liClassName="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[23px]"
            />
      ...
      <section>
        <div className="xl:mt-[155px] mt-[110px]  xl:pt-[84px] pt-[52px] xl:pb-[103px] pb-[142px] text-[#ffffff] relative overflow-hidden">
          <Image
            src="/images/services/salesforce-agentforce/Mobile/our-salesforce-mob-bg.webp"
            alt="Salesforce Industry Cloud Mobile Background"
            fill
            priority
          ...
          {/* Desktop Background */}
          <Image
            src="/images/services/salesforce-agentforce/our-salesforce-desk-bg.webp"
            alt="Salesforce Industry Cloud Desktop Background"
            fill
            priority
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-[20px] gap-y-[21px] lg:mt-[65px] mt-[38px] xl:w-[96%] 4xl:w-[95%] md:w-[94%] sm:w-[70%]">
              {ourSalesforceData.map((data, ind) => {
                return (
                  <div
                    key={ind}
                    className="2xl:pt-[39px] 2xl:px-[49px] 2xl:pb-[49px] pt-[33px] px-[22px] pb-[38px] bg-[#ffffff]"
                  >
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 gap-y-[21px] lg:gap-[20px] xl:mt-[-50px] lg:mt-[-40px] mt-[-40px]">
            <div className="lg:col-span-9 col-span-12">
              <div className="xl:py-[28px] xl:px-[31px] py-[22px] px-[25px] bg-[#006FBE] text-[#ffffff] sm:w-fit">
                <p className="xl:text-[21px] 4xl:text-[24px] text-[18px] leading-tight font-normal">
                  Whatever your industry, Rialtes helps Salesforce work smarter
                  for you.
                </p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-y-[36px] md:gap-[20px]">
          <div className="my-auto md:order-1 order-2">
            ...
            <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[37px] mt-[23px] font-normal xl:w-[80%]">
              Whether migrating from legacy CRMs, Zoho, HubSpot, Dynamics, or
              custom systems, Rialtes ensures:
            </p>
            <UnorderedList
              arrName={migrateData}
              ulClassName="list-disc xl:mt-[52px] mt-[31px] md:ml-[26px] ml-[20px] xl:w-[80%]"
              liClassName="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight xl:mt-[34px] mt-[23px]"
            />
          ...
          <div className="md:col-span-5 xl:col-span-5">
            <div className="bg-[#67C774] xl:pt-[47px] xl:px-[60px] 2xl:px-[80px] xl:pb-[92px] pt-[41px] px-[26px] pb-[79px] md:mt-[20%] max-md:mx-[36px]">
              <h2 className="4xl:text-[60px] xl:text-[39px] text-[26px] leading-tight font-light sm:w-[80%] md:w-full lg:w-[70%] xl:w-full">
                Certified Salesforce Architects & AI Strategists for Every
                Project
              </h2>
              <UnorderedList
                arrName={certifiedData}
                ulClassName="list-disc xl:mt-[44px] mt-[28px] md:ml-[26px] ml-[20px]"
      ...
      <div className="custom-container xl:mt-[117px] xl:mb-[104px] mt-[104px] mb-[45px]">
        <ContactForm
          ...
          subtitle1="Contact Rialtes to discover how SalesforceAgent+ can supercharge your Salesforce ecosystem."
          className="4xl:text-[60px] xl:text-[40px] text-[26px]"
        />
      </div>
    </section>
  );
