       ...
       "
                ...
                >
                    <div className="relative p-6 xl:w-[828px] xl:pb-32 pb-20  mt-[26rem] xl:mt-0">
                        ...
                        <div className="relative  bg-opacity-80 text-white z-10 p-3 xl:pl-8 rounded-lg">
                            ...
                            <ul className="list-disc xl:space-y-5 space-y-2 marker:font-bold marker:text-2xl pl-5 xl:text-[20px] text-[16px] xl:mt-10 mt-3">
                    ...
                    <div className="grid xl:grid-cols-4 grid-cols-2 xl:gap-20 gap-16 mt-16">
                        <div>
                            <Image
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold pr-10 leading-tight">Fashion & Apparel</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold leading-tight">Consumer Electronics</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold pr-10 leading-tight">Home & Furniture</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold xl:pr-20 leading-tight">Luxury Goods & Lifestyle</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold pr-10 leading-tight">Food & Beverage</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold pr-10 leading-tight">Health & Wellness</h3>
                        </div>
                        <div>
                            <Image
                                className="xl:w-[138px] xl:h-[138px] w-[75px] h-[75px]"
                                ...
                                priority
                            />
                            <h3 className="mt-5 font-semibold xl:pr-20 leading-tight">Travel Retail and Duty-Free</h3>
                        </div>
                    </div>
            ...
            <section className="xl:ml-[280px] grid xl:grid-cols-12 grid-cols-1 xl:mt-32 mt-48">
                ...
                <div className="xl:col-span-5 bg-[#006FBE] xl:pt-20 pt-10 px-10 text-white order-2 xl:order-1 pb-20">
                    ...
                    <p className="mt-5">Leverage Salesforce’s Retail Cloud capabilities — including unified customer profiles, AI-based personalization, loyalty management, omnichannel service, and marketing automation — to deliver consistent and personalized experiences across all customer touchpoints.</p>
                    <h3 className="mt-5">SAP S/4HANA for Retail</h3>
                    <p className="mt-5">Transform back-end operations with SAP S/4HANA Retail, enabling intelligent inventory management, demand forecasting, supply chain optimization, and real-time analytics to drive profitability and responsiveness.</p>
                </div>
            </section>
            ...
            <section className="xl:ml-[280px] mx-[35px] xl:mx-0 xl:mr-[418px] bg-[#6E6E6E] pb-20 p-8 xl:p-0 text-white mt-[-100px] absolute xl:mt-0 xl:relative">
                <div className="grid xl:grid-cols-12 grid-cols-1">
            ...
            <section className="xl:mt-16 mt-[28rem]">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    ...
                    <div className="bg-[#073259] text-white xl:col-span-6 px-16 xl:px-0 col-span-12 xl:ml-[-150px] xl:pl-[260px] xl:pr-[275px] xl;pb-32 pb-[6rem]">
                        ...
                        <p className="mt-5">Harness Salesforce Data Cloud to unify customer, sales, and supply chain data — driving real-time insights, segmentation, and personalized offers. Agentforce, Salesforce’s AI-powered service automation solution, enables proactive customer service, intelligent case routing, and personalized recommendations across channels.</p>
                        <hr className="mt-10"></hr>
                        <h3 className="xl:text-[42px] text-[22px] font-semibold mt-10 leading-tight">AI-Driven Consumer Case Management</h3>
                        <p className="mt-5">By integrating Salesforce Agentforce and Data Cloud, Rialtes helps retail enterprises transform case management and customer support, leveraging AI-driven chatbots, predictive analytics, and automated workflows to elevate customer service efficiency and satisfaction.</p>
                        <Link
                            href="/contact-us"
            ...
            <section className="xl:ml-[280px] xl:mr-[418px] mt-20 mx-[35px] xl:mx-0">
                ...
                <div className="grid xl:grid-cols-3 grid-cols-1 xl:gap-5 gap-16 mt-5">
                    <div className="border p-10">
                        ...
                        <p className="xl:text-[24px] text-[16px] mt-5 xl:pr-16">Empower customer service teams with omnichannel case management.</p>
                        <div className="absolute xl:mt-[125px]">
                            <LearnMore />
                        </div>
                    </div>
                    <div className="border p-10">
                        <h3 className="text-[#0A6BB8] xl:pr-20 font-semibold">Salesforce Experience (Community) Cloud</h3>
                        <p className="xl:text-[24px] text-[16px] mt-5 xl:pr-16">Build branded customer, partner, and employee portals for seamless communication.</p>
                    ...
                    <div className="border p-10">
                        ...
                        <p className="xl:text-[24px] text-[16px] mt-5 xl:pr-16">AI-based automation, customer insights, and intelligent engagement.</p>
            ...
            <section className="xl:mt-32 mt-20 xl:ml-[280px]">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    <div className="col-span-4">
                        <Image
                            className="xl:w-full w-[350px] mt-16 xl:mb-32 relative xl:h-[670px] mx-[35px] xl:mx-0"
                            src='/images/industry/retail/realchat-desk.webp'
                            alt="Taking the lead"
                            width={0}
                            height={0}
                            sizes="100vw"
                    ...
                    <div className="col-span-8 bg-[#646464] text-white xl:ml-[-25rem] pb-40 xl:pb-0 px-[35px] xl:pl-[30rem] xl:pr-[24rem] xl:mt-0 mt-[-300px]">
            ...
            <div className="xl:col-span-9 mx-[35px] z-[9] xl:mx-0 col-span-12 relative bg-[#163055] p-8 xl:mt-[-128px] mt-[-100px] xl:mr-[280px] xl:ml-[418px]">
            ...
            <section className="relative h-[1026px] xl:h-[870px] overflow-hidden mt-[-135px] xl:mt-0 ">
                ...
                <div
                    className="
                        ...
                        md:ml-[100px]"
                >
                    <div className="flex justify-end xl:mt-32 mt-[26rem]">
