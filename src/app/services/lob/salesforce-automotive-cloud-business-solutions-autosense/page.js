    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Future-ready digital strategy, EV compliance, and CX innovation powered by SAP Signavio and Salesforce advisory.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Deployment of Salesforce Automotive Cloud, SAP VMS, and connected car ecosystems with AI and IoT integration.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "End-to-end ERP, CRM, and IoT platform integration, AI-driven testing, and cybersecurity compliance.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "24/7 managed services, AI CoE, and connected data monetization strategies for long-term growth.",
        },
      },
    ],
  },
  category:
    "Automotive Consulting, Digital Transformation, Salesforce Automotive Cloud, SAP S/4HANA for Automotive",
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id":
      "https://www.rialtes.com/services/lob/salesforce-automotive-cloud-business-solutions-autosense/",
  },
};
const KeyPillarsSectionDesign = ({ onTalkClick }) => {
  const keyPillarsSectionData = [
    {
      ...
      mobileImageUrl:
        "/images/industry/auto-sense/Mobile/strategic-advisory-mob-img.webp",
    ...
    {
      imageUrl:
        "/images/industry/auto-sense/design-and-implementation-img.webp",
      imageAlt: "design and implementation image",
      mobileImageUrl:
        "/images/industry/auto-sense/Mobile/design-and-implementation-mob-img.webp",
    ...
    {
      imageUrl:
        "/images/industry/auto-sense/integration-quality-assurance-img.webp",
      imageAlt: "integration quality assurance image",
      mobileImageUrl:
        "/images/industry/auto-sense/Mobile/integration-quality-assurance-mob-img.webp",
    ...
    },
    {
      ...
      mobileImageUrl:
        "/images/industry/auto-sense/Mobile/post-go-live-mob-img.webp",
                ...
                {ind % 2 === 0 ? (
                  <>
                    ...
                    >
                      ...
                      <UnorderedList
                        arrName={data.listItems}
                        ulClassName="list-disc text-[#FFFFFF] xl:mt-[24px] xl:px-[24px] pb-0 px-[22px] xl:pl-[52px] pl-[16px] xl:w-[80%] pr-0"
                        liClassName="xl:mt[24px] mt-[19px] text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
                      />
                  ...
                  <>
                    ...
                    >
                      ...
                      <UnorderedList
                        arrName={data.listItems}
                        ulClassName="list-disc text-[#FFFFFF] xl:mt-[24px] xl:px-[24px] pb-0 px-[22px] xl:pl-[52px] pl-[16px] xl:w-[90%] pr-0"
                        liClassName="xl:mt[24px] mt-[19px] text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
                      />
                      <div className="xl:mt-[31px] xl:px-[30px]">
                        <LearnMore onClick={onTalkClick} btnName="Talk to Us" />
...
const ChooseRialtes = ({ onTalkClick }) => {
  ...
  return (
    <section className="custom-container xl:mt-[135px] mt-[74px]">
      <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] font-light">
        Why Choose Rialtes for{" "}
        <span className="block">Automotive Transformation?</span>
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:mt-[61px] mt-[37px]">
        {chooseRialtesData.map((item, ind) => {
          return (
            <div
              key={ind}
              className="xl:p-[47px] p-[42px] border-[1px] border-[#707070] hover:border-[#D9F2FF] hover:bg-[#D9F2FF] transition-colors duration-300"
            >
              <Image
                src={item.imageUrl}
                alt={`image-${ind}`}
                ...
                priority
              />
              <h3 className="xl:mt-[46px] mt-[33px] 4xl:text-[30px] xl:text-[23px] text-[20px] font-semibold leading-tight">
                {item.title}
              </h3>
              <div>
                {item.listItems.map((listItem, index) => (
                  <p
                    key={index}
                    className="xl:mt-[33px] mt-[26px] text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight font-normal "
                  >
                    {listItem}
                  </p>
                ))}
...
const RialtesMakesWork = ({ onTalkClick }) => {
  const rialtesMakesWorkData = [
    {
      image: "/images/industry/auto-sense/backend-erp-img.webp",
      mobileImage:
        "/images/industry/auto-sense/Mobile/backend-erp-mob-img.webp",
      title:
        "Salesforce Automotive Cloud + Backend ERP Systems (SAP, Oracle, Others)",
      list: [
    ...
    },
    {
      ...
      title:
        "Salesforce Automotive Cloud + Front-End Data Visualization & AI Solutions",
      list: [
    ...
    },
    {
      ...
      mobileImage:
        "/images/industry/auto-sense/Mobile/end-to-end-process-mob-img.webp",
    ...
    <section className="custom-container xl:mt-[110px] mt-[70px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-[60px] lg:gap-[100px] xl:gap-[158px] xl:mt-[61px] mt-[29px]">
        ...
        {rialtesMakesWorkData[0] && (
          <div className="rialtesmakecard-1">
            <Image
              src={rialtesMakesWorkData[0].image}
              alt={rialtesMakesWorkData[0].title}
              width={1200}
              height={700}
              priority
            ...
            />
            <Image
              src={rialtesMakesWorkData[0].mobileImage}
              alt={rialtesMakesWorkData[0].title}
              width={1200}
              height={700}
              priority
            ...
            <UnorderedList
              arrName={rialtesMakesWorkData[0].list}
              ulClassName="list-disc pl-5 xl:mt-[33px] mt-[29px] w-[90%]"
              liClassName="xl:mt-[24px] mt-[19px] text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight"
            />
          </div>
        )}
        ...
        {rialtesMakesWorkData[1] && (
          <div className="rialtesmakecard-2 mt-[47px] md:mt-[160px] xl:mt-[230px]">
            <Image
              src={rialtesMakesWorkData[1].image}
              alt={rialtesMakesWorkData[1].title}
              width={1200}
              height={700}
              priority
              className="w-full hidden md:block"
            />
            <Image
              src={rialtesMakesWorkData[1].mobileImage}
              alt={rialtesMakesWorkData[1].title}
              width={1200}
              height={700}
              priority
            ...
            <UnorderedList
              arrName={rialtesMakesWorkData[1].list}
              ulClassName="list-disc pl-5 xl:text-[20px] text-[16px] xl:mt-[33px] mt-[29px]  w-[90%]"
              liClassName="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[24px] mt-[19px]"
            />
          </div>
        )}
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-[40px] md:mt-[-60px] xl:mt-[-40px] 3xl:mt-[-80px]">
        ...
        {rialtesMakesWorkData[2] && (
          <div className="rialtesmakecard-1">
            <Image
              src={rialtesMakesWorkData[2].image}
              alt={rialtesMakesWorkData[2].title}
              width={1200}
              height={700}
              priority
              className="w-full hidden md:block"
            />
            <Image
              src={rialtesMakesWorkData[2].mobileImage}
              alt={rialtesMakesWorkData[2].title}
              width={1200}
              height={700}
              priority
            ...
            <UnorderedList
              arrName={rialtesMakesWorkData[2].list}
              ulClassName="list-disc pl-5 xl:mt-[33px] mt-[29px] w-[90%]"
              liClassName="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight xl:mt-[24px] mt-[19px]"
            />
          </div>
...
const ThoughtLeadershipDesign = ({ onTalkClick }) => {
  const thoughtLeadershipData = [
    {
      title:
        "The Road to EV-First Business Models: What Automotive Leaders Need to Know",
      description:
        "Navigating battery lifecycles, new revenue streams, and digital sales transformation.",
    },
    {
      title:
        "AI-Powered Supply Chains: Solving Automotive Disruption with Intelligence",
      description:
        "How AI and SAP IBP are redefining proactive supply chain visibility.",
    },
    {
      title:
        "From Car Sales to Mobility Services: The Future of Customer Experience in Automotive",
      description:
        "Leveraging Salesforce Automotive Cloud for end-to-end CX management.",
    },
    {
      title:
        "Connected Cars, Data Goldmine: Monetization and AI-Driven Insights",
      description:
        "How to unlock the value of data streams from connected vehicles.",
    },
    {
      title:
        "Sustainability in the Fast Lane: Making Green Mobility Profitable",
      description:
        "Aligning profitability with ESG goals through AI and intelligent platforms.",
    },
  ];
  return (
    <section className="relative overflow-hidden xl:pt-[151px] xl:pb-[93px] py-[65px] xl:mt-[70px] mt-[57px] px-[30px] xl:px-2">
      <Image
      ...
      <div className="custom-container max-lg:px-0 relative z-10">
        <div>
          ...
          <p className="text-[#FFFFFF] font-semibold xl:mt[29px] mt-[26px]  xl:w-[71%] text-[20px] xl:text-[25px] 4xl:text-[30px] leading-tight">
            Here are 5 high impact thought leadership ideas Rialtes can drive to
...
export default function page() {
  ...
  return (
    <>
      ...
      {/* breadcrumbs schema*/}
      <BreadcrumbSchema
        currPage="Salesforce Automotive Cloud"
        subPath="Line of Business"
      />
      {/* hero section */}
      ...
      <section className="custom-container xl:mt-[105px] mt-[55px] xl:mb-[114px] mb-[42px]">
        <p className="text-[16px] xl:text-[18px] 4xl:text-[22px] leading-tight xl:w-[70%] w-[96%]">
          For over a decade, Rialtes has been a trusted partner for global
          automotive leaders, helping them navigate rapid industry
          transformation — from electrification and connected vehicles to
          customer experience innovation and supply chain resilience. Our
          specialized service suite, AutoSense, brings together deep automotive
          expertise, Salesforce Automotive Cloud proficiency, and powerful ERP
          integrations to drive real business outcomes.
        </p>
      </section>
      {/* introducing rialtes */}
      <section className="custom-container">
        <div className="flex flex-col lg:flex-row gap-5">
          <div className="flex flex-col w-full lg:max-w-xl lg:mb-0 mb-4">
            <p className="text-[#000000] text-[18px] xl:text-[22px] 4xl:text-[30px] leading-tight font-normal">
              Introducing
            </p>
            <p className="text-[#000000] leading-tight 4xl:text-[50px] xl:text-[40px] text-[24px]  font-medium ">
              Rialtes AutoSense
            </p>
            <div className="text-[#000000] text-[22px] xl:text-[32px] 2xl:text-[34px] 4xl:text-[36px]  leading-tight font-semibold xl:mt-[31px] mt-[12px] xl:w-full w-[96%]">
              End-to-End Automotive Solutions
            </div>
          </div>
          <div className="flex flex-col w-full">
            <p className="text-[#000000] text-[16px] xl:text-[18px] 4xl:text-[22px] leading-tight xl:w-[90%] w-[90%]">
              AutoSense is Rialtes comprehensive service suite designed
              specifically for the evolving needs of the automotive ecosystem —
              including OEMs, suppliers, dealers, and mobility providers.
              AutoSense combines advisory, implementation, quality assurance,
              and post-go-live support, fully integrated with OEM technology
              partners like SAP and Salesforce. 
            </p>
          </div>
        </div>
      </section>
      {/* key pillars of autosense */}
      <KeyPillarsSectionDesign onTalkClick={handleScrollToContact} />
      {/* how rialtes makes it workd section */}
      <RialtesMakesWork onTalkClick={handleScrollToContact} />
      {/* why choose rialtes section */}
      <ChooseRialtes onTalkClick={handleScrollToContact} />
              ...
              <div className="grid lg:grid-cols-2 grid-cols-1 xl:gap-[10px]">
                <div className="">
                  <h2 className="text-[#FFFFFF] leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] lg:w-[80%] xl:w-full 2xl:w-[90%] 4xl:w-[100%]">
                    Partner with Rialtes to Drive Intelligent Automotive
                    Transformation
                  </h2>
                </div>
                <div className="lg:mt-0 2xl:mt-[14px] mt-[27px] xl:ml-[61px] xl:w-[80%] lg:pl-[40px]">
                  <p className="text-[#FFFFFF] text-[16px] xl:text-[18px] 4xl:text-[24px] leading-tight font-normal lg:w-[80%] xl:w-full">
                    Whether you’re a global OEM, a growing EV brand, or a
                    leading dealership network, Rialtes helps you connect
                    technology with outcomes. From advisory and implementation
                    to ongoing innovation, we are your partner in building the
                    future of mobility.
                  </p>
                </div>
              </div>
      ...
      <ThoughtLeadershipDesign onTalkClick={handleScrollToContact} />
      {/* Contact Form */}
      <div
        className="custom-container text-black xl:pb-20 pb-10 pt-[115px] xl:pt-[138px] scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Accelerate Your Automotive Transformation with Rialtes"}
          className={
