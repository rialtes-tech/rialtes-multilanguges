...
const schemaData = {
  ...
  description:
    "Rialtes LifeAI+ is an end-to-end Salesforce Life Sciences Cloud consulting service empowering life sciences organizations with AI-driven compliance, automation, and patient engagement solutions.",
  inLanguage: "en",
  publisher: {
    "@type": "Organization",
    name: "Rialtes",
  ...
  mainEntity: {
    ...
    audience: {
      "@type": "Audience",
      audienceType:
        "Pharmaceutical, Biotech, Medical Devices, Healthcare Providers, Life Sciences Leaders",
    },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
    ...
    <section className={`custom-container lg:mt-[95px] mt-[80px] pb-[59px]`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-16 xl:mt-[45px] mt-[33px] text-black">
        {relatedSolutionsData.map((item, index) => {
          // Border
          const borderRight =
            index < 2 ? "xl:border-r-[1px] xl:border-black" : "";
          const borderBottom =
            "border-b-[1px] border-black md:border-0 pb-[33px] last:border-b-0 last:pb-0";
          return (
            <div
              key={index}
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                <div
                  className={`mt-auto pt-10 ${index === relatedSolutionsData.length - 1 ? "xl:mt-[37px]" : ""}`}
                >
                  <LearnMore
                    bgcolor={"#073259"}
                    bordercolor={"#006FBE"}
...
export default function page() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* BreadcrumbSchema */}
      <BreadcrumbSchema
        currPage="Salesforce Life Sciences Cloud"
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1 mt-16">
          <div className="xl:col-span-8 2xl:col-span-7 4xl:col-span-9 col-span-12 xl:pr-16">
            <h1 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px]">
              Salesforce Life Sciences Cloud Services for Smarter, Compliant
              Innovation with AI
            </h1>
            <p className="mt-10 xl:pr-0  text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
              At Rialtes, we understand that the life sciences industry is
              rapidly evolving — with growing expectations from patients,
              providers, regulators, and partners. To meet these demands,
              organizations need intelligent, AI-driven solutions that integrate
              compliance, personalization, and automation at scale.
            </p>
            <p className="mt-5 xl:pr-0  text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
              Introducing Rialtes LifeAI+, our comprehensive consulting service
              tailored for life sciences enterprises, combining deep industry
              expertise with Salesforce Life Sciences Cloud, Health Cloud, and
              AI-powered solutions to help you drive innovation, ensure
      ...
      <section className="relative  lg:min-h-[980px] 2xl:min-h-[1100px] lg:mt-[95px] mt-[80px]">
        ...
        <div className="custom-container max-lg:px-0 text-white relative">
          <div className="bg-[#0F71BF]  md:p-14 max-md:p-[33px] lg:mt-[-595px] relative">
            ...
            <p className="mt-5 font-normal xl:pr-20 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
              A 360° consulting service that unites Advisory, Design,
              Implementation, Quality Assurance, Integration, and Post-Go-Live
              Support — ensuring continuous value creation and innovation across
              your life sciences value chain.
            </p>
            <h3 className="text-[22px] xl:text-[30px] 4xl:text-[36px] leading-tight font-semibold mt-5">
              ...
              {lifeAiData.map((data, ind) => {
                return (
                  <div className="lg:col-span-4 col-span-12 h-full" key={ind}>
                    <p
                      className={`font-bold ${ind == 2 || ind == 5 || ind == 6 ? "" : " lg:border-r-[2px] border-white "}  ${ind == 4 ? "max-lg:pb-8" : "pb-8"} lg:pr-10 text-[17px] xl:text-[19px] 4xl:text-[20px] leading-tight`}
                    >
                      {data}
                    </p>
                    {ind !== 6 && (
                      <div className="absolute h-[2px] bg-white w-[20%] lg:hidden"></div>
                    )}
                  </div>
                );
              })}
        ...
        <div className="grid xl:grid-cols-12 grid-cols-1">
          ...
          <div className="col-span-6 bg-[#073259] text-white order-2 xl:order-1 pb-20 xl:pb-16">
            <div className="custom-container xl:pt-16 pt-10 xl:pr-[8rem] mx-[35px] xl:mx-0">
              <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px]  pr-16 xl:pr-0">
                Why Partner with Rialtes?
              </h2>
              <UnorderedList
                arrName={whyPartnerData}
                ulClassName="list-disc leading-tight xl:space-y-4 font-normal marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] mt-5 pr-2 xl:pr-0"
                liClassName=""
              />
        ...
        <div className="custom-container xl:pr-0">
          <div className="grid xl:grid-cols-12 grid-cols-1 md:gap-[10px] xl:gap-[50px] bg-[#0690C9] text-white mt-[-100px] relative custom-container 4xl:px-[90px] py-[20px]">
            <div className="xl:col-span-6 col-span-12 pt-[20px] xl:pr-[100px]">
              <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] ">
                Deep Expertise in Salesforce Life Sciences Cloud
              </h2>
              <p className="mt-5 font-normal text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
                We help life sciences organizations maximize Salesforce Life
                Sciences Cloud, configuring its industry-specific modules to
                streamline workflows and improve compliance:
              </p>
            ...
            <div className="xl:col-span-6 col-span-12 xl:mt-10 mt-5">
              ...
              <UnorderedList
                arrName={deepData}
                ulClassName="list-disc leading-tight xl:space-y-4 font-normal marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] mt-5 lg:pr-4"
                liClassName=""
              />
      ...
      <section className="custom-container lg:mt-[95px] mt-[80px]">
        <div className="grid xl:grid-cols-12 grid-cols-1 xl:gap-24 gap-10">
          ...
          <div className="xl:col-span-6 order-2 xl:order-1">
            <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px]  xl:w-[81%] 4xl:w-[100%]">
              How Rialtes LifeAI+ Drives Growth Across Life Sciences
            </h2>
            <p className="mt-5  xl:pr-0 font-normal text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
              Whether you are a pharma, medical device manufacturer, biotech
              firm, or healthcare provider, Rialtes helps you:
            </p>
            <UnorderedList
              arrName={howRialtesData}
              ulClassName="list-disc xl:space-y-4 font-normal marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight mt-6"
              liClassName=""
            />
          </div>
        </div>
      ...
      <section className="mt-[80px] sm:mt-[90px] md:mt-[95px] bg-[#EDEDED] pb-30">
        <div className="custom-container relative bottom-[-60px]">
          <h2 className=" pb-6 leading-tight pr-10 xl:pr-0 xl:pt-[30px] xl:pb-0 4xl:text-[60px] xl:text-[40px] md:text-[26px] xl:w-[65%] 2xl:w-[60%] 4xl:w-[83%]  ">
            ...
            {featureBoxes.map((feature, index) => (
              ...
              >
                <div className="flex flex-col items-start mb-4">
                  <h3 className="text-[#0A6BB8] mt-2 leading-tight 4xl:text-[30px] xl:text-[25px] md:text-[20px]   font-semibold">
                    {feature.title}
                  </h3>
                </div>
                <p className="mt-2 text-[16px] xl:text-[18px] 4xl:text-[24px] leading-tight">
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <div className="custom-container">
          <div className="grid xl:grid-cols-12 grid-cols-1 bg-[#A16B5D] text-white xl:pb-16 pb-8 sticky xl:mt-[-100px] pr-3">
            <div className="col-span-6 xl:pl-20 xl:pt-20 pl-10 pt-10">
              ...
              <h3 className="4xl:text-[42px] xl:text-[30px] text-[20px] mt-5 font-semibold leading-tight">
                Streamlined, Compliant, Intelligent
              </h3>
              <p className="mt-5 font-normal pr-10 xl:pr-0 text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
            ...
            <div className="col-span-6  xl:p-16 p-8">
              <UnorderedList
                arrName={priorData}
                ulClassName="list-disc leading-tight xl:space-y-4 space-y-2 font-normal marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] xl:mt-10 xl:pr-14 pr-8"
                liClassName=""
              />
      ...
      <div className="custom-container relative">
        <div className="xl:px-[110px] max-xl:px-0">
          <div className="bg-[#163055]  p-8 text-[20px] xl:text-[22px] 4xl:text-[26px]  text-white xl:mt-[-60px] leading-tight">
            Our PA solution reduces delays, improves patient experience, and
            ensures faster therapy access — driving better adherence and
            outcomes.
          </div>
        </div>
      </div>
        ...
        <div className="h-full relative custom-container mt-[30rem] md:mt-0">
          <div className="relative p-8 4xl:w-[907px] xl:w-[725px] h-full mt-[17rem] xl:mt-0 pb-10">
            ...
            <div className="relative bg-opacity-80 text-white z-10 xl:p-10 xl:pl-24 rounded-lg">
              <h2 className="leading-tight 4xl:text-[60px] xl:text-[40px] md:text-[26px] pr-5 xl:pr-0">
                AI-Driven Life Sciences with Salesforce Data Cloud & Agentforce
              </h2>
              <p className="mt-5 font-normal text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight">
                Rialtes helps organizations integrate Salesforce Data Cloud and
                Agentforce for Health, unlocking powerful AI-driven
                capabilities:
              </p>
              <UnorderedList
                arrName={aiDrivenData}
                ulClassName="list-disc leading-tight xl:space-y-8 font-normal marker:font-bold marker:text-2xl pl-5 text-[16px] xl:text-[18px] 4xl:text-[20px] mt-5 xl:pr-0 pr-5"
                liClassName=""
              />
              <p className="mt-8 font-normal leading-tight text-[16px] xl:text-[18px] 4xl:text-[20px]">
                Together, Data Cloud and Agentforce enable organizations to
                elevate case management, field services, and patient programs to
                new heights — simplifying complex workflows and reducing time to
                treatment.
              </p>
            </div>
          </div>
      ...
      {/* contact form */}
      <div
        className="custom-container text-black py-16 scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={"Ready to Innovate and Transform?"}
          subtitle="Join leading life sciences organizations who trust Rialtes LifeAI+ to future-proof their operations, enhance compliance, and improve patient engagement."
          subtitle1="Contact us today to schedule a personalized strategy session and demo."
          className={
            "xl:max-w-[72%] leading-tight font-normal 4xl:text-[56px] xl:text-[40px] text-[26px] "
          }
        />
      </div>
    </div>
