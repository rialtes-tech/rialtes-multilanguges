...
export default function page() {
  const schemaData = {
    ...
    description:
      "Salesforce Financial Services Cloud Consulting by Rialtes’ RialFinance+ offers AI-led advisory, implementation, and post-go-live support for FSC success.",
    provider: {
      "@type": "Organization",
      name: "Rialtes",
    ...
    serviceType:
      "Salesforce FSC Strategy, AI Advisory, Custom Implementation, and Support",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Financial services strategy aligned to FSC features, AI use cases, and regulatory needs across retail, commercial, and corporate banking.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Certified Salesforce FSC implementation tailored to banking, lending, insurance, and asset management workflows with full compliance.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Pre-built bots and AI modules for onboarding, fraud detection, lending, and wealth — seamlessly embedded into FSC via Agentforce.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Risk and compliance validations, sandbox testing, UAT, and security checks aligned with global financial regulations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Zero Copy Data integration with Salesforce and SAP ecosystems for a unified client profile and real-time financial insights.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Global 24/7 support, training, enhancement sprints, FSC optimizations, and AI performance monitoring via RialFinance+.",
          },
        },
      ],
    },
    additionalProperty: [
      {
        ...
        value:
          "Experts in FSC, Data Cloud, Agentforce, and industry modules like lending, insurance, and wealth management.",
      },
      {
        "@type": "PropertyValue",
        name: "AI-Driven FSC Transformation with Agentforce",
        value:
          "Conversational AI, compliance automation, and customer intelligence powered by Salesforce Agentforce.",
      },
      {
        "@type": "PropertyValue",
        name: "Integrated Real Estate & Finance with Exelona",
        value:
          "Extend FSC to manage real estate portfolios, leasing, investor services, and revenue — all in one platform.",
      },
    ],
  };
  const startWithData = [
  ...
  const deepDiveData = [
    ...
    },
    {
      ...
      mobImg:
        "/images/services/rial-finance/Mobile/commercial-banking-mob.webp",
    },
    {
      id: "3",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Breadcrumb Schema */}
      <BreadcrumbSchema
        currPage="Salesforce Financial Services Cloud"
      ...
      <section className="relative group overflow-hidden h-[420px] lg:h-[550px] 4xl:h-[650px]">
        ...
        <div className="relative h-full custom-container sm:flex sm:items-center pt-[70px] sm:pt-0 ">
          <div className="grid grid-cols-12 w-full">
            ...
            <div className="4xl:col-span-4 sm:col-span-5 md:col-span-6 lg:col-span-6 col-span-3"></div>
          </div>
        </div>
      </section>
      ...
      <section className="custom-container mt-5">
        ...
        <div className="xl:mt-[99px] mt-[50px]">
          <h2 className="text-[26px] leading-tight xl:text-[40px] 4xl:text-[60px] w-[90%] sm:w-full">
            AI-Powered Financial Services. <div className="sm:block hidden" />{" "}
            Personalized Client Journeys. <div className="sm:block hidden" />{" "}
          ...
          <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] leading-tight font-normal xl:mt-[43px] mt-[30px] w-[90%] sm:w-full xl:w-[80%] 2xl:pr-32 4xl:pr-0 xl:pr-0">
            At Rialtes, we enable financial institutions to lead with innovation
            and trust. Our RialFinance+ Managed Services deliver advisory,
            implementation, customization, AI integration, and post-go-live
            support, all unified to transform your Salesforce Financial Services
            Cloud (FSC) experience.
            <br />
            <br />
            With deep domain expertise in Banking, Wealth, Lending, Asset
            Management, Insurance, and Brokerage, and offices in the U.S.,
            Canada, Singapore, and India, Rialtes is a certified Salesforce
            partner delivering cutting-edge, compliant, AI-ready solutions.
          </p>
        </div>
      </section>
      ...
      <section className="xl:mt-[124px] mt-[88px]">
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] gap-y-[44px]">
            ...
            <div className="lg:col-span-5 col-span-12 max-lg:px-[36px] w-full lg:w-full">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] xl:mt-[25px] mt-[17px] font-normal">
                Agentforce, Salesforce’s revolutionary AI assistant, is
                transforming customer-agent relationships in financial services.
                Rialtes makes Agentforce adoption seamless with:
              </p>
              <UnorderedList
                arrName={startWithData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[25px] mt-[17px] pl-[20px]"
        ...
        <div className="custom-container xl:mt-[46px] mt-[53px]">
          <p className="xl:py-[31px] xl:px-[38px] py-[24px] px-[34px] bg-[#073259] text-[#ffffff] font-normal w-fit 4xl:text-[24px] xl:text-[20px] text-[18px]">
            Adopt AI with confidence — powered by Rialtes financial services
            expertise.
          </p>
        </div>
      </section>
      ...
      <section className="xl:mt-[121px] mt-[84px]">
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[60px] gap-y-[17px]">
            ...
            <div className="lg:col-span-7 col-span-12 w-[90%] md:w-[80%] lg:w-full">
              <p className="xl:text-[19px] 4xl:text-[22px] text-[16px] leading-tight font-normal">
                Our RialFinance+ combines strategic advisory, system design,
                certified implementation, quality assurance, AI integrations,
                and ongoing managed services into a single powerful solution —
                enabling financial institutions to transform, innovate, and
                lead.
              </p>
            </div>
          </div>
        ...
        <div className="xl:mt-[90px] mt-[80px]">
          {deepDiveData.map((data, ind) => {
            return (
              <div
                className="relative custom-container xl:mt-[120px] mt-[80px] border-t border-[#707070]"
                key={ind}
              >
                <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[60px] 4xl:gap-[20px]">
                  <div className="xl:pt-[60px] pt-[40px]">
                    <div className="absolute top-[-50px]">
                      <p className="text-[50px] px-4 pl-1 py-2 bg-[#ffffff] font-bold">
                        {data.id}
                      </p>
                    </div>
                    ...
                    <UnorderedList
                      ...
                      ulClassName="xl:space-y-[24px] space-y-[19px] list-disc pl-[20px] w-[90%] md:w-full xl:mt-[40px] mt-[23px]"
                      liClassName="text-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight font-normaltext-[16px] xl:text-[18px] 4xl:text-[20px] leading-tight font-normal"
                    />
                  </div>
                  <div>
      ...
      <section className="xl:mt-[70px] mt-[63px]">
        ...
        <div className="custom-container 4xl:!pr-[142px] xl:!pr-[36px] md:!pr-0 max-md:px-0 md:mt-[-120px] relative z-20">
          <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[60px] 4xl:gap-[20px] gap-y-[30px] bg-[#0E3157] text-[#ffffff] xl:pt-[87px] xl:pl-[70px] xl:pr-[40px] xl:pb-[127px] pt-[41px] pb-[93px] px-[36px]">
            <div className="md:col-span-6 col-span-12">
              ...
              <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] xl:mt-[25px] mt-[17px] font-normal 4xl:w-[70%]">
                Our proprietary solution Exelona, when integrated with FSC,
                revolutionizes real estate firms and asset management companies
                by enabling:
              </p>
            </div>
            <div className="md:col-span-6 col-span-12">
              <UnorderedList
                arrName={exelonaData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc pl-[20px] w-[90%] md:w-full"
                liClassName="text-[16px] xl:text-[19px] 4xl:text-[22px] leading-tight font-normal"
              />
          ...
          <div className="absolute xl:px-[70px] px-[36px] mt-[-50px]">
            <p className="xl:py-[31px] xl:px-[38px] py-[24px] px-[34px] bg-[#006FBE] text-[#ffffff] font-normal w-fit 4xl:text-[24px] xl:text-[20px] text-[18px]">
              One integrated platform — Real Estate + Financial Services.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[60px] 4xl:gap-[80px] gap-y-[30px] text-[#ffffff] xl:mt-[23px] mt-[16px]">
          <div className="md:col-span-5 col-span-12">
            <h3 className="text-[20px] xl:text-[28px] 4xl:text-[38px] font-semibold w-[90%] xl:w-[90%] 4xl:w-full">
              WhatsApp-Enabled Real-Time Customer Engagement (Included Free with
              RialFinance+)
            </h3>
            <p className="xl:text-[18px] 4xl:text-[20px] text-[16px] xl:mt-[35px] mt-[16px] font-normal w-[90%] xl:w-full">
              With AgentChat,seamlessly integrated into Salesforce FSC, engage
          ...
          <div className="md:col-span-7 col-span-12">
            ...
            <p className="xl:text-[18px] 4xl:text-[22px] text-[18px] xl:mt-[52px] mt-[29px] font-normal">
              Included FREE with RialFinance+ — enhancing customer engagement
              without extra costs.
            </p>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-[40px] lg:gap-[80px] gap-y-[29px]">
          <div className="md:order-1 order-2">
            ...
            <p className="xl:text-[18px] 4xl:text-[22px] text-[16px] xl:mt-[35px] mt-[16px] font-normal w-[90%] xl:w-full">
              Agentforce, with Rialtes’ expertise, delivers AI-driven
              excellence:
            </p>
            <UnorderedList
              arrName={agentforceData}
              ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[43px] mt-[16] pl-[20px] w-[90%] md:w-full"
              liClassName="text-[16px] xl:text-[19px] 4xl:text-[22px] leading-tight font-normal"
            />
          ...
          <div className="md:col-span-7 col-span-12">
            <div className="md:block hidden w-full h-full relative">
              ...
              <div className="absolute right-0 mt-[-60px]">
                <p className="xl:py-[31px] xl:px-[38px] py-[24px] px-[34px] bg-[#073259] text-[#ffffff] font-normal w-fit 4xl:text-[24px] xl:text-[20px] text-[18px]">
                  A unified view of your client. Real-time. AI-ready.
                </p>
              </div>
            </div>
            {/* mob image */}
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1">
          <div className="lg:col-span-5 col-span-12 lg:mr-[-90px] relative z-20 lg:order-1 order-2">
            <div className="bg-[#5D5F63] max-lg:mx-[36px] text-[#ffffff] xl:pt-[57px] xl:pb-[101px] xl:pl-[80px] xl:pr-[60px] lg:my-[60px] pt-[34px] px-[30px] pb-[60px]">
              ...
              <UnorderedList
                arrName={howWeDeliverData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[33px] mt-[17px] pl-[20px] w-[86%] md:w-full 4xl:w-[90%]"
                liClassName="text-[16px] xl:text-[19px] 4xl:text-[22px] leading-tight font-normal"
              />
        ...
        <div className="relative">
          ...
          <div className="lg:absolute lg:right-0 xl:top-[-90px] lg:top-[-40px] lg:w-[50%] xl:w-[48%] 3xl:w-[40%] 4xl:w-[50%]">
            <div className="bg-[#006FBE] text-[#ffffff] 4xl:pt-[79px] 4xl:pl-[67px] 4xl:pr-[60px] xl:pt-[54px] xl:pl-[50px] xl:pr-[50px] pt-[34px] px-[36px]">
              ...
              <UnorderedList
                arrName={whyRialtesData}
                ulClassName="xl:space-y-[27px] space-y-[19px] list-disc xl:mt-[39px] mt-[16px] pl-[20px] w-[86%] md:w-full"
                liClassName="text-[16px] xl:text-[19px] 4xl:text-[22px] leading-tight font-normal"
              />
      ...
      {/* Contact Form */}
      <div
        className="custom-container lg:mt-[108px] lg:mb-[92px] mt-[41px] mb-[45px]  scroll-mt-28"
        ref={contactRef}
      >
        <ContactForm
          title={
            "Get Started with RialFinance+ — Transform Your Financial Services with AI, Data, and Salesforce"
          }
          subtitle="Ready to future-proof your financial institution and deliver next-gen customer experiences?"
          subtitle1="Contact Rialtes to explore RialFinance+ — your partner for Salesforce-driven financial transformation."
          className={
