    ...
    return (
        ...
        custom-container"
                >
                    <div className="grid xl:grid-cols-12 grid-cols-1 gap-2 xl:mt-20 4xl:mt-20 mt-16 mx-auto">
                        <div className="xl:col-span-7 col-span-12 pr-5 ">
                            ...
                            <h2 className="text-white  leading-tight break-words 4xl:text-[60px] xl:text-[40px] text-[26px]  xl:mt-10 4xl:mt-10 mt-5 pr-32 4xl:pr-0 xl:pr-0 md:pr-[25rem]">
              ...
              custom-container">
                <div className="grid xl:grid-cols-12 grid-cols-1">
                    <div className="4xl:col-span-10 xl:col-span-8 col-span-12">
                        ...
                        <p className="text-[16px] 4xl:text-[22px] leading-tight mt-5 4xl:pr-[25px] pr-[2rem] xl:pr-0">In today’s fast-evolving sales and marketing landscape, customers expect personalized, timely, and relevant engagements—across every touchpoint. At Rialtes, we help organizations unlock the true potential of Salesforce Marketing Cloud with our proprietary Avantage+ Services — a comprehensive suite of advisory, implementation, design, quality assurance, integration, and post-go-live support services that ensure rapid and successful Marketing Cloud adoption. </p>
            ...
            <div className="relative  4xl:mt-[20rem] 4xl:pl-[142px]  pb-20 custom-container mt-[11rem] max-md:px-0 xl:mt-[18rem]">
                <div className="bg-[#F0F0F0] relative 4xl:pl-[142px] 4xl:h-[1340px] xl:h-[865px]">
                    ...
                    <div className="relative z-20 mt-10 grid xl:grid-cols-2 gap-10 px-4 xl:px-0 max-md:px-[35px]">
                        <div className="4xl:mt-[40rem] mt-[23rem]  md:mt-[43rem] xl:mt-[29rem] xl:ml-[5rem] 4xl:ml-0">
            ...
            <section className="relative 4xl:mt-[9rem] mt-[1rem] xl:mt-[9rem]">
                ...
                <div className="grid xl:grid-cols-12 grid-cols-12 absolute xl:top-[-8rem] 4xl:top-[-8rem] top-[31rem] md:top-[57rem]">
                    ...
                    <div className="xl:col-span-5 col-span-12 bg-[#184671] text-white pt-12 4xl:px-14 xl:px-10 px-10">
                        ...
                        <h3 className="4xl:text-[38px] text-[24px] xl:text-[25px] mt-5 leading-tight pr-12 xl:pr-0 4xl:pr-0">Transforming WhatsApp Conversations for Salesforce Users</h3>
