                    ...
                    <div>
                        <div className="max-w-4xl">
                            ...
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 mt-3">
                                <li className="pb-4 text-black">Copy, reproduce, modify, republish, upload, post, distribute, transmit, or use any content from this Website for commercial purposes without prior written permission from Rialtes.</li>
                                <li className="pb-4 text-black">Engage in any unauthorized use of the Website, including but not limited to data mining, automated scripts, or any other practice that extracts data from the Website.</li>
                                <li className="pb-4 text-black">Attempt to gain unauthorized access to any portion of the Website, server, or any system connected to Rialtes' network.</li>
                                <li className="pb-4 text-black">Use the Website in any manner that could damage, disable, overburden, or impair its functionality or interfere with other users' access.</li>
                                <li className="pb-4 text-black">Introduce any malware, viruses, or harmful code into the Website.</li>
                                <li className="pb-4 text-black">Violate any applicable local, national, or international laws through your use of the Website.</li>
                            </ul>
                            ...
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 mt-3">
                                <li className="pb-4 text-black">Loss of profits, revenue, or business opportunities.</li>
                                <li className="pb-4 text-black">Business interruption, technical failures, or data corruption.</li>
                                <li className="pb-4 text-black">Unauthorized access or use of personal information.</li>
                                <li className="pb-4 text-black">Any reliance on content published on the Website.</li>
