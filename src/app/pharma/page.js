...
export default function Page() {
    return (
                ...
                >
                    <div className="grid xl:grid-cols-12 grid-cols-1 gap-20 mt-20">
                        <div className="xl:col-span-6 col-span-12">
                            <h3 className="text-white xl:text-[24px] font-medium mb-2">Pharma Industry</h3>
                            <h1 className="text-white xl:text-[60px] leading-tight">
                                Accelerating Pharma Innovation & Compliance
                            </h1>
                            <h3 className="xl:text-[45px] mt-5 text-white font-bold pr-32">Rialtes End-to-End Pharma & Biotech Solutions</h3>
                ...
                >
                    ...
                    <div className="grid xl:grid-cols-12 grid-cols-1  pt-10 pb-32">
                        <div className="xl:col-span-6 col-span-12 pr-20">
                            ...
                            <h3 className="text-[42px] mt-5 font-bold">Advancing Pharma with Digital, AI, and Data-Driven Approaches</h3>
                 ...
                 "
                    >
                        <p className="xl:text-[25px] bg-[#073259]  p-5 pl-10 text-white mt-[-3rem] absolute w-[90%] pr-32">Our end-to-end approach bridges gaps between R&D, regulatory, commercial, and supply chain functions, delivering a unified platform for better decision-making and faster time to market.</p>
                ...
                <div className=" xl:ml-[280px]">
                    <div className="relative p-12 w-[828px] h-[403px]">
                        ...
                        <div className="relative bg-opacity-80 text-white z-10 p-4 rounded-lg">
                            <h2 className="text-[60px]">Why Leading Pharma & Biotech Firms Choose Rialtes</h2>
                        </div>
                    </div>
       ...
       ">
            ...
            >
                <div className="grid grid-cols-12 ">
                    <div className="col-span-8">
                        <h2 className="text-[60px]">Top 4 Strategic Challenges Facing Pharma and Biotech Industry Today</h2>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-12  bg-[#CCFFEA]">
                        <div className="col-span-6 p-10 pl-16 pb-16 pr-16">
                            <div className="flex gap-10 items-center">
                                ...
                                <h2 className="text-[42px] font-bold">Complex and Dynamic Regulatory Compliance</h2>
                            </div>
                    ...
                    <div className="grid grid-cols-12  bg-[#C3EBFF]">
                        ...
                        <div className="col-span-7 p-10 pl-16 pb-16 ">
                            <div className="flex gap-10">
                                ...
                                <h2 className="text-[42px] font-bold">Accelerating Clinical Trials and R&D Innovation</h2>
                            </div>
                            <p className="text-[22px] mt-3">Bringing therapies to market faster demands better trial management, patient recruitment, and data consolidation. Current issues:</p>
                            <ul className="list-disc space-y-4 marker:font-bold marker:text-2xl pl-5 xl:text-[20px] mt-5">
                ...
                <div className="  mt-10 pr-[142px]">
                    <div className="grid grid-cols-12  bg-[#FFF3D8]">
                        <div className="col-span-7 p-10 pl-16 pb-16 pr-32 pt-10">
                            <div className="flex gap-10 items-center">
                                <h2 className="text-[100px] font-bold text-[#B16929]">1</h2>
                                <h2 className="text-[42px] font-bold">Commercial and Medical Affairs Engagement Gaps</h2>
                            </div>
        ...
        xs:mx-4 xs:w-[calc(100%-32px)]"
                    ...
                    <div className="grid grid-cols-12  bg-[#C7DEFF]">
                        ...
                        <div className="col-span-7 p-10 pl-16 pb-16 pr-20">
                            <div className="flex gap-10">
                                ...
                                <h2 className="text-[42px] font-bold">Supply Chain, Manufacturing, and Serialization</h2>
                            </div>
            ...
            <section className="relative group overflow-hidden h-[500px] xl:h-[1690px]  mt-5 xl:mt-40 xl:block hidden text-white">
                <Image
        ...
        md:ml-[100px]"
                >
                    <div className="grid grid-cols-12  mt-20">
                        <div className="col-span-8">
                            <h2 className="text-[60px]">Deep Expertise in Salesforce Life Sciences Cloud & SAP S/4 HANA for Pharma and Biotech</h2>
                        </div>
                    </div>
                    <div className="grid grid-cols-12">
                        <div className="col-span-5 mt-10 pr-10">
                            <div className="group relative overflow-hidden">
                                <Image
                                    ...
                                    height={0}
                                    width={0}
                                    className="!h-[342px] !w-[532px] transform transition-transform duration-500 group-hover:scale-110"
                                />
                            </div>
                            <h3 className="text-[40px] mt-10 font-bold">Salesforce Life Sciences Cloud </h3>
                            <h3 className="mt-5 text-[35px]">Unifying Commercial, Clinical, and Medical Operations</h3>
                        ...
                        <div className="col-span-5 mt-64 relative pr-10">
                            ...
                            <h3 className="mt-5 text-[35px]">Ensuring Compliance, Quality, and Operational Excellence</h3>
                            <p className="text-[22px] mt-5">Our SAP expertise helps pharmaceutical firms streamline:</p>
                            <ul className="list-disc space-y-4 marker:font-bold marker:text-2xl pl-5 xl:text-[20px] mt-5 pr-16">
            ...
            <div
                className="
                 ...
                 "
            >
                <p className="xl:text-[26px] bg-[#0E3157]  p-5 pl-10 text-white mt-[-4rem] absolute w-[50%]">Together, Salesforce and SAP integrations ensure seamless, compliant processes from R&D to commercialization.</p></div>
            ...
            <div
                className=" mt-20 !h-[650px] text-white group overflow-hidden
                               relative
                              ml-[15px]  mr-[142px]
                             xl:ml-[280px]"
            >
            ...
            <div className="bg-[#0C8AD4] mt-64 h-[1500px]">
                <div
                ...
                >
                    ...
                    <div className="grid grid-cols-12 gap-32">
                        <div className="col-span-6 mt-[-4rem]">
                            ...
                            <h2 className="mt-5 text-[60px] pr-32">Patient-Centric Mobile Apps</h2>
                            <h3 className="text-[42px] mt-10 font-medium">Driving Outcomes and Real-World Evidence </h3>

                            <p className="text-[22px] mt-5">Modern pharma needs secure mobile apps for engaging patients and collecting outcomes. Rialtes designs apps to:</p>
                            ...
                            <p className="bg-[#163055] text-[26px] p-5 pl-16 mt-10">Mobile apps ensure better engagement, adherence, and outcome measurement.</p>
                        </div>
                        ...
                        <div className="col-span-6 mt-64">
                            ...
                            <h2 className="mt-5 text-[60px]">Remote Monitoring & Real-World Data Collection</h2>
                            <p className="text-[22px] mt-5">Remote monitoring allows pharma companies to track product effectiveness and patient safety in real-time:</p>
                            <ul className="list-disc space-y-4 marker:font-bold marker:text-2xl pl-5 xl:text-[20px] mt-5 pr-10">
                            ...
                            <p className="bg-[#163055] text-[26px] p-5 pl-16 mt-16">Enhancing patient safety, outcomes, and evidence generation.</p>
            ...
            >
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-5">
                        ...
                        <h3 className="text-[42px] font-bold">Real-Time WhatsApp Integration for Pharma</h3>
                        <p className="text-[22px] mt-10">AgentChat Rialtes’ WhatsApp integration solution, supports secure and compliant engagement:</p>
                ...
                <div className="h-full  xl:mr-[142px]">
                    <p className="xl:text-[25px] bg-[#068EDA]  p-5 pl-10 text-white mt-[-2rem] absolute w-[75%] pr-12">AgentChat enables real-time omnichannel patient and HCP engagement — securely and compliantly.</p>
                </div>
            </div>


            <div className="bg-[#184671] text-white pb-20">
                <div
                    className="mt-[30px]
  container
  ml-[15px] w-[calc(100%-15px)] mr-0
  ...
  text-black py-20"
                >
                    <div className="group overflow-hidden relative mt-20">
                        <Image
                            ...
                            height={0}
                            width={0}
                            className="!h-[791px] !w-full transition-all duration-700 ease-in-out group-hover:scale-105 group-hover:brightness-90 group-hover:saturate-150"
                        />
                    </div>
                    <div className="grid grid-cols-12 mt-10 text-white">
                        <div className="col-span-5">
                            <h2 className="text-[50px]">Salesforce Agentforce </h2>
                            <h3 className="text-[42px]">Supercharging Pharma Sales, Medical Affairs, and Support</h3>
                        </div>
                        <div className="col-span-1">
                        </div>
                    ...
                    <div className="h-full  xl:mr-[142px]">
                        <p className="xl:text-[25px] bg-[#068EDA]  p-5 pl-10 text-white mt-[6rem] absolute w-[65%] pr-40">Agentforce enhances field force effectiveness and ensures compliant, personalized HCP interactions.</p>
                    </div>
                      </div>
  ...
  text-black py-20"
            >
                <ContactForm title={'Partner with Rialtes — Enabling Next-Gen Pharma and Biotech Excellence'} className={"max-w-[62rem] font-medium text-[60px]"} />
            </div >
        </div >
    );
}