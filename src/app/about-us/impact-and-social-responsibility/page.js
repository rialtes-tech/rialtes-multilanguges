        ...
        >
          <div className="container mx-auto h-full flex flex-col justify-center xl:mt-[-80px]">
            <div className="flex flex-col">
              ...
              <h1 className="text-white max-w-2xl xl:text-[60px] text-[40px]">
          ...
          <div className="container mx-auto">
            <div>
              <div className="w-full xl:mr-4 xl:mb-0">
                <h2 className="text-black md:pb-0 pb-4 font-bold  w-full xl:text-[44px]">Rialtes has been empowering customers across the world to trust AI and strengthen the philosophy of responsible AI.</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pb-16 mt-20">
            <div className="relative">
              <div className=" bg-[#086CB9] p-10 text-white w-full">
                <div className="flex flex-col">
                  <h3 className="h3-bold line-clamp-2 xl:text-[40px] text-[20px]">1 % of revenue </h3>
                </div>
                <p className='md:mb-[15px] xl:text-[30px] text-[19px]'>committed to social work</p>
              </div>
              <Image
                className="w-full"
            ...
            <div className="relative">
              <Image
                ...
                priority
              />
              <div className="bg-[#086CB9] p-10 w-full text-white xl:h-[245px]">
                <p className="mt-4 xl:text-[28px] text-[19px]">Committed to planting</p>
                <div className="flex flex-col">
                  <h3 className="h3-bold line-clamp-2 xl:text-[40px] text-[20px]">
                    1 trillion trees
                  </h3>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-[#086CB9] p-10 w-full text-white">
                <div className="flex flex-col">
                  <h3 className="h3-bold line-clamp-2 xl:text-[40px] text-[20px]">500+ AI Certified  </h3>
                </div>
                <p className='md:mb-[15px] xl:text-[28px] text-[19px]'>professionals every six months</p>
              </div>
              <Image
                className="w-full"
