                    ...
                    <div className="grid xl:grid-cols-12">
                        <div className="col-span-9">
                            ...
                            <div>
                                ...
                                <ul className="list-disc marker:text-black marker:text-xl text-black 4xl:pr-0 xl:pr-0 mt-2 space-y-3 text-[16px] xl:text-[18px] 4xl:text-[20px] font-medium pl-[26px]">
                            ...
                            <div>
                                ...
                                <ul className="list-disc marker:text-black marker:text-xl text-black 4xl:pr-0 xl:pr-0 mt-5 space-y-3 text-[16px] xl:text-[18px] 4xl:text-[20px] font-medium pl-[26px]">
                                    {
                                        goverenanceData.map((data, ind) => {
                                            return (
                                                <li key={ind}><h4 className="inline text-[16px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px]">{data.title}</h4>
                                                    <UnorderedList arrName={data.list} ulClassName="list-[circle] pl-[26px] mt-3 space-y-2" liClassName="" />
                                                </li>
                                            )
                                        })
                                    }
                            ...
                            <div>
                                ...
                                <ul className="list-disc marker:text-black marker:text-xl text-black 4xl:pr-0 xl:pr-0 mt-3 space-y-3 text-[16px] xl:text-[18px] 4xl:text-[20px] font-medium pl-[26px]">
                                    {
                                ...
                                <UnorderedList arrName={traceabilityData2} ulClassName="list-disc marker:text-black marker:text-xl text-black 4xl:pr-0 xl:pr-0 mt-2 space-y-3 text-[16px] xl:text-[18px] 4xl:text-[20px] font-medium pl-[26px]" liClassName="" />
                            ...
                            <div>
                                ...
                                <ul className="list-decimal marker:text-black marker:text-xl text-black 4xl:pr-0 xl:pr-0 mt-3 space-y-3 text-[16px] xl:text-[18px] 4xl:text-[20px] font-medium pl-[26px]">
                                    {
                                        lifecycleData.map((data, ind) => {
                                            return (
                                                <li key={ind}><h4 className="inline text-[16px] 2xl:text-[18px] xl:text-[18px] 4xl:text-[20px]">{data.title}</h4>
                                                    <UnorderedList arrName={data.list} ulClassName="list-[circle] pl-[26px] space-y-2 mt-2" liClassName="" />
                                                </li>
                                            )
                                        })
                                    }
                            ...
                            <div>
                                ...
                                <p className="mt-5 4xl:pr-20 2xl:text-[18px] 4xl:text-[20px] xl:text-[17px] text-[16px]">SAP S/4HANA implementations succeed not just when systems go live but when business outcomes are delivered and sustained. Pairing SAP Signavio with SAP Cloud ALM creates a foundation of governance, traceability, and KPI-driven execution.</p>
                                <p className="mt-5 4xl:pr-20 2xl:text-[18px] 4xl:text-[20px] xl:text-[17px] text-[16px]">At <strong>Rialtes</strong> , we help enterprises unlock the combined power of Signavio and Cloud ALM, transforming S/4HANA projects into controlled, transparent, and measurable business transformation programs. With our consulting expertise, leaders gain the confidence that every decision, every configuration, and every KPI is connected to enterprise value.</p>
                            </div>
                            <div>
