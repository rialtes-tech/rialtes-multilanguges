        ...
        <div className="py-10 bg-white">
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl md:w-4/2">
              ...
              <h2 className="pb-4 font-medium text-[#0092E0] xl:text-[30px] text-[20px]">Why the Pharmaceutical Industry Needs Agentic AI</h2>
  ...
  <li>
    ...
    <p>With stricter regulations and rising operational expenses, pharma companies must improve efficiency, streamline workflows, and reduce costs, all while maintaining high standards of compliance and care.</p>
            ...
            <div className="pl-8">
              ...
              <h2 className="pb-4 font-medium text-[#0092E0] xl:text-[30px] text-[20px]">Improve Patient Outcomes and Revolutionize Pharmaceuticals Worldwide</h2>
