                ...
                <div className="py-10 bg-white">
                    ...
                    <div className=" mx-auto">
                        <div className="max-w-[1084px] xl:w-[1084px]">
                            ...
                            <p className="mt-5">Instead of waiting for problems to show up, you're already solving them. That’s predictive intelligence in action and a clear advantage over teams still chasing tickets.</p>
