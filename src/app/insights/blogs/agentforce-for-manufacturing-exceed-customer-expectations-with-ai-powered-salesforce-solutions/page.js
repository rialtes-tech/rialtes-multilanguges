        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="custom-container">
                <div className="py-10 bg-white max-w-[1084px] 4xl:w-[1084px] 2xl:w-[900px] xl:w-[750px]">
                    ...
                    <div className=" ">
                        <div className="">
                            ...
                            <p className="text-black text-[16px] pb-4 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px]">And here's the thing: every one of these touchpoints is a growth opportunity, if your support operation is intelligent enough to catch it.</p>

                            <h3 className="pb-4 mt-6 h3-bold text-[16px] 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px]">
                                That’s where Agentforce comes in handy.
                            </h3>
                            <p className="text-black pb-4 text-[16px] 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px]">It transforms service desks from reactive help channels into proactive, revenue-generating hubs. It does this by embedding AI copilots that understand your products, workflows, and customer relationships inside and out.</p>
                            ...
                            <div className="pl-6">
                                ...
                                <ol className="list-disc  marker:text-xl  marker:text-[#0092E0] 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px] text-[16px]  font-medium space-y-3">
                            ...
                            <p className="text-black pb-4 mt-5 text-[16px] 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px]">
                                With this intelligence, your teams can:
                            </p>
                            <ol className="pl-4 list-disc marker:text-[#0092E0] 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px] text-[16px] font-medium space-y-3">
                                <li>
                            ...
                            <p className="text-black text-[16px] mt-5 4xl:text-[20px] 2xl:text-[18px]  xl:text-[17px]">
                            ...
                            <p className="mt-5 4xl:text-[20px] 2xl:text-[18px] text-[16px]  xl:text-[17px]">And trust pays off.</p>
                            ...
                            <p className="mt-5 4xl:text-[20px] text-[16px] 2xl:text-[18px]  xl:text-[17px]">Instead of waiting for problems to show up, you're already solving them. That’s predictive intelligence in action and a clear advantage over teams still chasing tickets.</p>
                ...
                <div className="xl:mt-[80px] mt-[40px]">
                    <h2 className="font-semibold text-[#0092E0] 4xl:text-[32px] 2xl:text-[26px] xl:text-[26px] md:text-[22px] text-[22px]"> FAQs: Agentforce for AI-Powered Manufacturing Transformation</h2>
