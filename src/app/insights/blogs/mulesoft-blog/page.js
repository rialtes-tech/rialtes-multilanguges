...
export default function Page() {
    ...
    const faqData = [
        ...
        {
            question: "Can MuleSoft integrate Salesforce with SAP and legacy systems?",
            answer:
    ...
    const commonData = [
        ...
        {
            "title": "How MuleSoft Ensures Enterprise-Grade Security for Salesforce Integrations",
            "desc": [
        ...
        {
            "title": "API-Led Connectivity: The Foundation of Scalable Salesforce Integration",
            "desc": [
        ...
        {
            "title": "What Enterprise Scale Really Means in MuleSoft–Salesforce Deployments",
            "desc": [
        ...
        {
            "title": "Common Risks in Large-Scale Salesforce Integrations and How MuleSoft Mitigates Them",
            "desc": [
            ...
            "desc2": "By addressing these risks at the architecture level, MuleSoft transforms integrations from fragile connectors into strategic assets."

        },
        {
            "title": "Key Questions Executives Should Ask Before a MuleSoft Implementation",
            "desc": [
            ...
            "desc2": "The answers to these questions determine whether MuleSoft becomes a long-term platform or just another tool."
        },
        {
    ...
    const whyRialtesData = [
        {
            ...
            "desc": [
                "Rialtes brings deep expertise across Salesforce, SAP, and enterprise integration landscapes. Our teams have delivered complex MuleSoft integrations across industries, geographies, and regulatory environments.",
        ...
        <section className="min-h-screen">
            ...
            <section className="relative 4xl:h-[638px] xl:h-[450px] 2xl:h-[500px] overflow-hidden">
                <div className="xl:block hidden">
                    <Image
                        src="/images/blog/digital-data-streams.webp"
                            ...
                            {/* common data */}
                            {
                                commonData.map((data, ind) => (
                                    <div className="md:mt-[50px] mt-[40px]" key={ind}>
                                        ...
                                        {data.olList &&
                                            <OrderedList arrName={data.olList} ulClassName="mt-5 space-y-2 pl-[26px] lg:pl-[46px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] font-medium list-decimal" />
                                        }
                                        {data.ulList &&
                                            <UnorderedList arrName={data.ulList} ulClassName="mt-5 space-y-2 pl-[26px] lg:pl-[46px] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px] font-medium list-disc" />
                                        }
                                        {
                                            data.desc2
                                            && <p
                                        ...
                                        <h3 className="4xl:text-[24px] 2xl:text-[21px] text-[20px] font-bold mt-5">{data.subTitle}</h3>
                                        {
                                            ...
                                            <div className="md:flex mt-5">
                                                {data.steps.map((elem, id) => (
                                                    <div key={id}>
                                                        <div className={`md:mt-5 max-md:pb-2 max-md:flex max-md:ml-4 max-md:border-l max-md:border-[#aaa8a8] gap-4 lg:pr-10 3xl:pr-16 md:pb-8 md:border-b ${id == 4 && "md:border-b-0 max-md:border-l-0"} border-b-[#aaa8a8] 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]`}>
                                                            <p className="w-2 h-2 bg-[#1A82E0] rounded-full md:hidden ml-[-5px]"></p> <span className="font-bold max-md:mt-[-7px]">Stage {id + 1}</span>
                                                        </div>
                                                        <div className="w-3 h-3 rounded-full hidden md:block bg-[#1A82E0] md:mt-[-6px]"></div>
                                                        <div className={`md:mt-5 max-md:pb-6 max-md:flex max-md:ml-4 max-md:border-l max-md:border-[#aaa8a8] gap-4 md:pr-10 lg:pr-10 3xl:pr-16 md:pb-8 ${id == 4 && "max-md:border-l-0"} 4xl:text-[20px] 2xl:text-[17px] xl:text-[17px] md:text-[16px] text-[16px]`}>
            ...
            <section className="xl:mt-[80px] mt-[40px] custom-container">
                <h2 className="font-semibold text-[#0092E0] 4xl:text-[32px] 2xl:text-[26px] xl:text-[26px] md:text-[22px] text-[22px] leading-tight">FAQs: MuleSoft Salesforce Integration</h2>
