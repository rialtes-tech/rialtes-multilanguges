 ...
 <a
          ...
          <div>
            <div className="max-[1084px] xl:w-[1084px]">
              ...
              <h2 className="font-medium text-[#0092E0] xl:text-[30px] text-[20px] pb-4">Overcoming DEI Challenges with SAP</h2>


              <h3 className="text-black pb-4 h3-bold">Bias-Free Recruitment</h3>
              ...
              <h3 className="text-black pb-4 h3-bold">Inclusive Performance Management</h3>
              ...
              <h3 className="text-black pb-4 h3-bold">Building a Culture of Learning and Growth</h3>
              ...
              <h3 className="text-black pb-4 h3-bold">Analytics and Reporting for DEI Initiatives</h3>
              ...
              <h3 className="text-black pb-4 h3-bold">Flexible Work and Inclusive Policies</h3>
              ...
              <h3 className="text-black pb-4 h3-bold">Enhancing Belonging through Employee Engagement</h3>
              ...
              <h2 className="font-medium text-[#0092E0] xl:text-[30px] text-[20px] pb-4">Is your HR system doing enough for Diversity and Inclusion?</h2>
