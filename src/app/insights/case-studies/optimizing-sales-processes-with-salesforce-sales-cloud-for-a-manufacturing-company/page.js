                ...
                <span className='text-[#0092E0]'>Manufacturing</span> <span className='text-[#ACACAC]'> | </span>26 March 2025
                    ...
                    <div>
                        <div className="">
                            ...
                            <h3 className="h3-bold text-[#0092E0] text-lg">Complex Sales Process</h3>
                            ...
                            <h6 className="h3-bold text-[#0092E0] text-lg">Lack of a Customer Engagement System</h6>
                            ...
                            <h6 className="h3-bold text-[#0092E0]  text-lg">Overcoming Budget and Invoice Management Challenges</h6>
                            ...
                            <h6 className="h3-bold text-[#0092E0] text-lg">Lack of ERP-Salesforce Integration Leading to Manual ERP Updating</h6>
                            ...
                            <h6 className="h3-bold text-[#0092E0] text-lg mt-5">Isolated Data Across Subsidiaries </h6>
                            ...
                            <h6 className="h3-bold text-[#0092E0]  text-lg mt-5">Limited Language Support and Globalization</h6>
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Maximized Sales </h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Improving Customer Engagement</h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Salesforce-ERP Integration for Seamless Workflow</h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Managing Budgets, Order History, and Invoices</h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Unified  Platform for All Subsidiaries</h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
                            ...
                            <h6 className="text-lg h3-bold text-[#0092E0] pb-6">Globalization</h6>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium">
