...
export default function Page() {
   ...
   <Script
      ...
      />
                ...
                <span className='text-[#0092E0]'>Manufacturing</span> <span className='text-[#ACACAC]'> | </span>26 March 2025
                    ...
                    <div>
                        <div className="">
                            ...
                            <h2 className="text-[#0092E0] pb-6 xl:text-[30px] text-[20px] font-medium">Client Overview</h2>
                            ...
                            <div className="py-6"></div>
                            <h2 className=" text-[#0092E0] pb-6 xl:text-[30px] text-[20px] font-medium">Problem or Challenge </h2>
                            <h3 className="text-lg h3-bold">Complex Sales Process</h3>
                            ...
                            <h3 className="text-lg h3-bold">Lack of a Customer Engagement System</h3>
                            ...
                            <h3 className="text-lg h3-bold">Overcoming Budget and Invoice Management Challenges</h3>
                            ...
                            <h3 className="text-lg h3-bold">Lack of ERP-Salesforce Integration Leading to Manual ERP Updating</h3>
                            ...
                            <h3 className="text-lg h3-bold mt-5">Isolated Data Across Subsidiaries </h3>
                            ...
                            <h3 className="text-lg h3-bold mt-5">Limited Language Support and Globalization</h3>
                            ...
                            <div className="py-6"></div>
                            <h2 className="text-[#0092E0] pb-6 xl:text-[30px] text-[20px] font-medium">Impact and Results </h2>
                            <h3 className="text-lg h3-bold pb-6">Maximized Sales </h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
                            ...
                            <h3 className="text-lg h3-bold pb-6">Improving Customer Engagement</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
                            ...
                            <h3 className="text-lg h3-bold pb-6">Salesforce-ERP Integration for Seamless Workflow</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
                            ...
                            <h3 className="text-lg h3-bold pb-6">Managing Budgets, Order History, and Invoices</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
                            ...
                            <h3 className="text-lg h3-bold pb-6">Unified  Platform for All Subsidiaries</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
                            ...
                            <h3 className="text-lg h3-bold pb-6">Globalization</h3>
                            <ul className="list-disc marker:text-[#0092E0] text-black pl-4 pb-2 font-medium xl:text-[20px] text-[16px]">
            ...
            {/* Latest Blogs */}
            <div
                className="py-20 custom-container xl:!pr-0"
            >
