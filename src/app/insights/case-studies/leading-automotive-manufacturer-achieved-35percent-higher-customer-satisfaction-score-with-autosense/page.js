        ...
        <div className="py-10 bg-white 4xl:max-w-[1084px] 4xl:w-[1084px] xl:w-[900px]">
          ...
          <div className="">
            <div className="">
              ...
              <h2 className="font-medium text-[#0092E0] xl:text-[30px] text-[20px] pb-4 md:text-[22px]">Key Challenges:</h2>

              <p className="text-black pb-2">The client’s legacy system posed several significant challenges that hindered warranty management and overall dealer performance:</p>

              <div className="pl-2">
                <ul className="list-disc marker:text-[#0092E0] marker:text-xl text-black pl-4 xl:text-[20px] text-[16px] md:text-[19px] font-medium">
                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">Outdated Technology </h3>: The legacy Java/J2EE-based application was no longer able to meet the dynamic needs of the automotive business. The system struggled with scalability issues, slowing down response times and leading to inefficiencies.</li>

                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">Lack of Integration </h3>: The warranty management system was not integrated with other critical business platforms such as inventory management and sales systems, leading to disjointed workflows and data silos.</li>

                  <li><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">Limited Functionality </h3>: The legacy system was incapable of handling modern warranty claims processes, such as real-time claims tracking, inventory checks, and the management of vehicle lifecycles.</li>

                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px] ">Poor User Experience  </h3>:  The dealer portal lacked an intuitive interface, leading to low adoption and significant frustration for dealers who struggled with complex navigation and time-consuming processes.</li>


                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">Inefficient Claims Process </h3>:  The warranty claims process was manual, error-prone, and lacked transparency, which caused delays, increased costs, and dissatisfied customers.</li>
...
<h3 className="h3-bold pb-4 xl:text-[22px] text-[18px] md:text-[19px]">Key Features of the AutoSense Warranty Management Portal</h3>
 <div className="pl-2">
                <ol className="list-decimal marker:text-[#000] marker:text-xl text-black pl-4 xl:text-[20px] text-[16px] md:text-[19px] font-medium">
                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">	Warranty Claims Submission & Tracking </h4>: The AutoSense portal enabled dealers to submit and track warranty claims seamlessly. Dealers could view real-time status updates, ensuring faster resolution times and improving overall customer satisfaction.</li>

                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">Lead Submission & Nurturing </h4>: AutoSense’s warranty portal integrated lead submission functionality, allowing the warranty team to capture claims-related leads and proactively nurture them through automated follow-up processes.</li>
                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px]  md:text-[19px]"> Opportunity Management </h4>: The system allowed warranty managers to track potential opportunities arising from warranty claims, including upsell and cross-sell possibilities for extended warranties and additional services, improving overall revenue potential.</li>

                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px] "> Order Management </h4>:  The portal provided an integrated order management system for warranty replacements, enabling dealers to track replacement parts, place orders, and update claim statuses in real-time.</li>

                   <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px]  md:text-[19px]"> 	Inventory Search with Vehicle Images </h4>: The AutoSense portal offered an intuitive inventory search tool that allowed dealers to check available replacement parts, view part images, and filter inventory by specifications. This reduced downtime and sped up the claims process, enhancing dealer productivity.</li>

                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px] "> Vehicle Lifecycle Management </h4>:  AutoSense provided visibility into the entire lifecycle of each vehicle, from the original sale to post-sale services and warranty claims. This holistic view ensured warranty managers had accurate information when processing claims and tracking vehicle-related issues.</li>
          ...
          <div className="">
            <div className="">
              <h2 className="font-medium text-[#0092E0] xl:text-[30px] text-[20px] pb-4 md:text-[22px]">Key Benefits for the Client</h2>
  <div className="pl-2">

     <p className="text-black pb-2">By leveraging the AutoSense warranty management solution, the automotive manufacturer achieved several significant benefits:</p>
                <ul className="list-disc marker:text-[#0092E0] marker:text-xl text-black pl-4 xl:text-[20px] text-[16px] md:text-[19px] font-medium">
                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]"> Improved Warranty Claims Efficiency </h3>: The streamlined process for submitting, tracking, and managing warranty claims reduced manual intervention, sped up processing times, and increased dealer satisfaction.</li>

                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]"> Real-Time Visibility </h3>: With the integration of Salesforce Automotive Cloud, the client gained access to real-time data on warranty claims, inventory, and vehicle status, enabling more informed decision-making and faster resolution of issues.</li>

                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]"> Increased Dealer Adoption </h3>: The modern, user-friendly interface of the AutoSense portal led to higher dealer adoption rates, improving overall productivity and engagement.</li>

                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px] ">Operational Efficiency </h3>: Automation of key workflows reduced errors, improved accuracy in warranty claim settlements, and freed up valuable resources to focus on more strategic tasks.</li>


                  <li className="pb-4"><h3 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]"> Enhanced Customer Satisfaction </h3>:  The faster, more transparent warranty claims process led to improved customer satisfaction, as dealers could resolve warranty issues promptly, increasing customer loyalty and trust.</li>

                </ul>
              </div>

<h3 className="h3-bold pb-4 xl:text-[20px] text-[18px] md:text-[19px]">Key Deliverables by Rialtes Under the AutoSense Service:</h3>

<div className="pl-2">
                <ol className="list-decimal marker:text-[#000] marker:text-xl text-black pl-4 xl:text-[20px] text-[16px] md:text-[19px] font-medium">
                  <li className="pb-4"><h4 className=" h3-bold inline xl:text-[20px] text-[17px] md:text-[19px]">	Stakeholder Workshops & Requirement Definition </h4>: Rialtes facilitated workshops with warranty, IT, and dealer management teams to capture pain points, define business requirements, and align on a clear project vision.</li>
